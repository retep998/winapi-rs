...
fn um_dsound() {
    ...
    assert_eq!(size_of::<DSEFFECTDESC>(), 32);
    assert_eq!(align_of::<DSEFFECTDESC>(), 4);
    assert_eq!(size_of::<DSCEFFECTDESC>(), 48);
    assert_eq!(align_of::<DSCEFFECTDESC>(), 4);
    assert_eq!(size_of::<DSBUFFERDESC>(), 36);
    assert_eq!(align_of::<DSBUFFERDESC>(), 4);
    assert_eq!(size_of::<DSBUFFERDESC1>(), 20);
    assert_eq!(align_of::<DSBUFFERDESC1>(), 4);
    assert_eq!(size_of::<DS3DBUFFER>(), 64);
    assert_eq!(align_of::<DS3DBUFFER>(), 4);
    assert_eq!(size_of::<DS3DLISTENER>(), 64);
    assert_eq!(align_of::<DS3DLISTENER>(), 4);
    assert_eq!(size_of::<DSCCAPS>(), 16);
    assert_eq!(align_of::<DSCCAPS>(), 4);
    assert_eq!(size_of::<DSCBUFFERDESC1>(), 20);
    assert_eq!(align_of::<DSCBUFFERDESC1>(), 4);
    assert_eq!(size_of::<DSCBUFFERDESC>(), 28);
    assert_eq!(align_of::<DSCBUFFERDESC>(), 4);
    assert_eq!(size_of::<DSCBCAPS>(), 16);
    assert_eq!(align_of::<DSCBCAPS>(), 4);
    assert_eq!(size_of::<DSBPOSITIONNOTIFY>(), 8);
    assert_eq!(align_of::<DSBPOSITIONNOTIFY>(), 4);
    assert_eq!(size_of::<DSFXGargle>(), 8);
    assert_eq!(align_of::<DSFXGargle>(), 4);
    assert_eq!(size_of::<DSFXChorus>(), 28);
    assert_eq!(align_of::<DSFXChorus>(), 4);
    assert_eq!(size_of::<DSFXFlanger>(), 28);
    assert_eq!(align_of::<DSFXFlanger>(), 4);
    assert_eq!(size_of::<DSFXEcho>(), 20);
    assert_eq!(align_of::<DSFXEcho>(), 4);
    assert_eq!(size_of::<DSFXDistortion>(), 20);
    assert_eq!(align_of::<DSFXDistortion>(), 4);
    assert_eq!(size_of::<DSFXCompressor>(), 24);
    assert_eq!(align_of::<DSFXCompressor>(), 4);
    assert_eq!(size_of::<DSFXParamEq>(), 12);
    assert_eq!(align_of::<DSFXParamEq>(), 4);
    assert_eq!(size_of::<DSFXI3DL2Reverb>(), 48);
    assert_eq!(align_of::<DSFXI3DL2Reverb>(), 4);
    assert_eq!(size_of::<DSFXWavesReverb>(), 16);
    assert_eq!(align_of::<DSFXWavesReverb>(), 4);
    assert_eq!(size_of::<DSCFXAec>(), 12);
    assert_eq!(align_of::<DSCFXAec>(), 4);
    assert_eq!(size_of::<DSCFXNoiseSuppress>(), 4);
    assert_eq!(align_of::<DSCFXNoiseSuppress>(), 4);
}
