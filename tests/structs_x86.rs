...
fn um_d3d12() {
    ...
    assert_eq!(size_of::<D3D12_FEATURE_DATA_D3D12_OPTIONS3>(), 20);
    assert_eq!(align_of::<D3D12_FEATURE_DATA_D3D12_OPTIONS3>(), 4);
    assert_eq!(size_of::<D3D12_FEATURE_DATA_EXISTING_HEAPS>(), 4);
    assert_eq!(align_of::<D3D12_FEATURE_DATA_EXISTING_HEAPS>(), 4);
    assert_eq!(size_of::<D3D12_FEATURE_DATA_D3D12_OPTIONS4>(), 12);
    assert_eq!(align_of::<D3D12_FEATURE_DATA_D3D12_OPTIONS4>(), 4);
    assert_eq!(size_of::<D3D12_FEATURE_DATA_SERIALIZATION>(), 8);
    assert_eq!(align_of::<D3D12_FEATURE_DATA_SERIALIZATION>(), 4);
    assert_eq!(size_of::<D3D12_FEATURE_DATA_CROSS_NODE>(), 8);
    assert_eq!(align_of::<D3D12_FEATURE_DATA_CROSS_NODE>(), 4);
    assert_eq!(size_of::<D3D12_FEATURE_DATA_D3D12_OPTIONS5>(), 12);
    assert_eq!(align_of::<D3D12_FEATURE_DATA_D3D12_OPTIONS5>(), 4);
    assert_eq!(size_of::<D3D12_RESOURCE_ALLOCATION_INFO>(), 16);
    assert_eq!(align_of::<D3D12_RESOURCE_ALLOCATION_INFO>(), 8);
    assert_eq!(size_of::<D3D12_RESOURCE_ALLOCATION_INFO1>(), 24);
    assert_eq!(align_of::<D3D12_RESOURCE_ALLOCATION_INFO1>(), 8);
    ...
    assert_eq!(size_of::<D3D12_VIEW_INSTANCE_LOCATION>(), 8);
    assert_eq!(align_of::<D3D12_VIEW_INSTANCE_LOCATION>(), 4);
    assert_eq!(size_of::<D3D12_VIEW_INSTANCING_DESC>(), 12);
    assert_eq!(align_of::<D3D12_VIEW_INSTANCING_DESC>(), 4);
    ...
    assert_eq!(size_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_SRV>(), 8);
    assert_eq!(align_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_SRV>(), 8);
    ...
    assert_eq!(size_of::<D3D12_WRITEBUFFERIMMEDIATE_PARAMETER>(), 16);
    assert_eq!(align_of::<D3D12_WRITEBUFFERIMMEDIATE_PARAMETER>(), 8);
    assert_eq!(size_of::<D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_SUPPORT>(), 8);
    assert_eq!(align_of::<D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_SUPPORT>(), 4);
    assert_eq!(size_of::<D3D12_PROTECTED_RESOURCE_SESSION_DESC>(), 8);
    assert_eq!(align_of::<D3D12_PROTECTED_RESOURCE_SESSION_DESC>(), 4);
    assert_eq!(size_of::<D3D12_META_COMMAND_PARAMETER_DESC>(), 20);
    assert_eq!(align_of::<D3D12_META_COMMAND_PARAMETER_DESC>(), 4);
    assert_eq!(size_of::<D3D12_META_COMMAND_DESC>(), 28);
    assert_eq!(align_of::<D3D12_META_COMMAND_DESC>(), 4);
    assert_eq!(size_of::<D3D12_STATE_SUBOBJECT>(), 8);
    assert_eq!(align_of::<D3D12_STATE_SUBOBJECT>(), 4);
    assert_eq!(size_of::<D3D12_STATE_OBJECT_CONFIG>(), 4);
    assert_eq!(align_of::<D3D12_STATE_OBJECT_CONFIG>(), 4);
    assert_eq!(size_of::<D3D12_GLOBAL_ROOT_SIGNATURE>(), 4);
    assert_eq!(align_of::<D3D12_GLOBAL_ROOT_SIGNATURE>(), 4);
    assert_eq!(size_of::<D3D12_LOCAL_ROOT_SIGNATURE>(), 4);
    assert_eq!(align_of::<D3D12_LOCAL_ROOT_SIGNATURE>(), 4);
    assert_eq!(size_of::<D3D12_NODE_MASK>(), 4);
    assert_eq!(align_of::<D3D12_NODE_MASK>(), 4);
    assert_eq!(size_of::<D3D12_EXPORT_DESC>(), 12);
    assert_eq!(align_of::<D3D12_EXPORT_DESC>(), 4);
    assert_eq!(size_of::<D3D12_DXIL_LIBRARY_DESC>(), 16);
    assert_eq!(align_of::<D3D12_DXIL_LIBRARY_DESC>(), 4);
    assert_eq!(size_of::<D3D12_EXISTING_COLLECTION_DESC>(), 12);
    assert_eq!(align_of::<D3D12_EXISTING_COLLECTION_DESC>(), 4);
    assert_eq!(size_of::<D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION>(), 12);
    assert_eq!(align_of::<D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION>(), 4);
    assert_eq!(size_of::<D3D12_DXIL_SUBOBJECT_TO_EXPORTS_ASSOCIATION>(), 12);
    assert_eq!(align_of::<D3D12_DXIL_SUBOBJECT_TO_EXPORTS_ASSOCIATION>(), 4);
    assert_eq!(size_of::<D3D12_HIT_GROUP_DESC>(), 20);
    assert_eq!(align_of::<D3D12_HIT_GROUP_DESC>(), 4);
    assert_eq!(size_of::<D3D12_RAYTRACING_SHADER_CONFIG>(), 8);
    assert_eq!(align_of::<D3D12_RAYTRACING_SHADER_CONFIG>(), 4);
    assert_eq!(size_of::<D3D12_RAYTRACING_PIPELINE_CONFIG>(), 4);
    assert_eq!(align_of::<D3D12_RAYTRACING_PIPELINE_CONFIG>(), 4);
    assert_eq!(size_of::<D3D12_STATE_OBJECT_DESC>(), 12);
    assert_eq!(align_of::<D3D12_STATE_OBJECT_DESC>(), 4);
    assert_eq!(size_of::<D3D12_GPU_VIRTUAL_ADDRESS_AND_STRIDE>(), 16);
    assert_eq!(align_of::<D3D12_GPU_VIRTUAL_ADDRESS_AND_STRIDE>(), 8);
    assert_eq!(size_of::<D3D12_GPU_VIRTUAL_ADDRESS_RANGE>(), 16);
    assert_eq!(align_of::<D3D12_GPU_VIRTUAL_ADDRESS_RANGE>(), 8);
    assert_eq!(size_of::<D3D12_GPU_VIRTUAL_ADDRESS_RANGE_AND_STRIDE>(), 24);
    assert_eq!(align_of::<D3D12_GPU_VIRTUAL_ADDRESS_RANGE_AND_STRIDE>(), 8);
    assert_eq!(size_of::<D3D12_RAYTRACING_GEOMETRY_TRIANGLES_DESC>(), 48);
    assert_eq!(align_of::<D3D12_RAYTRACING_GEOMETRY_TRIANGLES_DESC>(), 8);
    assert_eq!(size_of::<D3D12_RAYTRACING_AABB>(), 24);
    assert_eq!(align_of::<D3D12_RAYTRACING_AABB>(), 4);
    assert_eq!(size_of::<D3D12_RAYTRACING_GEOMETRY_AABBS_DESC>(), 24);
    assert_eq!(align_of::<D3D12_RAYTRACING_GEOMETRY_AABBS_DESC>(), 8);
    assert_eq!(size_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC>(), 16);
    assert_eq!(align_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC>(), 8);
    assert_eq!(size_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_COMPACTED_SIZE_DESC>(), 8);
    assert_eq!(align_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_COMPACTED_SIZE_DESC>(), 8);
    assert_eq!(size_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_TOOLS_VISUALIZATION_DESC>(), 8);
    assert_eq!(align_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_TOOLS_VISUALIZATION_DESC>(), 8);
    assert_eq!(size_of::<D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_TOOLS_VISUALIZATION_HEADER>(), 8);
    assert_eq!(align_of::<D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_TOOLS_VISUALIZATION_HEADER>(), 4);
    assert_eq!(size_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_SERIALIZATION_DESC>(), 16);
    assert_eq!(align_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_SERIALIZATION_DESC>(), 8);
    assert_eq!(size_of::<D3D12_SERIALIZED_DATA_DRIVER_MATCHING_IDENTIFIER>(), 32);
    assert_eq!(align_of::<D3D12_SERIALIZED_DATA_DRIVER_MATCHING_IDENTIFIER>(), 4);
    assert_eq!(size_of::<D3D12_SERIALIZED_RAYTRACING_ACCELERATION_STRUCTURE_HEADER>(), 56);
    assert_eq!(align_of::<D3D12_SERIALIZED_RAYTRACING_ACCELERATION_STRUCTURE_HEADER>(), 8);
    assert_eq!(size_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_CURRENT_SIZE_DESC>(), 8);
    assert_eq!(align_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_CURRENT_SIZE_DESC>(), 8);
    assert_eq!(size_of::<D3D12_RAYTRACING_INSTANCE_DESC>(), 64);
    assert_eq!(align_of::<D3D12_RAYTRACING_INSTANCE_DESC>(), 8);
    assert_eq!(size_of::<D3D12_RAYTRACING_GEOMETRY_DESC>(), 56);
    assert_eq!(align_of::<D3D12_RAYTRACING_GEOMETRY_DESC>(), 8);
    assert_eq!(size_of::<D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTS>(), 24);
    assert_eq!(align_of::<D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTS>(), 8);
    assert_eq!(size_of::<D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC>(), 48);
    assert_eq!(align_of::<D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC>(), 8);
    assert_eq!(size_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_PREBUILD_INFO>(), 24);
    assert_eq!(align_of::<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_PREBUILD_INFO>(), 8);
    assert_eq!(size_of::<D3D12_AUTO_BREADCRUMB_NODE>(), 40);
    assert_eq!(align_of::<D3D12_AUTO_BREADCRUMB_NODE>(), 4);
    assert_eq!(size_of::<D3D12_DEVICE_REMOVED_EXTENDED_DATA>(), 8);
    assert_eq!(align_of::<D3D12_DEVICE_REMOVED_EXTENDED_DATA>(), 4);
    assert_eq!(size_of::<D3D12_VERSIONED_DEVICE_REMOVED_EXTENDED_DATA>(), 12);
    assert_eq!(align_of::<D3D12_VERSIONED_DEVICE_REMOVED_EXTENDED_DATA>(), 4);
    assert_eq!(size_of::<D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERS>(), 20);
    assert_eq!(align_of::<D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERS>(), 4);
    assert_eq!(size_of::<D3D12_RENDER_PASS_BEGINNING_ACCESS>(), 24);
    assert_eq!(align_of::<D3D12_RENDER_PASS_BEGINNING_ACCESS>(), 4);
    assert_eq!(size_of::<D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_SUBRESOURCE_PARAMETERS>(), 32);
    assert_eq!(align_of::<D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_SUBRESOURCE_PARAMETERS>(), 4);
    assert_eq!(size_of::<D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS>(), 28);
    assert_eq!(align_of::<D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS>(), 4);
    assert_eq!(size_of::<D3D12_RENDER_PASS_ENDING_ACCESS>(), 32);
    assert_eq!(align_of::<D3D12_RENDER_PASS_ENDING_ACCESS>(), 4);
    assert_eq!(size_of::<D3D12_RENDER_PASS_RENDER_TARGET_DESC>(), 60);
    assert_eq!(align_of::<D3D12_RENDER_PASS_RENDER_TARGET_DESC>(), 4);
    assert_eq!(size_of::<D3D12_RENDER_PASS_DEPTH_STENCIL_DESC>(), 116);
    assert_eq!(align_of::<D3D12_RENDER_PASS_DEPTH_STENCIL_DESC>(), 4);
    assert_eq!(size_of::<D3D12_DISPATCH_RAYS_DESC>(), 104);
    assert_eq!(align_of::<D3D12_DISPATCH_RAYS_DESC>(), 8);
