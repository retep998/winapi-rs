...
fn um_projectedfslib() {
    ...
    assert_eq!(size_of::<PRJ_EXTENDED_INFO_u_Symlink>(), 4);
    assert_eq!(align_of::<PRJ_EXTENDED_INFO_u_Symlink>(), 4);
    assert_eq!(size_of::<PRJ_EXTENDED_INFO_u>(), 4);
    assert_eq!(align_of::<PRJ_EXTENDED_INFO_u>(), 4);
    assert_eq!(size_of::<PRJ_EXTENDED_INFO>(), 12);
    assert_eq!(align_of::<PRJ_EXTENDED_INFO>(), 4);
    assert_eq!(size_of::<PRJ_NOTIFICATION_MAPPING>(), 8);
    assert_eq!(align_of::<PRJ_NOTIFICATION_MAPPING>(), 4);
    assert_eq!(size_of::<PRJ_STARTVIRTUALIZING_FLAGS>(), 4);
    assert_eq!(align_of::<PRJ_STARTVIRTUALIZING_FLAGS>(), 4);
    assert_eq!(size_of::<PRJ_STARTVIRTUALIZING_OPTIONS>(), 20);
    assert_eq!(align_of::<PRJ_STARTVIRTUALIZING_OPTIONS>(), 4);
    ...
    assert_eq!(size_of::<PRJ_CALLBACK_DATA>(), 68);
    assert_eq!(align_of::<PRJ_CALLBACK_DATA>(), 4);
    ...
    assert_eq!(size_of::<PRJ_CALLBACKS>(), 32);
    assert_eq!(align_of::<PRJ_CALLBACKS>(), 4);
    ...
    assert_eq!(size_of::<PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS_u_Enumeration>(), 4);
    assert_eq!(align_of::<PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS_u_Enumeration>(), 4);
    assert_eq!(size_of::<PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS_u>(), 4);
    assert_eq!(align_of::<PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS_u>(), 4);
    assert_eq!(size_of::<PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS>(), 8);
    assert_eq!(align_of::<PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS>(), 4);
}
