...
fn um_xaudio2() {
    ...
    assert_eq!(size_of::<XAUDIO2_SEND_DESCRIPTOR>(), 8);
    assert_eq!(align_of::<XAUDIO2_SEND_DESCRIPTOR>(), 1);
    assert_eq!(size_of::<XAUDIO2_VOICE_SENDS>(), 8);
    assert_eq!(align_of::<XAUDIO2_VOICE_SENDS>(), 1);
    assert_eq!(size_of::<XAUDIO2_EFFECT_DESCRIPTOR>(), 12);
    assert_eq!(align_of::<XAUDIO2_EFFECT_DESCRIPTOR>(), 1);
    assert_eq!(size_of::<XAUDIO2_EFFECT_CHAIN>(), 8);
    ...
    assert_eq!(size_of::<XAUDIO2_BUFFER>(), 36);
    assert_eq!(align_of::<XAUDIO2_BUFFER>(), 1);
    assert_eq!(size_of::<XAUDIO2_BUFFER_WMA>(), 8);
    assert_eq!(align_of::<XAUDIO2_BUFFER_WMA>(), 1);
    assert_eq!(size_of::<XAUDIO2_VOICE_STATE>(), 16);
...
fn um_xaudio2fx() {
    ...
    assert_eq!(size_of::<XAUDIO2FX_VOLUMEMETER_LEVELS>(), 12);
