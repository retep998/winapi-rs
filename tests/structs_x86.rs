...
#[cfg(feature = "dinput")] #[test]
fn um_dinput() {
    use winapi::um::dinput::*;
    assert_eq!(size_of::<DICONSTANTFORCE>(), 4);
    assert_eq!(align_of::<DICONSTANTFORCE>(), 4);
    assert_eq!(size_of::<DIRAMPFORCE>(), 8);
    assert_eq!(align_of::<DIRAMPFORCE>(), 4);
    assert_eq!(size_of::<DIPERIODIC>(), 16);
    assert_eq!(align_of::<DIPERIODIC>(), 4);
    assert_eq!(size_of::<DICONDITION>(), 24);
    assert_eq!(align_of::<DICONDITION>(), 4);
    assert_eq!(size_of::<DICUSTOMFORCE>(), 16);
    assert_eq!(align_of::<DICUSTOMFORCE>(), 4);
    assert_eq!(size_of::<DIENVELOPE>(), 20);
    assert_eq!(align_of::<DIENVELOPE>(), 4);
    assert_eq!(size_of::<DIEFFECT_DX5>(), 52);
    assert_eq!(align_of::<DIEFFECT_DX5>(), 4);
    assert_eq!(size_of::<DIEFFECT>(), 56);
    assert_eq!(align_of::<DIEFFECT>(), 4);
    assert_eq!(size_of::<DIFILEEFFECT>(), 284);
    assert_eq!(align_of::<DIFILEEFFECT>(), 4);
    assert_eq!(size_of::<DIEFFESCAPE>(), 24);
    assert_eq!(align_of::<DIEFFESCAPE>(), 4);
    assert_eq!(size_of::<DIDEVCAPS_DX3>(), 24);
    assert_eq!(align_of::<DIDEVCAPS_DX3>(), 4);
    assert_eq!(size_of::<DIDEVCAPS>(), 44);
    assert_eq!(align_of::<DIDEVCAPS>(), 4);
    assert_eq!(size_of::<DIOBJECTDATAFORMAT>(), 16);
    assert_eq!(align_of::<DIOBJECTDATAFORMAT>(), 4);
    assert_eq!(size_of::<DIDATAFORMAT>(), 24);
    assert_eq!(align_of::<DIDATAFORMAT>(), 4);
    assert_eq!(size_of::<DIACTIONA>(), 40);
    assert_eq!(align_of::<DIACTIONA>(), 4);
    assert_eq!(size_of::<DIACTIONW>(), 40);
    assert_eq!(align_of::<DIACTIONW>(), 4);
    assert_eq!(size_of::<DIACTIONFORMATA>(), 328);
    assert_eq!(align_of::<DIACTIONFORMATA>(), 4);
    assert_eq!(size_of::<DIACTIONFORMATW>(), 588);
    assert_eq!(align_of::<DIACTIONFORMATW>(), 4);
    assert_eq!(size_of::<DICOLORSET>(), 36);
    assert_eq!(align_of::<DICOLORSET>(), 4);
    assert_eq!(size_of::<DICONFIGUREDEVICESPARAMSA>(), 64);
    assert_eq!(align_of::<DICONFIGUREDEVICESPARAMSA>(), 4);
    assert_eq!(size_of::<DICONFIGUREDEVICESPARAMSW>(), 64);
    assert_eq!(align_of::<DICONFIGUREDEVICESPARAMSW>(), 4);
    assert_eq!(size_of::<DIDEVICEIMAGEINFOA>(), 352);
    assert_eq!(align_of::<DIDEVICEIMAGEINFOA>(), 4);
    assert_eq!(size_of::<DIDEVICEIMAGEINFOW>(), 612);
    assert_eq!(align_of::<DIDEVICEIMAGEINFOW>(), 4);
    assert_eq!(size_of::<DIDEVICEIMAGEINFOHEADERA>(), 36);
    assert_eq!(align_of::<DIDEVICEIMAGEINFOHEADERA>(), 4);
    assert_eq!(size_of::<DIDEVICEIMAGEINFOHEADERW>(), 36);
    assert_eq!(align_of::<DIDEVICEIMAGEINFOHEADERW>(), 4);
    assert_eq!(size_of::<DIDEVICEOBJECTINSTANCE_DX3A>(), 292);
    assert_eq!(align_of::<DIDEVICEOBJECTINSTANCE_DX3A>(), 4);
    assert_eq!(size_of::<DIDEVICEOBJECTINSTANCE_DX3W>(), 552);
    assert_eq!(align_of::<DIDEVICEOBJECTINSTANCE_DX3W>(), 4);
    assert_eq!(size_of::<DIDEVICEOBJECTINSTANCEA>(), 316);
    assert_eq!(align_of::<DIDEVICEOBJECTINSTANCEA>(), 4);
    assert_eq!(size_of::<DIDEVICEOBJECTINSTANCEW>(), 576);
    assert_eq!(align_of::<DIDEVICEOBJECTINSTANCEW>(), 4);
    assert_eq!(size_of::<DIPROPHEADER>(), 16);
    assert_eq!(align_of::<DIPROPHEADER>(), 4);
    assert_eq!(size_of::<DIPROPDWORD>(), 20);
    assert_eq!(align_of::<DIPROPDWORD>(), 4);
    assert_eq!(size_of::<DIPROPPOINTER>(), 20);
    assert_eq!(align_of::<DIPROPPOINTER>(), 4);
    assert_eq!(size_of::<DIPROPRANGE>(), 24);
    assert_eq!(align_of::<DIPROPRANGE>(), 4);
    assert_eq!(size_of::<DIPROPCAL>(), 28);
    assert_eq!(align_of::<DIPROPCAL>(), 4);
    assert_eq!(size_of::<DIPROPCALPOV>(), 56);
    assert_eq!(align_of::<DIPROPCALPOV>(), 4);
    assert_eq!(size_of::<DIPROPGUIDANDPATH>(), 552);
    assert_eq!(align_of::<DIPROPGUIDANDPATH>(), 4);
    assert_eq!(size_of::<DIPROPSTRING>(), 536);
    assert_eq!(align_of::<DIPROPSTRING>(), 4);
    assert_eq!(size_of::<CPOINT>(), 8);
    assert_eq!(align_of::<CPOINT>(), 4);
    assert_eq!(size_of::<DIPROPCPOINTS>(), 84);
    assert_eq!(align_of::<DIPROPCPOINTS>(), 4);
    assert_eq!(size_of::<DIDEVICEOBJECTDATA_DX3>(), 16);
    assert_eq!(align_of::<DIDEVICEOBJECTDATA_DX3>(), 4);
    assert_eq!(size_of::<DIDEVICEOBJECTDATA>(), 20);
    assert_eq!(align_of::<DIDEVICEOBJECTDATA>(), 4);
    assert_eq!(size_of::<DIDEVICEINSTANCE_DX3A>(), 560);
    assert_eq!(align_of::<DIDEVICEINSTANCE_DX3A>(), 4);
    assert_eq!(size_of::<DIDEVICEINSTANCE_DX3W>(), 1080);
    assert_eq!(align_of::<DIDEVICEINSTANCE_DX3W>(), 4);
    assert_eq!(size_of::<DIDEVICEINSTANCEA>(), 580);
    assert_eq!(align_of::<DIDEVICEINSTANCEA>(), 4);
    assert_eq!(size_of::<DIDEVICEINSTANCEW>(), 1100);
    assert_eq!(align_of::<DIDEVICEINSTANCEW>(), 4);
    assert_eq!(size_of::<DIEFFECTINFOA>(), 292);
    assert_eq!(align_of::<DIEFFECTINFOA>(), 4);
    assert_eq!(size_of::<DIEFFECTINFOW>(), 552);
    assert_eq!(align_of::<DIEFFECTINFOW>(), 4);
    assert_eq!(size_of::<DIMOUSESTATE>(), 16);
    assert_eq!(align_of::<DIMOUSESTATE>(), 4);
    assert_eq!(size_of::<DIMOUSESTATE2>(), 20);
    assert_eq!(align_of::<DIMOUSESTATE2>(), 4);
    assert_eq!(size_of::<DIJOYSTATE>(), 80);
    assert_eq!(align_of::<DIJOYSTATE>(), 4);
    assert_eq!(size_of::<DIJOYSTATE2>(), 272);
    assert_eq!(align_of::<DIJOYSTATE2>(), 4);
}
