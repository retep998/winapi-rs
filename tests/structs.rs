...
#[cfg(all(target_arch = "x86", feature = "usbspec"))] #[test]
fn shared_usbspec() {
    ...
    assert_eq!(size_of::<USB_DEVICE_CAPABILITY_CONFIGURATION_SUMMARY_DESCRIPTOR>(), 11);
    assert_eq!(align_of::<USB_DEVICE_CAPABILITY_CONFIGURATION_SUMMARY_DESCRIPTOR>(), 1);
...
#[cfg(all(target_arch = "x86_64", feature = "usbspec"))] #[test]
fn shared_usbspec() {
    use winapi::shared::usbspec::*;
    assert_eq!(size_of::<USB_DEFAULT_PIPE_SETUP_PACKET>(), 8);
    assert_eq!(align_of::<USB_DEFAULT_PIPE_SETUP_PACKET>(), 1);
