...
fn um_directml() {
    ...
    assert_eq!(size_of::<DML_BUFFER_TENSOR_DESC>(), 48);
    assert_eq!(align_of::<DML_BUFFER_TENSOR_DESC>(), 8);
    assert_eq!(size_of::<DML_TENSOR_DESC>(), 16);
    assert_eq!(align_of::<DML_TENSOR_DESC>(), 8);
    ...
    assert_eq!(size_of::<DML_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_IDENTITY_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_IDENTITY_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_ABS_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_ABS_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_ACOS_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_ACOS_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_ADD_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_ADD_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_ASIN_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_ASIN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_ATAN_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_ATAN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_CEIL_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_CEIL_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_CLIP_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_ELEMENT_WISE_CLIP_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_COS_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_COS_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_DIVIDE_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_DIVIDE_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_EXP_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_EXP_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_FLOOR_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_FLOOR_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_LOG_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_LOG_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_LOGICAL_AND_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_LOGICAL_AND_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_LOGICAL_EQUALS_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_LOGICAL_EQUALS_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_LOGICAL_GREATER_THAN_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_LOGICAL_GREATER_THAN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_LOGICAL_NOT_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_ELEMENT_WISE_LOGICAL_NOT_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_LOGICAL_OR_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_LOGICAL_OR_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_LOGICAL_XOR_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_LOGICAL_XOR_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_MAX_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_MAX_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_MEAN_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_MEAN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_MIN_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_MIN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_MULTIPLY_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_MULTIPLY_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_POW_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_ELEMENT_WISE_POW_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_CONSTANT_POW_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_ELEMENT_WISE_CONSTANT_POW_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_RECIP_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_RECIP_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_SIN_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_SIN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_SQRT_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_SQRT_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_SUBTRACT_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_SUBTRACT_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_TAN_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ELEMENT_WISE_TAN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_THRESHOLD_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_ELEMENT_WISE_THRESHOLD_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_QUANTIZE_LINEAR_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_ELEMENT_WISE_QUANTIZE_LINEAR_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ELEMENT_WISE_DEQUANTIZE_LINEAR_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_ELEMENT_WISE_DEQUANTIZE_LINEAR_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_ELU_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_ELU_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_HARDMAX_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_ACTIVATION_HARDMAX_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_HARD_SIGMOID_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_HARD_SIGMOID_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_IDENTITY_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_ACTIVATION_IDENTITY_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_LEAKY_RELU_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_LEAKY_RELU_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_LINEAR_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_LINEAR_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_LOG_SOFTMAX_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_ACTIVATION_LOG_SOFTMAX_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_PARAMETERIZED_RELU_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_PARAMETERIZED_RELU_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_PARAMETRIC_SOFTPLUS_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_PARAMETRIC_SOFTPLUS_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_RELU_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_ACTIVATION_RELU_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_SCALED_ELU_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_SCALED_ELU_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_SCALED_TANH_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_SCALED_TANH_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_SIGMOID_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_ACTIVATION_SIGMOID_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_SOFTMAX_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_ACTIVATION_SOFTMAX_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_SOFTPLUS_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_SOFTPLUS_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_SOFTSIGN_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_ACTIVATION_SOFTSIGN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_TANH_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_ACTIVATION_TANH_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ACTIVATION_THRESHOLDED_RELU_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_ACTIVATION_THRESHOLDED_RELU_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_CONVOLUTION_OPERATOR_DESC>(), 104);
    assert_eq!(align_of::<DML_CONVOLUTION_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_GEMM_OPERATOR_DESC>(), 56);
    assert_eq!(align_of::<DML_GEMM_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_REDUCE_OPERATOR_DESC>(), 40);
    assert_eq!(align_of::<DML_REDUCE_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_AVERAGE_POOLING_OPERATOR_DESC>(), 64);
    assert_eq!(align_of::<DML_AVERAGE_POOLING_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_LP_POOLING_OPERATOR_DESC>(), 64);
    assert_eq!(align_of::<DML_LP_POOLING_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_MAX_POOLING_OPERATOR_DESC>(), 56);
    assert_eq!(align_of::<DML_MAX_POOLING_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_ROI_POOLING_OPERATOR_DESC>(), 40);
    assert_eq!(align_of::<DML_ROI_POOLING_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_SLICE_OPERATOR_DESC>(), 48);
    assert_eq!(align_of::<DML_SLICE_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_CAST_OPERATOR_DESC>(), 16);
    assert_eq!(align_of::<DML_CAST_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_SPLIT_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_SPLIT_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_JOIN_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_JOIN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_PADDING_OPERATOR_DESC>(), 48);
    assert_eq!(align_of::<DML_PADDING_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_VALUE_SCALE_2D_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_VALUE_SCALE_2D_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_UPSAMPLE_2D_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_UPSAMPLE_2D_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_GATHER_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_GATHER_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_SPACE_TO_DEPTH_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_SPACE_TO_DEPTH_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_DEPTH_TO_SPACE_OPERATOR_DESC>(), 24);
    assert_eq!(align_of::<DML_DEPTH_TO_SPACE_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_TILE_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_TILE_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_TOP_K_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_TOP_K_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_BATCH_NORMALIZATION_OPERATOR_DESC>(), 64);
    assert_eq!(align_of::<DML_BATCH_NORMALIZATION_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_MEAN_VARIANCE_NORMALIZATION_OPERATOR_DESC>(), 56);
    assert_eq!(align_of::<DML_MEAN_VARIANCE_NORMALIZATION_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_LOCAL_RESPONSE_NORMALIZATION_OPERATOR_DESC>(), 40);
    assert_eq!(align_of::<DML_LOCAL_RESPONSE_NORMALIZATION_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_LP_NORMALIZATION_OPERATOR_DESC>(), 32);
    assert_eq!(align_of::<DML_LP_NORMALIZATION_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_RNN_OPERATOR_DESC>(), 88);
    assert_eq!(align_of::<DML_RNN_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_LSTM_OPERATOR_DESC>(), 120);
    assert_eq!(align_of::<DML_LSTM_OPERATOR_DESC>(), 8);
    assert_eq!(size_of::<DML_GRU_OPERATOR_DESC>(), 88);
    assert_eq!(align_of::<DML_GRU_OPERATOR_DESC>(), 8);
    ...
    assert_eq!(size_of::<DML_BINDING_DESC>(), 16);
    assert_eq!(align_of::<DML_BINDING_DESC>(), 8);
    assert_eq!(size_of::<DML_BUFFER_BINDING>(), 24);
    assert_eq!(align_of::<DML_BUFFER_BINDING>(), 8);
    assert_eq!(size_of::<DML_BUFFER_ARRAY_BINDING>(), 16);
    assert_eq!(align_of::<DML_BUFFER_ARRAY_BINDING>(), 8);
}
