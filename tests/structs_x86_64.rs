...
fn um_ocidl() {
    use winapi::um::ocidl::*;
    assert_eq!(size_of::<CONNECTDATA>(), 16);
    assert_eq!(align_of::<CONNECTDATA>(), 8);
    assert_eq!(size_of::<LICINFO>(), 12);
    assert_eq!(align_of::<LICINFO>(), 4);
    assert_eq!(size_of::<CONTROLINFO>(), 24);
    assert_eq!(align_of::<CONTROLINFO>(), 8);
    assert_eq!(size_of::<POINTF>(), 8);
    assert_eq!(align_of::<POINTF>(), 4);
    assert_eq!(size_of::<PROPPAGEINFO>(), 48);
    assert_eq!(align_of::<PROPPAGEINFO>(), 8);
    assert_eq!(size_of::<CAUUID>(), 16);
    assert_eq!(align_of::<CAUUID>(), 8);
    ...
    assert_eq!(size_of::<CALPOLESTR>(), 16);
    assert_eq!(align_of::<CALPOLESTR>(), 8);
    assert_eq!(size_of::<CADWORD>(), 16);
    assert_eq!(align_of::<CADWORD>(), 8);
    assert_eq!(size_of::<PROPBAG2>(), 40);
    assert_eq!(align_of::<PROPBAG2>(), 8);
    assert_eq!(size_of::<QACONTAINER>(), 112);
    assert_eq!(align_of::<QACONTAINER>(), 8);
...
fn um_olectl() {
    ...
    assert_eq!(size_of::<OCPFIPARAMS>(), 72);
    assert_eq!(align_of::<OCPFIPARAMS>(), 8);
    assert_eq!(size_of::<FONTDESC>(), 40);
    assert_eq!(align_of::<FONTDESC>(), 8);
    assert_eq!(size_of::<PICTDESC_bmp>(), 16);
    assert_eq!(align_of::<PICTDESC_bmp>(), 8);
    assert_eq!(size_of::<PICTDESC_wmf>(), 16);
    assert_eq!(align_of::<PICTDESC_wmf>(), 8);
    assert_eq!(size_of::<PICTDESC_icon>(), 8);
    assert_eq!(align_of::<PICTDESC_icon>(), 8);
    assert_eq!(size_of::<PICTDESC_emf>(), 8);
    assert_eq!(align_of::<PICTDESC_emf>(), 8);
    assert_eq!(size_of::<PICTDESC>(), 24);
    assert_eq!(align_of::<PICTDESC>(), 8);
}
...
fn um_oleidl() {
    ...
    assert_eq!(size_of::<OLEINPLACEFRAMEINFO>(), 32);
    assert_eq!(align_of::<OLEINPLACEFRAMEINFO>(), 8);
    assert_eq!(size_of::<OLEMENUGROUPWIDTHS>(), 24);
    assert_eq!(align_of::<OLEMENUGROUPWIDTHS>(), 4);
    assert_eq!(size_of::<OLEVERB>(), 24);
    assert_eq!(align_of::<OLEVERB>(), 8);
}
...
fn um_shobjidl() {
    ...
    assert_eq!(size_of::<NSTCCUSTOMDRAW>(), 48);
    assert_eq!(align_of::<NSTCCUSTOMDRAW>(), 8);
}
#[cfg(feature = "shobjidl_core")] #[test]
fn um_shobjidl_core() {
    use winapi::um::shobjidl_core::*;
    assert_eq!(size_of::<CMINVOKECOMMANDINFO>(), 56);
    assert_eq!(align_of::<CMINVOKECOMMANDINFO>(), 8);
    assert_eq!(size_of::<CMINVOKECOMMANDINFOEX>(), 104);
    assert_eq!(align_of::<CMINVOKECOMMANDINFOEX>(), 8);
    assert_eq!(size_of::<PERSIST_FOLDER_TARGET_INFO>(), 1056);
    assert_eq!(align_of::<PERSIST_FOLDER_TARGET_INFO>(), 8);
    ...
    assert_eq!(size_of::<SV2CVW2_PARAMS>(), 56);
    assert_eq!(align_of::<SV2CVW2_PARAMS>(), 8);
    ...
    assert_eq!(size_of::<SHDRAGIMAGE>(), 32);
    assert_eq!(align_of::<SHDRAGIMAGE>(), 8);
    ...
    assert_eq!(size_of::<SMDATA>(), 80);
    assert_eq!(align_of::<SMDATA>(), 8);
    assert_eq!(size_of::<SMINFO>(), 16);
    assert_eq!(align_of::<SMINFO>(), 4);
    assert_eq!(size_of::<SMCSHCHANGENOTIFYSTRUCT>(), 24);
    assert_eq!(align_of::<SMCSHCHANGENOTIFYSTRUCT>(), 8);
    assert_eq!(size_of::<KNOWNFOLDER_DEFINITION>(), 112);
    assert_eq!(align_of::<KNOWNFOLDER_DEFINITION>(), 8);
    assert_eq!(size_of::<PREVIEWHANDLERFRAMEINFO>(), 16);
    assert_eq!(align_of::<PREVIEWHANDLERFRAMEINFO>(), 8);
}
...
fn um_shtypes() {
    ...
    assert_eq!(size_of::<STRRET_u>(), 264);
    assert_eq!(align_of::<STRRET_u>(), 8);
    assert_eq!(size_of::<STRRET>(), 272);
    assert_eq!(align_of::<STRRET>(), 8);
    assert_eq!(size_of::<SHELLDETAILS>(), 280);
...
fn um_urlmon() {
    ...
    assert_eq!(size_of::<BINDINFO>(), 128);
    assert_eq!(align_of::<BINDINFO>(), 8);
    assert_eq!(size_of::<REMSECURITY_ATTRIBUTES>(), 12);
    assert_eq!(align_of::<REMSECURITY_ATTRIBUTES>(), 4);
    assert_eq!(size_of::<RemBINDINFO>(), 96);
    assert_eq!(align_of::<RemBINDINFO>(), 8);
    ...
    assert_eq!(size_of::<PROTOCOLDATA>(), 24);
    assert_eq!(align_of::<PROTOCOLDATA>(), 8);
    assert_eq!(size_of::<StartParam>(), 32);
    assert_eq!(align_of::<StartParam>(), 8);
    assert_eq!(size_of::<ZONEATTRIBUTES>(), 1460);
    assert_eq!(align_of::<ZONEATTRIBUTES>(), 4);
    assert_eq!(size_of::<CODEBASEHOLD>(), 40);
    assert_eq!(align_of::<CODEBASEHOLD>(), 8);
    assert_eq!(size_of::<SOFTDISTINFO>(), 72);
    assert_eq!(align_of::<SOFTDISTINFO>(), 8);
    assert_eq!(size_of::<PROTOCOLFILTERDATA>(), 40);
    assert_eq!(align_of::<PROTOCOLFILTERDATA>(), 8);
    assert_eq!(size_of::<DATAINFO>(), 16);
    assert_eq!(align_of::<DATAINFO>(), 4);
    assert_eq!(size_of::<HIT_LOGGING_INFO>(), 56);
    assert_eq!(align_of::<HIT_LOGGING_INFO>(), 8);
    assert_eq!(size_of::<CONFIRMSAFETY>(), 32);
    assert_eq!(align_of::<CONFIRMSAFETY>(), 8);
    assert_eq!(size_of::<PROTOCOL_ARGUMENT>(), 16);
    assert_eq!(align_of::<PROTOCOL_ARGUMENT>(), 8);
}
