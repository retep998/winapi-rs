...
#[cfg(feature = "winhvplatformdefs")] #[test]
fn um_winhvplatformdefs() {
    use winapi::um::winhvplatformdefs::*;
    assert_eq!(size_of::<WHV_CAPABILITY_CODE>(), 4);
    assert_eq!(align_of::<WHV_CAPABILITY_CODE>(), 4);
    assert_eq!(size_of::<WHV_CAPABILITY_FEATURES>(), 8);
    assert_eq!(align_of::<WHV_CAPABILITY_FEATURES>(), 8);
    assert_eq!(size_of::<WHV_EXTENDED_VM_EXITS>(), 8);
    assert_eq!(align_of::<WHV_EXTENDED_VM_EXITS>(), 8);
    assert_eq!(size_of::<WHV_PROCESSOR_VENDOR>(), 4);
    assert_eq!(align_of::<WHV_PROCESSOR_VENDOR>(), 4);
    assert_eq!(size_of::<WHV_PROCESSOR_FEATURES>(), 8);
    assert_eq!(align_of::<WHV_PROCESSOR_FEATURES>(), 8);
    assert_eq!(size_of::<WHV_PROCESSOR_FEATURES1>(), 8);
    assert_eq!(align_of::<WHV_PROCESSOR_FEATURES1>(), 8);
    assert_eq!(size_of::<WHV_PROCESSOR_FEATURES_BANKS>(), 24);
    assert_eq!(align_of::<WHV_PROCESSOR_FEATURES_BANKS>(), 8);
    assert_eq!(size_of::<WHV_PROCESSOR_XSAVE_FEATURES>(), 8);
    assert_eq!(align_of::<WHV_PROCESSOR_XSAVE_FEATURES>(), 8);
    assert_eq!(size_of::<WHV_X64_MSR_EXIT_BITMAP>(), 8);
    assert_eq!(align_of::<WHV_X64_MSR_EXIT_BITMAP>(), 8);
    assert_eq!(size_of::<WHV_CAPABILITY>(), 24);
    assert_eq!(align_of::<WHV_CAPABILITY>(), 8);
    assert_eq!(size_of::<WHV_PARTITION_PROPERTY_CODE>(), 4);
    assert_eq!(align_of::<WHV_PARTITION_PROPERTY_CODE>(), 4);
    assert_eq!(size_of::<WHV_X64_CPUID_RESULT>(), 32);
    assert_eq!(align_of::<WHV_X64_CPUID_RESULT>(), 4);
    assert_eq!(size_of::<WHV_EXCEPTION_TYPE>(), 4);
    assert_eq!(align_of::<WHV_EXCEPTION_TYPE>(), 4);
    assert_eq!(size_of::<WHV_X64_LOCAL_APIC_EMULATION_MODE>(), 4);
    assert_eq!(align_of::<WHV_X64_LOCAL_APIC_EMULATION_MODE>(), 4);
    assert_eq!(size_of::<WHV_PARTITION_PROPERTY>(), 32);
    assert_eq!(align_of::<WHV_PARTITION_PROPERTY>(), 8);
    assert_eq!(size_of::<WHV_MAP_GPA_RANGE_FLAGS>(), 4);
    assert_eq!(align_of::<WHV_MAP_GPA_RANGE_FLAGS>(), 4);
    assert_eq!(size_of::<WHV_TRANSLATE_GVA_FLAGS>(), 4);
    assert_eq!(align_of::<WHV_TRANSLATE_GVA_FLAGS>(), 4);
    assert_eq!(size_of::<WHV_TRANSLATE_GVA_RESULT_CODE>(), 4);
    assert_eq!(align_of::<WHV_TRANSLATE_GVA_RESULT_CODE>(), 4);
    assert_eq!(size_of::<WHV_TRANSLATE_GVA_RESULT>(), 8);
    assert_eq!(align_of::<WHV_TRANSLATE_GVA_RESULT>(), 4);
    assert_eq!(size_of::<WHV_REGISTER_NAME>(), 4);
    assert_eq!(align_of::<WHV_REGISTER_NAME>(), 4);
    assert_eq!(size_of::<WHV_UINT128>(), 16);
    assert_eq!(align_of::<WHV_UINT128>(), 16);
    assert_eq!(size_of::<WHV_X64_FP_REGISTER>(), 16);
    assert_eq!(align_of::<WHV_X64_FP_REGISTER>(), 16);
    assert_eq!(size_of::<WHV_X64_FP_CONTROL_STATUS_REGISTER>(), 16);
    assert_eq!(align_of::<WHV_X64_FP_CONTROL_STATUS_REGISTER>(), 16);
    assert_eq!(size_of::<WHV_X64_XMM_CONTROL_STATUS_REGISTER>(), 16);
    assert_eq!(align_of::<WHV_X64_XMM_CONTROL_STATUS_REGISTER>(), 16);
    assert_eq!(size_of::<WHV_X64_SEGMENT_REGISTER>(), 16);
    assert_eq!(align_of::<WHV_X64_SEGMENT_REGISTER>(), 8);
    assert_eq!(size_of::<WHV_X64_TABLE_REGISTER>(), 16);
    assert_eq!(align_of::<WHV_X64_TABLE_REGISTER>(), 8);
    assert_eq!(size_of::<WHV_X64_INTERRUPT_STATE_REGISTER>(), 8);
    assert_eq!(align_of::<WHV_X64_INTERRUPT_STATE_REGISTER>(), 8);
    assert_eq!(size_of::<WHV_X64_PENDING_INTERRUPTION_REGISTER>(), 8);
    assert_eq!(align_of::<WHV_X64_PENDING_INTERRUPTION_REGISTER>(), 8);
    assert_eq!(size_of::<WHV_X64_DELIVERABILITY_NOTIFICATIONS_REGISTER>(), 8);
    assert_eq!(align_of::<WHV_X64_DELIVERABILITY_NOTIFICATIONS_REGISTER>(), 8);
    assert_eq!(size_of::<WHV_X64_PENDING_EVENT_TYPE>(), 4);
    assert_eq!(align_of::<WHV_X64_PENDING_EVENT_TYPE>(), 4);
    assert_eq!(size_of::<WHV_X64_PENDING_EXCEPTION_EVENT>(), 16);
    assert_eq!(align_of::<WHV_X64_PENDING_EXCEPTION_EVENT>(), 16);
    assert_eq!(size_of::<WHV_X64_PENDING_EXT_INT_EVENT>(), 16);
    assert_eq!(align_of::<WHV_X64_PENDING_EXT_INT_EVENT>(), 16);
    assert_eq!(size_of::<WHV_INTERNAL_ACTIVITY_REGISTER>(), 8);
    assert_eq!(align_of::<WHV_INTERNAL_ACTIVITY_REGISTER>(), 8);
    assert_eq!(size_of::<WHV_X64_PENDING_DEBUG_EXCEPTION>(), 8);
    assert_eq!(align_of::<WHV_X64_PENDING_DEBUG_EXCEPTION>(), 8);
    assert_eq!(size_of::<WHV_REGISTER_VALUE>(), 16);
    assert_eq!(align_of::<WHV_REGISTER_VALUE>(), 16);
    assert_eq!(size_of::<WHV_RUN_VP_EXIT_REASON>(), 4);
    assert_eq!(align_of::<WHV_RUN_VP_EXIT_REASON>(), 4);
    assert_eq!(size_of::<WHV_X64_VP_EXECUTION_STATE>(), 2);
    assert_eq!(align_of::<WHV_X64_VP_EXECUTION_STATE>(), 2);
    assert_eq!(size_of::<WHV_VP_EXIT_CONTEXT>(), 40);
    assert_eq!(align_of::<WHV_VP_EXIT_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_MEMORY_ACCESS_TYPE>(), 4);
    assert_eq!(align_of::<WHV_MEMORY_ACCESS_TYPE>(), 4);
    assert_eq!(size_of::<WHV_MEMORY_ACCESS_INFO>(), 4);
    assert_eq!(align_of::<WHV_MEMORY_ACCESS_INFO>(), 4);
    assert_eq!(size_of::<WHV_MEMORY_ACCESS_CONTEXT>(), 40);
    assert_eq!(align_of::<WHV_MEMORY_ACCESS_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_X64_IO_PORT_ACCESS_INFO>(), 4);
    assert_eq!(align_of::<WHV_X64_IO_PORT_ACCESS_INFO>(), 4);
    assert_eq!(size_of::<WHV_X64_IO_PORT_ACCESS_CONTEXT>(), 96);
    assert_eq!(align_of::<WHV_X64_IO_PORT_ACCESS_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_X64_MSR_ACCESS_INFO>(), 4);
    assert_eq!(align_of::<WHV_X64_MSR_ACCESS_INFO>(), 4);
    assert_eq!(size_of::<WHV_X64_MSR_ACCESS_CONTEXT>(), 24);
    assert_eq!(align_of::<WHV_X64_MSR_ACCESS_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_X64_CPUID_ACCESS_CONTEXT>(), 64);
    assert_eq!(align_of::<WHV_X64_CPUID_ACCESS_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_VP_EXCEPTION_INFO>(), 4);
    assert_eq!(align_of::<WHV_VP_EXCEPTION_INFO>(), 4);
    assert_eq!(size_of::<WHV_VP_EXCEPTION_CONTEXT>(), 40);
    assert_eq!(align_of::<WHV_VP_EXCEPTION_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_X64_UNSUPPORTED_FEATURE_CODE>(), 4);
    assert_eq!(align_of::<WHV_X64_UNSUPPORTED_FEATURE_CODE>(), 4);
    assert_eq!(size_of::<WHV_X64_UNSUPPORTED_FEATURE_CONTEXT>(), 16);
    assert_eq!(align_of::<WHV_X64_UNSUPPORTED_FEATURE_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_RUN_VP_CANCEL_REASON>(), 4);
    assert_eq!(align_of::<WHV_RUN_VP_CANCEL_REASON>(), 4);
    assert_eq!(size_of::<WHV_RUN_VP_CANCELED_CONTEXT>(), 4);
    assert_eq!(align_of::<WHV_RUN_VP_CANCELED_CONTEXT>(), 4);
    assert_eq!(size_of::<WHV_X64_PENDING_INTERRUPTION_TYPE>(), 4);
    assert_eq!(align_of::<WHV_X64_PENDING_INTERRUPTION_TYPE>(), 4);
    assert_eq!(size_of::<WHV_X64_INTERRUPTION_DELIVERABLE_CONTEXT>(), 4);
    assert_eq!(align_of::<WHV_X64_INTERRUPTION_DELIVERABLE_CONTEXT>(), 4);
    assert_eq!(size_of::<WHV_X64_APIC_EOI_CONTEXT>(), 4);
    assert_eq!(align_of::<WHV_X64_APIC_EOI_CONTEXT>(), 4);
    assert_eq!(size_of::<WHV_X64_RDTSC_INFO>(), 8);
    assert_eq!(align_of::<WHV_X64_RDTSC_INFO>(), 8);
    assert_eq!(size_of::<WHV_X64_RDTSC_CONTEXT>(), 40);
    assert_eq!(align_of::<WHV_X64_RDTSC_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_X64_APIC_SMI_CONTEXT>(), 8);
    assert_eq!(align_of::<WHV_X64_APIC_SMI_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_HYPERCALL_CONTEXT>(), 176);
    assert_eq!(align_of::<WHV_HYPERCALL_CONTEXT>(), 16);
    assert_eq!(size_of::<WHV_X64_APIC_INIT_SIPI_CONTEXT>(), 8);
    assert_eq!(align_of::<WHV_X64_APIC_INIT_SIPI_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_X64_APIC_WRITE_TYPE>(), 4);
    assert_eq!(align_of::<WHV_X64_APIC_WRITE_TYPE>(), 4);
    assert_eq!(size_of::<WHV_X64_APIC_WRITE_CONTEXT>(), 16);
    assert_eq!(align_of::<WHV_X64_APIC_WRITE_CONTEXT>(), 8);
    assert_eq!(size_of::<WHV_RUN_VP_EXIT_CONTEXT>(), 224);
    assert_eq!(align_of::<WHV_RUN_VP_EXIT_CONTEXT>(), 16);
    assert_eq!(size_of::<WHV_INTERRUPT_TYPE>(), 4);
    assert_eq!(align_of::<WHV_INTERRUPT_TYPE>(), 4);
    assert_eq!(size_of::<WHV_INTERRUPT_DESTINATION_MODE>(), 4);
    assert_eq!(align_of::<WHV_INTERRUPT_DESTINATION_MODE>(), 4);
    assert_eq!(size_of::<WHV_INTERRUPT_TRIGGER_MODE>(), 4);
    assert_eq!(align_of::<WHV_INTERRUPT_TRIGGER_MODE>(), 4);
    assert_eq!(size_of::<WHV_INTERRUPT_CONTROL>(), 16);
    assert_eq!(align_of::<WHV_INTERRUPT_CONTROL>(), 8);
    assert_eq!(size_of::<WHV_DOORBELL_MATCH_DATA>(), 24);
    assert_eq!(align_of::<WHV_DOORBELL_MATCH_DATA>(), 8);
    assert_eq!(size_of::<WHV_PARTITION_COUNTER_SET>(), 4);
    assert_eq!(align_of::<WHV_PARTITION_COUNTER_SET>(), 4);
    assert_eq!(size_of::<WHV_PARTITION_MEMORY_COUNTERS>(), 24);
    assert_eq!(align_of::<WHV_PARTITION_MEMORY_COUNTERS>(), 8);
    assert_eq!(size_of::<WHV_PROCESSOR_COUNTER_SET>(), 4);
    assert_eq!(align_of::<WHV_PROCESSOR_COUNTER_SET>(), 4);
    assert_eq!(size_of::<WHV_PROCESSOR_RUNTIME_COUNTERS>(), 16);
    assert_eq!(align_of::<WHV_PROCESSOR_RUNTIME_COUNTERS>(), 8);
    assert_eq!(size_of::<WHV_PROCESSOR_INTERCEPT_COUNTER>(), 16);
    assert_eq!(align_of::<WHV_PROCESSOR_INTERCEPT_COUNTER>(), 8);
    assert_eq!(size_of::<WHV_PROCESSOR_INTERCEPT_COUNTERS>(), 176);
    assert_eq!(align_of::<WHV_PROCESSOR_INTERCEPT_COUNTERS>(), 8);
    assert_eq!(size_of::<WHV_PROCESSOR_EVENT_COUNTERS>(), 24);
    assert_eq!(align_of::<WHV_PROCESSOR_EVENT_COUNTERS>(), 8);
    assert_eq!(size_of::<WHV_PROCESSOR_APIC_COUNTERS>(), 40);
    assert_eq!(align_of::<WHV_PROCESSOR_APIC_COUNTERS>(), 8);
}
