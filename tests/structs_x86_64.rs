...
fn um_d3d12() {
    ...
    assert_eq!(size_of::<D3D12_VIEW_INSTANCING_DESC>(), 24);
    assert_eq!(align_of::<D3D12_VIEW_INSTANCING_DESC>(), 8);
    ...
    assert_eq!(size_of::<D3D12_META_COMMAND_PARAMETER_DESC>(), 24);
    assert_eq!(align_of::<D3D12_META_COMMAND_PARAMETER_DESC>(), 8);
    assert_eq!(size_of::<D3D12_META_COMMAND_DESC>(), 32);
    assert_eq!(align_of::<D3D12_META_COMMAND_DESC>(), 8);
    assert_eq!(size_of::<D3D12_STATE_SUBOBJECT>(), 16);
    assert_eq!(align_of::<D3D12_STATE_SUBOBJECT>(), 8);
    assert_eq!(size_of::<D3D12_STATE_OBJECT_CONFIG>(), 4);
    assert_eq!(align_of::<D3D12_STATE_OBJECT_CONFIG>(), 4);
    assert_eq!(size_of::<D3D12_GLOBAL_ROOT_SIGNATURE>(), 8);
    assert_eq!(align_of::<D3D12_GLOBAL_ROOT_SIGNATURE>(), 8);
    assert_eq!(size_of::<D3D12_LOCAL_ROOT_SIGNATURE>(), 8);
    assert_eq!(align_of::<D3D12_LOCAL_ROOT_SIGNATURE>(), 8);
    assert_eq!(size_of::<D3D12_NODE_MASK>(), 4);
    assert_eq!(align_of::<D3D12_NODE_MASK>(), 4);
    assert_eq!(size_of::<D3D12_EXPORT_DESC>(), 24);
    assert_eq!(align_of::<D3D12_EXPORT_DESC>(), 8);
    assert_eq!(size_of::<D3D12_DXIL_LIBRARY_DESC>(), 32);
    assert_eq!(align_of::<D3D12_DXIL_LIBRARY_DESC>(), 8);
    assert_eq!(size_of::<D3D12_EXISTING_COLLECTION_DESC>(), 24);
    assert_eq!(align_of::<D3D12_EXISTING_COLLECTION_DESC>(), 8);
    assert_eq!(size_of::<D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION>(), 24);
    assert_eq!(align_of::<D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION>(), 8);
    assert_eq!(size_of::<D3D12_DXIL_SUBOBJECT_TO_EXPORTS_ASSOCIATION>(), 24);
    assert_eq!(align_of::<D3D12_DXIL_SUBOBJECT_TO_EXPORTS_ASSOCIATION>(), 8);
    assert_eq!(size_of::<D3D12_HIT_GROUP_DESC>(), 40);
    assert_eq!(align_of::<D3D12_HIT_GROUP_DESC>(), 8);
    ...
    assert_eq!(size_of::<D3D12_STATE_OBJECT_DESC>(), 16);
    assert_eq!(align_of::<D3D12_STATE_OBJECT_DESC>(), 8);
    ...
    assert_eq!(size_of::<D3D12_AUTO_BREADCRUMB_NODE>(), 80);
    assert_eq!(align_of::<D3D12_AUTO_BREADCRUMB_NODE>(), 8);
    assert_eq!(size_of::<D3D12_DEVICE_REMOVED_EXTENDED_DATA>(), 16);
    assert_eq!(align_of::<D3D12_DEVICE_REMOVED_EXTENDED_DATA>(), 8);
    assert_eq!(size_of::<D3D12_VERSIONED_DEVICE_REMOVED_EXTENDED_DATA>(), 24);
    assert_eq!(align_of::<D3D12_VERSIONED_DEVICE_REMOVED_EXTENDED_DATA>(), 8);
    ...
    assert_eq!(size_of::<D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS>(), 48);
    assert_eq!(align_of::<D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS>(), 8);
    assert_eq!(size_of::<D3D12_RENDER_PASS_ENDING_ACCESS>(), 56);
    assert_eq!(align_of::<D3D12_RENDER_PASS_ENDING_ACCESS>(), 8);
    assert_eq!(size_of::<D3D12_RENDER_PASS_RENDER_TARGET_DESC>(), 88);
    assert_eq!(align_of::<D3D12_RENDER_PASS_RENDER_TARGET_DESC>(), 8);
    assert_eq!(size_of::<D3D12_RENDER_PASS_DEPTH_STENCIL_DESC>(), 168);
    assert_eq!(align_of::<D3D12_RENDER_PASS_DEPTH_STENCIL_DESC>(), 8);
