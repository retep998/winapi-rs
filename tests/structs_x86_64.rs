...
fn um_dsound() {
    ...
    assert_eq!(size_of::<DSEFFECTDESC>(), 40);
    assert_eq!(align_of::<DSEFFECTDESC>(), 8);
    ...
    assert_eq!(size_of::<DSBUFFERDESC1>(), 24);
    assert_eq!(align_of::<DSBUFFERDESC1>(), 8);
    ...
    assert_eq!(size_of::<DSCBUFFERDESC1>(), 24);
    assert_eq!(align_of::<DSCBUFFERDESC1>(), 8);
    assert_eq!(size_of::<DSCBUFFERDESC>(), 40);
    assert_eq!(align_of::<DSCBUFFERDESC>(), 8);
    assert_eq!(size_of::<DSCBCAPS>(), 16);
    assert_eq!(align_of::<DSCBCAPS>(), 4);
    assert_eq!(size_of::<DSBPOSITIONNOTIFY>(), 16);
    assert_eq!(align_of::<DSBPOSITIONNOTIFY>(), 8);
