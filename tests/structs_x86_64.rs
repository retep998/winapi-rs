...
fn um_dinput() {
    ...
    assert_eq!(align_of::<DICUSTOMFORCE>(), 8);
    assert_eq!(size_of::<DIENVELOPE>(), 20);
    assert_eq!(align_of::<DIENVELOPE>(), 4);
    assert_eq!(size_of::<DIEFFECT_DX5>(), 72);
    assert_eq!(align_of::<DIEFFECT_DX5>(), 8);
    assert_eq!(size_of::<DIEFFECT>(), 80);
    assert_eq!(align_of::<DIEFFECT>(), 8);
    assert_eq!(size_of::<DIFILEEFFECT>(), 296);
    assert_eq!(align_of::<DIFILEEFFECT>(), 8);
    assert_eq!(size_of::<DIEFFESCAPE>(), 40);
    assert_eq!(align_of::<DIEFFESCAPE>(), 8);
    ...
    assert_eq!(align_of::<DIOBJECTDATAFORMAT>(), 8);
    assert_eq!(size_of::<DIDATAFORMAT>(), 32);
    assert_eq!(align_of::<DIDATAFORMAT>(), 8);
    assert_eq!(size_of::<DIACTIONA>(), 48);
    assert_eq!(align_of::<DIACTIONA>(), 8);
    assert_eq!(size_of::<DIACTIONW>(), 48);
    assert_eq!(align_of::<DIACTIONW>(), 8);
    assert_eq!(size_of::<DIACTIONFORMATA>(), 336);
    assert_eq!(align_of::<DIACTIONFORMATA>(), 8);
    assert_eq!(size_of::<DIACTIONFORMATW>(), 600);
    assert_eq!(align_of::<DIACTIONFORMATW>(), 8);
    assert_eq!(size_of::<DICOLORSET>(), 36);
    assert_eq!(align_of::<DICOLORSET>(), 4);
    assert_eq!(size_of::<DICONFIGUREDEVICESPARAMSA>(), 88);
    assert_eq!(align_of::<DICONFIGUREDEVICESPARAMSA>(), 8);
    assert_eq!(size_of::<DICONFIGUREDEVICESPARAMSW>(), 88);
    assert_eq!(align_of::<DICONFIGUREDEVICESPARAMSW>(), 8);
    ...
    assert_eq!(size_of::<DIDEVICEIMAGEINFOHEADERA>(), 40);
    assert_eq!(align_of::<DIDEVICEIMAGEINFOHEADERA>(), 8);
    assert_eq!(size_of::<DIDEVICEIMAGEINFOHEADERW>(), 40);
    assert_eq!(align_of::<DIDEVICEIMAGEINFOHEADERW>(), 8);
    ...
    assert_eq!(size_of::<DIPROPPOINTER>(), 24);
    assert_eq!(align_of::<DIPROPPOINTER>(), 8);
    ...
    assert_eq!(align_of::<DIDEVICEOBJECTDATA>(), 8);
