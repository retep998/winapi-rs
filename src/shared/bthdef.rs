...
DEFINE_BLUETOOTH_UUID128!{SDP_PROTOCOL_UUID,
    SDP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{UDP_PROTOCOL_UUID,
    UDP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{RFCOMM_PROTOCOL_UUID,
    RFCOMM_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{TCP_PROTOCOL_UUID,
    TCP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{TCSBIN_PROTOCOL_UUID,
    TCSBIN_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{TCSAT_PROTOCOL_UUID,
    TCSAT_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{ATT_PROTOCOL_UUID,
    ATT_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{OBEX_PROTOCOL_UUID,
    OBEX_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{IP_PROTOCOL_UUID,
    IP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{FTP_PROTOCOL_UUID,
    FTP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{HTTP_PROTOCOL_UUID,
    HTTP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{WSP_PROTOCOL_UUID,
    WSP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{BNEP_PROTOCOL_UUID,
    BNEP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{UPNP_PROTOCOL_UUID,
    UPNP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{HID_PROTOCOL_UUID,
    HID_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{HCCC_PROTOCOL_UUID,
    HCCC_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{HCDC_PROTOCOL_UUID,
    HCDC_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{HCN_PROTOCOL_UUID,
    HCN_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{AVCTP_PROTOCOL_UUID,
    AVCTP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{AVDTP_PROTOCOL_UUID,
    AVDTP_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{CMPT_PROTOCOL_UUID,
    CMPT_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{UDI_C_PLANE_PROTOCOL_UUID,
    UDI_C_PLANE_PROTOCOL_UUID16}
DEFINE_BLUETOOTH_UUID128!{L2CAP_PROTOCOL_UUID,
