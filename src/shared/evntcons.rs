...
use um::winnt::{ANYSIZE_ARRAY, BOOLEAN, LARGE_INTEGER, PSECURITY_DESCRIPTOR, PSID, PVOID, ULONGLONG};
...
pub const EVENT_HEADER_EXT_TYPE_MAX: USHORT = 0x000E;
...
BITFIELD!{EVENT_HEADER_EXTENDED_DATA_ITEM BitFields: USHORT [
...
pub const EVENT_ENABLE_PROPERTY_SID: ULONG = 0x00000001;
pub const EVENT_ENABLE_PROPERTY_TS_ID: ULONG = 0x00000002;
pub const EVENT_ENABLE_PROPERTY_STACK_TRACE: ULONG = 0x00000004;
pub const EVENT_ENABLE_PROPERTY_PSM_KEY: ULONG = 0x00000008;
pub const EVENT_ENABLE_PROPERTY_IGNORE_KEYWORD_0: ULONG = 0x00000010;
pub const EVENT_ENABLE_PROPERTY_PROVIDER_GROUP: ULONG = 0x00000020;
pub const EVENT_ENABLE_PROPERTY_ENABLE_KEYWORD_0: ULONG = 0x00000040;
pub const EVENT_ENABLE_PROPERTY_PROCESS_START_KEY: ULONG = 0x00000080;
pub const EVENT_ENABLE_PROPERTY_EVENT_KEY: ULONG = 0x00000100;
pub const EVENT_ENABLE_PROPERTY_EXCLUDE_INPRIVATE: ULONG = 0x00000200;
...
#[inline]
pub fn GetEventProcessorIndex(EventRecord: &EVENT_RECORD) -> ULONG {
    if (EventRecord.EventHeader.Flags & EVENT_HEADER_FLAG_PROCESSOR_INDEX) != 0 {
        unsafe { *EventRecord.BufferContext.u.ProcessorIndex() as ULONG }
    } else {
        unsafe { EventRecord.BufferContext.u.s().ProcessorNumber as ULONG }
    }
}
