...
pub const MIB_IPROUTE_TYPE_OTHER: DWORD = 1;
pub const MIB_IPROUTE_TYPE_INVALID: DWORD = 2;
pub const MIB_IPROUTE_TYPE_DIRECT: DWORD = 3;
pub const MIB_IPROUTE_TYPE_INDIRECT: DWORD = 4;
