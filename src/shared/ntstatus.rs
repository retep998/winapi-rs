...
pub const STATUS_NO_WORK_DONE: NTSTATUS = 0x80000032u32 as i32;
...
pub const STATUS_CLOUD_FILE_PROPERTY_BLOB_CHECKSUM_MISMATCH: NTSTATUS = 0x8000CF00u32 as i32;
...
pub const STATUS_CPU_SET_INVALID: NTSTATUS = 0xC00001AFu32 as i32;
...
pub const STATUS_CALLBACK_INVOKE_INLINE: NTSTATUS = 0xC000048Bu32 as i32;
pub const STATUS_BLOCK_TOO_MANY_REFERENCES: NTSTATUS = 0xC000048Cu32 as i32;
pub const STATUS_MARKED_TO_DISALLOW_WRITES: NTSTATUS = 0xC000048Du32 as i32;
pub const STATUS_NETWORK_ACCESS_DENIED_EDP: NTSTATUS = 0xC000048Eu32 as i32;
pub const STATUS_ENCLAVE_FAILURE: NTSTATUS = 0xC000048Fu32 as i32;
pub const STATUS_PNP_NO_COMPAT_DRIVERS: NTSTATUS = 0xC0000490u32 as i32;
pub const STATUS_PNP_DRIVER_PACKAGE_NOT_FOUND: NTSTATUS = 0xC0000491u32 as i32;
pub const STATUS_PNP_DRIVER_CONFIGURATION_NOT_FOUND: NTSTATUS = 0xC0000492u32 as i32;
pub const STATUS_PNP_DRIVER_CONFIGURATION_INCOMPLETE: NTSTATUS = 0xC0000493u32 as i32;
pub const STATUS_PNP_FUNCTION_DRIVER_REQUIRED: NTSTATUS = 0xC0000494u32 as i32;
pub const STATUS_PNP_DEVICE_CONFIGURATION_PENDING: NTSTATUS = 0xC0000495u32 as i32;
pub const STATUS_DEVICE_HINT_NAME_BUFFER_TOO_SMALL: NTSTATUS = 0xC0000496u32 as i32;
pub const STATUS_PACKAGE_NOT_AVAILABLE: NTSTATUS = 0xC0000497u32 as i32;
pub const STATUS_DEVICE_IN_MAINTENANCE: NTSTATUS = 0xC0000499u32 as i32;
pub const STATUS_NOT_SUPPORTED_ON_DAX: NTSTATUS = 0xC000049Au32 as i32;
pub const STATUS_FREE_SPACE_TOO_FRAGMENTED: NTSTATUS = 0xC000049Bu32 as i32;
pub const STATUS_DAX_MAPPING_EXISTS: NTSTATUS = 0xC000049Cu32 as i32;
pub const STATUS_CHILD_PROCESS_BLOCKED: NTSTATUS = 0xC000049Du32 as i32;
pub const STATUS_STORAGE_LOST_DATA_PERSISTENCE: NTSTATUS = 0xC000049Eu32 as i32;
...
pub const STATUS_CONTAINER_ASSIGNED: NTSTATUS = 0xC0000508u32 as i32;
pub const STATUS_JOB_NO_CONTAINER: NTSTATUS = 0xC0000509u32 as i32;
pub const STATUS_DEVICE_UNRESPONSIVE: NTSTATUS = 0xC000050Au32 as i32;
pub const STATUS_REPARSE_POINT_ENCOUNTERED: NTSTATUS = 0xC000050Bu32 as i32;
...
pub const STATUS_LPC_HANDLE_COUNT_EXCEEDED: NTSTATUS = 0xC0000722u32 as i32;
...
pub const STATUS_EOF_ON_GHOSTED_RANGE: NTSTATUS = 0xC000A007u32 as i32;
...
pub const STATUS_CLOUD_FILE_PROVIDER_UNKNOWN: NTSTATUS = 0xC000CF00u32 as i32;
pub const STATUS_CLOUD_FILE_PROVIDER_NOT_RUNNING: NTSTATUS = 0xC000CF01u32 as i32;
pub const STATUS_CLOUD_FILE_METADATA_CORRUPT: NTSTATUS = 0xC000CF02u32 as i32;
pub const STATUS_CLOUD_FILE_METADATA_TOO_LARGE: NTSTATUS = 0xC000CF03u32 as i32;
pub const STATUS_CLOUD_FILE_PROPERTY_BLOB_TOO_LARGE: NTSTATUS = 0x8000CF04u32 as i32;
...
pub const STATUS_CLUSTER_CSV_INVALID_HANDLE: NTSTATUS = 0xC0130029u32 as i32;
pub const STATUS_CLUSTER_CSV_SUPPORTED_ONLY_ON_COORDINATOR: NTSTATUS = 0xC0130030u32 as i32;
...
pub const STATUS_NDIS_DOT11_AP_CHANNEL_CURRENTLY_NOT_AVAILABLE: NTSTATUS = 0xC0232005u32 as i32;
pub const STATUS_NDIS_DOT11_AP_BAND_CURRENTLY_NOT_AVAILABLE: NTSTATUS = 0xC0232006u32 as i32;
pub const STATUS_NDIS_DOT11_AP_CHANNEL_NOT_ALLOWED: NTSTATUS = 0xC0232007u32 as i32;
pub const STATUS_NDIS_DOT11_AP_BAND_NOT_ALLOWED: NTSTATUS = 0xC0232008u32 as i32;
...
pub const STATUS_HV_INVALID_VP_STATE: NTSTATUS = 0xC0350015u32 as i32;
...
pub const STATUS_HV_INVALID_CPU_GROUP_ID: NTSTATUS = 0xC035006Fu32 as i32;
pub const STATUS_HV_INVALID_CPU_GROUP_STATE: NTSTATUS = 0xC0350070u32 as i32;
pub const STATUS_HV_NOT_ALLOWED_WITH_NESTED_VIRT_ACTIVE: NTSTATUS = 0xC0350071u32 as i32;
...
pub const STATUS_VID_VTL_ACCESS_DENIED: NTSTATUS = 0xC037002Au32 as i32;
...
pub const STATUS_SECUREBOOT_POLICY_NOT_AUTHORIZED: NTSTATUS = 0xC0430008u32 as i32;
pub const STATUS_SECUREBOOT_POLICY_UNKNOWN: NTSTATUS = 0xC0430009u32 as i32;
pub const STATUS_SECUREBOOT_POLICY_MISSING_ANTIROLLBACKVERSION: NTSTATUS = 0xC043000Au32 as i32;
pub const STATUS_SECUREBOOT_PLATFORM_ID_MISMATCH: NTSTATUS = 0xC043000Bu32 as i32;
pub const STATUS_SECUREBOOT_POLICY_ROLLBACK_DETECTED: NTSTATUS = 0xC043000Cu32 as i32;
pub const STATUS_SECUREBOOT_POLICY_UPGRADE_MISMATCH: NTSTATUS = 0xC043000Du32 as i32;
pub const STATUS_SECUREBOOT_REQUIRED_POLICY_FILE_MISSING: NTSTATUS = 0xC043000Eu32 as i32;
pub const STATUS_SECUREBOOT_NOT_BASE_POLICY: NTSTATUS = 0xC043000Fu32 as i32;
pub const STATUS_SECUREBOOT_NOT_SUPPLEMENTAL_POLICY: NTSTATUS = 0xC0430010u32 as i32;
pub const STATUS_PLATFORM_MANIFEST_NOT_AUTHORIZED: NTSTATUS = 0xC0EB0001u32 as i32;
pub const STATUS_PLATFORM_MANIFEST_INVALID: NTSTATUS = 0xC0EB0002u32 as i32;
pub const STATUS_PLATFORM_MANIFEST_FILE_NOT_AUTHORIZED: NTSTATUS = 0xC0EB0003u32 as i32;
pub const STATUS_PLATFORM_MANIFEST_CATALOG_NOT_AUTHORIZED: NTSTATUS = 0xC0EB0004u32 as i32;
pub const STATUS_PLATFORM_MANIFEST_BINARY_ID_NOT_FOUND: NTSTATUS = 0xC0EB0005u32 as i32;
pub const STATUS_PLATFORM_MANIFEST_NOT_ACTIVE: NTSTATUS = 0xC0EB0006u32 as i32;
pub const STATUS_PLATFORM_MANIFEST_NOT_SIGNED: NTSTATUS = 0xC0EB0007u32 as i32;
...
pub const STATUS_CLIP_LICENSE_NOT_FOUND: NTSTATUS = 0xC0EA0002u32 as i32;
pub const STATUS_CLIP_DEVICE_LICENSE_MISSING: NTSTATUS = 0xC0EA0003u32 as i32;
pub const STATUS_CLIP_LICENSE_INVALID_SIGNATURE: NTSTATUS = 0xC0EA0004u32 as i32;
pub const STATUS_CLIP_KEYHOLDER_LICENSE_MISSING_OR_INVALID: NTSTATUS = 0xC0EA0005u32 as i32;
pub const STATUS_CLIP_LICENSE_EXPIRED: NTSTATUS = 0xC0EA0006u32 as i32;
pub const STATUS_CLIP_LICENSE_SIGNED_BY_UNKNOWN_SOURCE: NTSTATUS = 0xC0EA0007u32 as i32;
pub const STATUS_CLIP_LICENSE_NOT_SIGNED: NTSTATUS = 0xC0EA0008u32 as i32;
pub const STATUS_CLIP_LICENSE_HARDWARE_ID_OUT_OF_TOLERANCE: NTSTATUS = 0xC0EA0009u32 as i32;
pub const STATUS_CLIP_LICENSE_DEVICE_ID_MISMATCH: NTSTATUS = 0xC0EA000Au32 as i32;
...
pub const STATUS_SPACES_FAULT_DOMAIN_TYPE_INVALID: NTSTATUS = 0xC0E70001u32 as i32;
...
pub const STATUS_SPACES_DRIVE_SPLIT: NTSTATUS = 0xC0E7001Cu32 as i32;
pub const STATUS_SPACES_DRIVE_LOST_DATA: NTSTATUS = 0xC0E7001Du32 as i32;
pub const STATUS_VOLSNAP_BOOTFILE_NOT_VALID: NTSTATUS = 0xC0500003u32 as i32;
pub const STATUS_VOLSNAP_ACTIVATION_TIMEOUT: NTSTATUS = 0xC0500004u32 as i32;
