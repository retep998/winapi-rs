...
use shared::dxgi::{
    DXGI_MAPPED_RECT, DXGI_SWAP_EFFECT, DXGI_USAGE, IDXGIAdapter1, IDXGIAdapter1Vtbl, IDXGIDevice1,
...
use shared::dxgicommon::{DXGI_RATIONAL, DXGI_SAMPLE_DESC};
use shared::dxgiformat::DXGI_FORMAT;
use shared::dxgitype::{
    DXGI_MODE_DESC, DXGI_MODE_ROTATION, DXGI_MODE_SCALING, DXGI_MODE_SCANLINE_ORDER, DXGI_RGBA,
};
...
ENUM!{enum DXGI_OFFER_RESOURCE_PRIORITY {
