...
pub type PNET_IF_OBJECT_ID = *mut ULONG32;
...
pub const NET_IF_OPER_STATUS_DOWN_NOT_AUTHENTICATED: ULONG = 0x00000001;
pub const NET_IF_OPER_STATUS_DOWN_NOT_MEDIA_CONNECTED: ULONG = 0x00000002;
pub const NET_IF_OPER_STATUS_DORMANT_PAUSED: ULONG = 0x00000004;
pub const NET_IF_OPER_STATUS_DORMANT_LOW_POWER: ULONG = 0x00000008;
pub type NET_IF_COMPARTMENT_SCOPE = UINT32;
pub type PNET_IF_COMPARTMENT_SCOPE = *mut UINT32;
...
pub const NET_IF_OID_IF_ALIAS: ULONG = 0x00000001;
pub const NET_IF_OID_COMPARTMENT_ID: ULONG = 0x00000002;
pub const NET_IF_OID_NETWORK_GUID: ULONG = 0x00000003;
pub const NET_IF_OID_IF_ENTRY: ULONG = 0x00000004;
pub const NET_SITEID_UNSPECIFIED: ULONG = 0;
pub const NET_SITEID_MAXUSER: ULONG = 0x07ffffff;
pub const NET_SITEID_MAXSYSTEM: ULONG = 0x0fffffff;
...
BITFIELD!(NET_LUID_LH_Info BitFields: ULONG64 [
...
pub const IFI_UNSPECIFIED: NET_IFINDEX = NET_IFINDEX_UNSPECIFIED;
pub const NIIF_HARDWARE_INTERFACE: ULONG = 0x00000001;
pub const NIIF_FILTER_INTERFACE: ULONG = 0x00000002;
pub const NIIF_NDIS_RESERVED1: ULONG = 0x00000004;
pub const NIIF_NDIS_RESERVED2: ULONG = 0x00000008;
pub const NIIF_NDIS_RESERVED3: ULONG = 0x00000010;
pub const NIIF_NDIS_WDM_INTERFACE: ULONG = 0x00000020;
pub const NIIF_NDIS_ENDPOINT_INTERFACE: ULONG = 0x00000040;
pub const NIIF_NDIS_ISCSI_INTERFACE: ULONG = 0x00000080;
pub const NIIF_NDIS_RESERVED4: ULONG = 0x00000100;
pub const NIIF_WAN_TUNNEL_TYPE_UNKNOWN: ULONG = -1i32 as u32;
...
pub const NET_IF_LINK_SPEED_UNKNOWN: ULONG64 = -1i64 as u64;
...
pub const NIIF_BUS_NUMBER_UNKNOWN: ULONG64 = -1i64 as u64;
pub const NIIF_SLOT_NUMBER_UNKNOWN: ULONG64 = -1i64 as u64;
pub const NIIF_FUNCTION_NUMBER_UNKNOWN: ULONG64 = -1i64 as u64;
...
STRUCT!{struct IF_COUNTED_STRING_LH {
    Length: USHORT,
    String_: [WCHAR; IF_MAX_STRING_SIZE + 1],
}}
