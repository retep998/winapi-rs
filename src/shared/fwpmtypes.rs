...
use shared::fwptypes::{FWP_ACTION_TYPE, FWP_AF, FWP_BYTE_ARRAY6, FWP_BYTE_ARRAY16, FWP_BYTE_BLOB, FWP_CLASSIFY_OPTION_TYPE, FWP_CONDITION_VALUE0, FWP_DATA_TYPE, FWP_DIRECTION, FWPM_DISPLAY_DATA0, FWP_FILTER_ENUM_TYPE, FWP_IP_VERSION, FWP_MATCH_TYPE, FWP_VALUE0};
use shared::guiddef::GUID;
use shared::iketypes::{IKEEXT_AUTHENTICATION_METHOD_TYPE, IKEEXT_CREDENTIAL2, IKEEXT_EM_SA_STATE, IKEEXT_KEY_MODULE_TYPE, IKEEXT_MM_SA_STATE, IKEEXT_POLICY0, IKEEXT_POLICY1, IKEEXT_POLICY2, IKEEXT_PROPOSAL0, IKEEXT_QM_SA_STATE, IKEEXT_SA_ROLE};
use shared::ipsectypes::{IPSEC_DOSP_OPTIONS0, IPSEC_FAILURE_POINT, IPSEC_KEYING_POLICY0, IPSEC_KEYING_POLICY1, IPSEC_SA_SPI, IPSEC_TRAFFIC_TYPE, IPSEC_TRANSPORT_POLICY0, IPSEC_TRANSPORT_POLICY1, IPSEC_TRANSPORT_POLICY2, IPSEC_TUNNEL_POLICY0, IPSEC_TUNNEL_POLICY1, IPSEC_TUNNEL_POLICY2, IPSEC_TUNNEL_POLICY3};
