...
interface IDirect3D9(IDirect3D9Vtbl): IUnknown(IUnknownVtbl) {
    ...
    fn GetAdapterIdentifier(
        Adapter: UINT, Flags: DWORD, pIdentifier: *mut D3DADAPTER_IDENTIFIER9
    ) -> HRESULT,
    fn GetAdapterModeCount(Adapter: UINT, Format: D3DFORMAT) -> UINT,
    fn EnumAdapterModes(
        Adapter: UINT, Format: D3DFORMAT, Mode: UINT, pMode: *mut D3DDISPLAYMODE
    ) -> HRESULT,
    fn GetAdapterDisplayMode(
        Adapter: UINT, pMode: *mut D3DDISPLAYMODE
    ) -> HRESULT,
    fn CheckDeviceType(
        Adapter: UINT, DevType: D3DDEVTYPE, AdapterFormat: D3DFORMAT,
        BackBufferFormat: D3DFORMAT, bWindowed: BOOL
    ) -> HRESULT,
    fn CheckDeviceFormat(
        Adapter: UINT, DeviceType: D3DDEVTYPE, AdapterFormat: D3DFORMAT,
        Usage: DWORD, RType: D3DRESOURCETYPE, CheckFormat: D3DFORMAT
    ) -> HRESULT,
    fn CheckDeviceMultiSampleType(
        Adapter: UINT, DeviceType: D3DDEVTYPE, SurfaceFormat: D3DFORMAT,
    ...
    fn CheckDeviceFormatConversion(
        Adapter: UINT, DeviceType: D3DDEVTYPE, SourceFormat: D3DFORMAT,
        TargetFormat: D3DFORMAT
    ) -> HRESULT,
    fn GetDeviceCaps(
        Adapter: UINT, DeviceType: D3DDEVTYPE, pCaps: *mut D3DCAPS9
    ) -> HRESULT,
    fn GetAdapterMonitor(Adapter: UINT) -> HMONITOR,
    fn CreateDevice(
...
interface IDirect3DDevice9(IDirect3DDevice9Vtbl): IUnknown(IUnknownVtbl) {
    ...
    fn GetDirect3D(ppD3D9: *mut *mut IDirect3D9) -> HRESULT,
    fn GetDeviceCaps(pCaps: *mut D3DCAPS9) -> HRESULT,
    fn GetDisplayMode(iSwapChain: UINT, pMode: *mut D3DDISPLAYMODE) -> HRESULT,
    fn GetCreationParameters(
        pParameters: *mut D3DDEVICE_CREATION_PARAMETERS
    ) -> HRESULT,
    fn SetCursorProperties(
        XHotSpot: UINT, YHotSpot: UINT, pCursorBitmap: *mut IDirect3DSurface9
    ) -> HRESULT,
    fn SetCursorPosition(X: INT, Y: INT, Flags: DWORD) -> (),
    fn ShowCursor(bShow: BOOL) -> BOOL,
    fn CreateAdditionalSwapChain(
        pPresentationParameters: *mut D3DPRESENT_PARAMETERS,
        pSwapChain: *mut *mut IDirect3DSwapChain9
    ) -> HRESULT,
    fn GetSwapChain(
        iSwapChain: UINT, pSwapChain: *mut *mut IDirect3DSwapChain9
    ) -> HRESULT,
    fn GetNumberOfSwapChains() -> UINT,
    fn Reset(pPresentationParameters: *mut D3DPRESENT_PARAMETERS) -> HRESULT,
    fn Present(
        pSourceRect: *const RECT, pDestRect: *const RECT,
        hDestWindowOverride: HWND, pDirtyRegion: *const RGNDATA
    ) -> HRESULT,
    fn GetBackBuffer(
        iSwapChain: UINT, iBackBuffer: UINT, Type: D3DBACKBUFFER_TYPE,
        ppBackBuffer: *mut *mut IDirect3DSurface9
    ) -> HRESULT,
    fn GetRasterStatus(
        iSwapChain: UINT, pRasterStatus: *mut D3DRASTER_STATUS
    ) -> HRESULT,
    fn SetDialogBoxMode(bEnableDialogs: BOOL) -> HRESULT,
    fn SetGammaRamp(
        iSwapChain: UINT, Flags: DWORD, pRamp: *const D3DGAMMARAMP
    ) -> (),
    fn GetGammaRamp(iSwapChain: UINT, pRamp: *mut D3DGAMMARAMP) -> (),
    fn CreateTexture(
        Width: UINT, Height: UINT, Levels: UINT, Usage: DWORD,
        Format: D3DFORMAT, Pool: D3DPOOL, ppTexture: *mut *mut IDirect3DTexture9,
        pSharedHandle: *mut HANDLE
    ) -> HRESULT,
    fn CreateVolumeTexture(
        Width: UINT, Height: UINT, Depth: UINT, Levels: UINT, Usage: DWORD,
    ...
    fn CreateVertexBuffer(
        Length: UINT, Usage: DWORD, FVF: DWORD, Pool: D3DPOOL,
    ...
    fn CreateRenderTarget(
        Width: UINT, Height: UINT, Format: D3DFORMAT,
    ...
    fn UpdateSurface(
        pSourceSurface: *mut IDirect3DSurface9, pSourceRect: *const RECT,
    ...
    fn GetRenderTargetData(
        pRenderTarget: *mut IDirect3DSurface9, pDestSurface: *mut IDirect3DSurface9
    ) -> HRESULT,
    fn GetFrontBufferData(
        iSwapChain: UINT, pDestSurface: *mut IDirect3DSurface9
    ) -> HRESULT,
    fn StretchRect(
        pSourceSurface: *mut IDirect3DSurface9, pSourceRect: *const RECT,
    ...
    fn ColorFill(
        pSurface: *mut IDirect3DSurface9, pRect: *const RECT, color: D3DCOLOR
    ) -> HRESULT,
    fn CreateOffscreenPlainSurface(
        Width: UINT, Height: UINT, Format: D3DFORMAT, Pool: D3DPOOL,
        ppSurface: *mut *mut IDirect3DSurface9, pSharedHandle: *mut HANDLE
    ) -> HRESULT,
    fn SetRenderTarget(
        RenderTargetIndex: DWORD, pRenderTarget: *mut IDirect3DSurface9
    ) -> HRESULT,
    fn GetRenderTarget(
        RenderTargetIndex: DWORD, ppRenderTarget: *mut *mut IDirect3DSurface9
    ) -> HRESULT,
    fn SetDepthStencilSurface(pNewZStencil: *mut IDirect3DSurface9) -> HRESULT,
    ...
    fn EndScene() -> HRESULT,
    fn Clear(
        Count: DWORD, pRects: *const D3DRECT, Flags: DWORD, Color: D3DCOLOR,
        Z: FLOAT, Stencil: DWORD
    ) -> HRESULT,
    fn SetTransform(
        State: D3DTRANSFORMSTATETYPE, pMatrix: *const D3DMATRIX
    ) -> HRESULT,
    fn GetTransform(
        State: D3DTRANSFORMSTATETYPE, pMatrix: *mut D3DMATRIX
    ) -> HRESULT,
    fn MultiplyTransform(
        arg1: D3DTRANSFORMSTATETYPE, arg2: *const D3DMATRIX
    ) -> HRESULT,
    fn SetViewport(pViewport: *const D3DVIEWPORT9) -> HRESULT,
    fn GetViewport(pViewport: *mut D3DVIEWPORT9) -> HRESULT,
    fn SetMaterial(pMaterial: *const D3DMATERIAL9) -> HRESULT,
    fn GetMaterial(pMaterial: *mut D3DMATERIAL9) -> HRESULT,
    fn SetLight(Index: DWORD, arg1: *const D3DLIGHT9) -> HRESULT,
    fn GetLight(Index: DWORD, arg1: *mut D3DLIGHT9) -> HRESULT,
    fn LightEnable(Index: DWORD, Enable: BOOL) -> HRESULT,
    fn GetLightEnable(Index: DWORD, pEnable: *mut BOOL) -> HRESULT,
    fn SetClipPlane(Index: DWORD, pPlane: *const FLOAT) -> HRESULT,
    fn GetClipPlane(Index: DWORD, pPlane: *mut FLOAT) -> HRESULT,
    fn SetRenderState(State: D3DRENDERSTATETYPE, Value: DWORD) -> HRESULT,
    fn GetRenderState(State: D3DRENDERSTATETYPE, pValue: *mut DWORD) -> HRESULT,
    fn CreateStateBlock(
        Type: D3DSTATEBLOCKTYPE, ppSB: *mut *mut IDirect3DStateBlock9
    ) -> HRESULT,
    fn BeginStateBlock() -> HRESULT,
    fn EndStateBlock(ppSB: *mut *mut IDirect3DStateBlock9) -> HRESULT,
    fn SetClipStatus(pClipStatus: *const D3DCLIPSTATUS9) -> HRESULT,
    fn GetClipStatus(pClipStatus: *mut D3DCLIPSTATUS9) -> HRESULT,
    fn GetTexture(
        Stage: DWORD, ppTexture: *mut *mut IDirect3DBaseTexture9
    ) -> HRESULT,
    fn SetTexture(Stage: DWORD, pTexture: *mut IDirect3DBaseTexture9) -> HRESULT,
    fn GetTextureStageState(
        Stage: DWORD, Type: D3DTEXTURESTAGESTATETYPE, pValue: *mut DWORD
    ) -> HRESULT,
    fn SetTextureStageState(
        Stage: DWORD, Type: D3DTEXTURESTAGESTATETYPE, Value: DWORD
    ) -> HRESULT,
    fn GetSamplerState(
        Sampler: DWORD, Type: D3DSAMPLERSTATETYPE, pValue: *mut DWORD
    ) -> HRESULT,
    fn SetSamplerState(
        Sampler: DWORD, Type: D3DSAMPLERSTATETYPE, Value: DWORD
    ) -> HRESULT,
    fn ValidateDevice(pNumPasses: *mut DWORD) -> HRESULT,
    fn SetPaletteEntries(
        PaletteNumber: UINT, pEntries: *const PALETTEENTRY
    ) -> HRESULT,
    fn GetPaletteEntries(
        PaletteNumber: UINT, pEntries: *mut PALETTEENTRY
    ) -> HRESULT,
    fn SetCurrentTexturePalette(PaletteNumber: UINT) -> HRESULT,
    fn GetCurrentTexturePalette(PaletteNumber: *mut UINT) -> HRESULT,
    fn SetScissorRect(pRect: *const RECT) -> HRESULT,
    fn GetScissorRect(pRect: *mut RECT) -> HRESULT,
    fn SetSoftwareVertexProcessing(bSoftware: BOOL) -> HRESULT,
    fn GetSoftwareVertexProcessing() -> BOOL,
    fn SetNPatchMode(nSegments: FLOAT) -> HRESULT,
    fn GetNPatchMode() -> FLOAT,
    fn DrawPrimitive(
        PrimitiveType: D3DPRIMITIVETYPE, StartVertex: UINT, PrimitiveCount: UINT
    ) -> HRESULT,
    fn DrawIndexedPrimitive(
        arg1: D3DPRIMITIVETYPE, BaseVertexIndex: INT, MinVertexIndex: UINT,
        NumVertices: UINT, startIndex: UINT, primCount: UINT
    ) -> HRESULT,
    fn DrawPrimitiveUP(
        PrimitiveType: D3DPRIMITIVETYPE, PrimitiveCount: UINT,
        pVertexStreamZeroData: *const VOID, VertexStreamZeroStride: UINT
    ) -> HRESULT,
    fn DrawIndexedPrimitiveUP(
        PrimitiveType: D3DPRIMITIVETYPE, MinVertexIndex: UINT, NumVertices: UINT,
        PrimitiveCount: UINT, pIndexData: *const VOID, IndexDataFormat: D3DFORMAT,
        pVertexStreamZeroData: *const VOID, VertexStreamZeroStride: UINT
    ) -> HRESULT,
    fn ProcessVertices(
        SrcStartIndex: UINT, DestIndex: UINT, VertexCount: UINT,
    ...
    fn SetVertexDeclaration(pDecl: *mut IDirect3DVertexDeclaration9) -> HRESULT,
    fn GetVertexDeclaration(ppDecl: *mut *mut IDirect3DVertexDeclaration9) -> HRESULT,
    fn SetFVF(FVF: DWORD) -> HRESULT,
    fn GetFVF(pFVF: *mut DWORD) -> HRESULT,
    fn CreateVertexShader(
        pFunction: *const DWORD, ppShader: *mut *mut IDirect3DVertexShader9
    ) -> HRESULT,
    fn SetVertexShader(pShader: *mut IDirect3DVertexShader9) -> HRESULT,
    fn GetVertexShader(ppShader: *mut *mut IDirect3DVertexShader9) -> HRESULT,
    fn SetVertexShaderConstantF(
        StartRegister: UINT, pConstantData: *const FLOAT, Vector4fCount: UINT
    ) -> HRESULT,
    fn GetVertexShaderConstantF(
        StartRegister: UINT, pConstantData: *mut FLOAT, Vector4fCount: UINT
    ) -> HRESULT,
    fn SetVertexShaderConstantI(
        StartRegister: UINT, pConstantData: *const INT, Vector4iCount: UINT
    ) -> HRESULT,
    fn GetVertexShaderConstantI(
        StartRegister: UINT, pConstantData: *mut INT, Vector4iCount: UINT
    ) -> HRESULT,
    fn SetVertexShaderConstantB(
        StartRegister: UINT, pConstantData: *const BOOL, BoolCount: UINT
    ) -> HRESULT,
    fn GetVertexShaderConstantB(
        StartRegister: UINT, pConstantData: *mut BOOL, BoolCount: UINT
    ) -> HRESULT,
    fn SetStreamSource(
        StreamNumber: UINT, pStreamData: *mut IDirect3DVertexBuffer9,
        OffsetInBytes: UINT, Stride: UINT
    ) -> HRESULT,
    fn GetStreamSource(
        StreamNumber: UINT, ppStreamData: *mut *mut IDirect3DVertexBuffer9,
        pOffsetInBytes: *mut UINT, pStride: *mut UINT
    ) -> HRESULT,
    fn SetStreamSourceFreq(StreamNumber: UINT, Setting: UINT) -> HRESULT,
    fn GetStreamSourceFreq(StreamNumber: UINT, pSetting: *mut UINT) -> HRESULT,
    fn SetIndices(pIndexData: *mut IDirect3DIndexBuffer9) -> HRESULT,
    fn GetIndices(ppIndexData: *mut *mut IDirect3DIndexBuffer9) -> HRESULT,
    fn CreatePixelShader(
        pFunction: *const DWORD, ppShader: *mut *mut IDirect3DPixelShader9
    ) -> HRESULT,
    fn SetPixelShader(pShader: *mut IDirect3DPixelShader9) -> HRESULT,
    fn GetPixelShader(ppShader: *mut *mut IDirect3DPixelShader9) -> HRESULT,
    ...
    fn DrawRectPatch(
        Handle: UINT, pNumSegs: *const FLOAT,
    ...
    fn CreateQuery(
        Type: D3DQUERYTYPE, ppQuery: *mut *mut IDirect3DQuery9
    ) -> HRESULT
}
);
...
interface IDirect3DSwapChain9(IDirect3DSwapChain9Vtbl): IUnknown(IUnknownVtbl) {
    ...
    fn GetFrontBufferData(pDestSurface: *mut IDirect3DSurface9) -> HRESULT,
    fn GetBackBuffer(
        iBackBuffer: UINT, Type: D3DBACKBUFFER_TYPE,
        ppBackBuffer: *mut *mut IDirect3DSurface9
    ) -> HRESULT,
    fn GetRasterStatus(pRasterStatus: *mut D3DRASTER_STATUS) -> HRESULT,
    fn GetDisplayMode(pMode: *mut D3DDISPLAYMODE) -> HRESULT,
    fn GetDevice(ppDevice: *mut *mut IDirect3DDevice9) -> HRESULT,
...
interface IDirect3DResource9(IDirect3DResource9Vtbl): IUnknown(IUnknownVtbl) {
    fn GetDevice(ppDevice: *mut *mut IDirect3DDevice9) -> HRESULT,
    fn SetPrivateData(
        refguid: *const GUID, pData: *const VOID, SizeOfData: DWORD,
        Flags: DWORD
    ) -> HRESULT,
    fn GetPrivateData(
        refguid: *const GUID, pData: *mut VOID, pSizeOfData: *mut DWORD
    ) -> HRESULT,
    fn FreePrivateData(refguid: *const GUID) -> HRESULT,
    fn SetPriority(PriorityNew: DWORD) -> DWORD,
...
interface IDirect3DVertexDeclaration9(IDirect3DVertexDeclaration9Vtbl): IUnknown(IUnknownVtbl) {
    fn GetDevice(ppDevice: *mut *mut IDirect3DDevice9) -> HRESULT,
    fn GetDeclaration(
        pElement: *mut D3DVERTEXELEMENT9, pNumElements: *mut UINT
    ) -> HRESULT
}
);
...
interface IDirect3DBaseTexture9(IDirect3DBaseTexture9Vtbl):
    ...
    fn SetAutoGenFilterType(FilterType: D3DTEXTUREFILTERTYPE) -> HRESULT,
...
interface IDirect3DTexture9(IDirect3DTexture9Vtbl):
    ...
    fn GetSurfaceLevel(
        Level: UINT, ppSurfaceLevel: *mut *mut IDirect3DSurface9
    ) -> HRESULT,
    fn LockRect(
        Level: UINT, pLockedRect: *mut D3DLOCKED_RECT, pRect: *const RECT,
        Flags: DWORD
    ) -> HRESULT,
    fn UnlockRect(Level: UINT) -> HRESULT,
    fn AddDirtyRect(pDirtyRect: *const RECT) -> HRESULT
}}
...
interface IDirect3DVolumeTexture9(IDirect3DVolumeTexture9Vtbl):
    ...
    fn GetVolumeLevel(
        Level: UINT, ppVolumeLevel: *mut *mut IDirect3DVolume9
    ) -> HRESULT,
    fn LockBox(
        Level: UINT, pLockedVolume: *mut D3DLOCKED_BOX, pBox: *const D3DBOX,
        Flags: DWORD
    ) -> HRESULT,
    fn UnlockBox(Level: UINT) -> HRESULT,
...
interface IDirect3DCubeTexture9(IDirect3DCubeTexture9Vtbl):
    ...
    fn GetCubeMapSurface(
        FaceType: D3DCUBEMAP_FACES, Level: UINT,
        ppCubeMapSurface: *mut *mut IDirect3DSurface9
    ) -> HRESULT,
    fn LockRect(
        FaceType: D3DCUBEMAP_FACES, Level: UINT, pLockedRect: *mut D3DLOCKED_RECT,
        pRect: *const RECT, Flags: DWORD
    ) -> HRESULT,
    fn UnlockRect(FaceType: D3DCUBEMAP_FACES, Level: UINT) -> HRESULT,
    fn AddDirtyRect(
        FaceType: D3DCUBEMAP_FACES, pDirtyRect: *const RECT
    ) -> HRESULT
}}
...
interface IDirect3DVertexBuffer9(IDirect3DVertexBuffer9Vtbl):
    ...
    fn Unlock() -> HRESULT,
    fn GetDesc(pDesc: *mut D3DVERTEXBUFFER_DESC) -> HRESULT
}}
...
interface IDirect3DIndexBuffer9(IDirect3DIndexBuffer9Vtbl):
    ...
    fn Unlock() -> HRESULT,
    fn GetDesc(pDesc: *mut D3DINDEXBUFFER_DESC) -> HRESULT
}}
...
interface IDirect3DSurface9(IDirect3DSurface9Vtbl): IDirect3DResource9(IDirect3DResource9Vtbl) {
    ...
    fn GetDC(phdc: *mut HDC) -> HRESULT,
    fn ReleaseDC(hdc: HDC) -> HRESULT
}}
...
interface IDirect3DVolume9(IDirect3DVolume9Vtbl): IUnknown(IUnknownVtbl) {
    ...
    fn FreePrivateData(refguid: *const GUID) -> HRESULT,
    fn GetContainer(riid: *const IID, ppContainer: *mut *mut VOID) -> HRESULT,
    fn GetDesc(pDesc: *mut D3DVOLUME_DESC) -> HRESULT,
    fn LockBox(
        pLockedVolume: *mut D3DLOCKED_BOX, pBox: *const D3DBOX, Flags: DWORD
    ) -> HRESULT,
...
interface IDirect3DQuery9(IDirect3DQuery9Vtbl): IUnknown(IUnknownVtbl) {
    ...
    fn Issue(dwIssueFlags: DWORD) -> HRESULT,
    fn GetData(
        pData: *mut VOID, dwSize: DWORD, dwGetDataFlags: DWORD
    ) -> HRESULT
}}
...
interface IDirect3D9Ex(IDirect3D9ExVtbl): IDirect3D9(IDirect3D9Vtbl) {
    ...
    fn EnumAdapterModesEx(
        Adapter: UINT, pFilter: *const D3DDISPLAYMODEFILTER, Mode: UINT,
        pMode: *mut D3DDISPLAYMODEEX
    ) -> HRESULT,
    fn GetAdapterDisplayModeEx(
        Adapter: UINT, pMode: *mut D3DDISPLAYMODEEX,
    ...
    fn GetAdapterLUID(Adapter: UINT, pLUID: *mut LUID) -> HRESULT
}}
...
interface IDirect3DDevice9Ex(IDirect3DDevice9ExVtbl): IDirect3DDevice9(IDirect3DDevice9Vtbl) {
    ...
    fn ComposeRects(
        pSrc: *mut IDirect3DSurface9, pDst: *mut IDirect3DSurface9,
    ...
    fn WaitForVBlank(iSwapChain: UINT) -> HRESULT,
    fn CheckResourceResidency(
        pResourceArray: *mut *mut IDirect3DResource9, NumResources: UINT32
    ) -> HRESULT,
    fn SetMaximumFrameLatency(MaxLatency: UINT) -> HRESULT,
    fn GetMaximumFrameLatency(pMaxLatency: *mut UINT) -> HRESULT,
    fn CheckDeviceState(hDestinationWindow: HWND) -> HRESULT,
    ...
    fn GetDisplayModeEx(
        iSwapChain: UINT, pMode: *mut D3DDISPLAYMODEEX,
        pRotation: *mut D3DDISPLAYROTATION
    ) -> HRESULT
}}
...
interface IDirect3DSwapChain9Ex(IDirect3DSwapChain9ExVtbl):
    ...
    fn GetDisplayModeEx(
        pMode: *mut D3DDISPLAYMODEEX, pRotation: *mut D3DDISPLAYROTATION
    ) -> HRESULT
}}
...
interface IDirect3DAuthenticatedChannel9(IDirect3DAuthenticatedChannel9Vtbl):
    ...
    fn NegotiateKeyExchange(DataSize: UINT, pData: *mut VOID) -> HRESULT,
    fn Query(
        InputSize: UINT, pInput: *const VOID, OutputSize: UINT,
        pOutput: *mut VOID
    ) -> HRESULT,
    fn Configure(
        InputSize: UINT, pInput: *const VOID,
...
interface IDirect3DCryptoSession9(IDirect3DCryptoSession9Vtbl): IUnknown(IUnknownVtbl) {
    ...
    fn NegotiateKeyExchange(DataSize: UINT, pData: *mut VOID) -> HRESULT,
    fn EncryptionBlt(
        pSrcSurface: *mut IDirect3DSurface9, pDstSurface: *mut IDirect3DSurface9,
    ...
    fn GetSurfacePitch(
        pSrcSurface: *mut IDirect3DSurface9, pSurfacePitch: *mut UINT
    ) -> HRESULT,
    fn StartSessionKeyRefresh(
        pRandomNumber: *mut VOID, RandomNumberSize: UINT
    ) -> HRESULT,
    fn FinishSessionKeyRefresh() -> HRESULT,
    fn GetEncryptionBltKey(pReadbackKey: *mut VOID, KeySize: UINT) -> HRESULT
}
);
