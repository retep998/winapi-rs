...
pub const USBD_STATUS_CRC: USBD_STATUS = 0xC0000001u32 as i32;
pub const USBD_STATUS_BTSTUFF: USBD_STATUS = 0xC0000002u32 as i32;
pub const USBD_STATUS_DATA_TOGGLE_MISMATCH: USBD_STATUS = 0xC0000003u32 as i32;
pub const USBD_STATUS_STALL_PID: USBD_STATUS = 0xC0000004u32 as i32;
pub const USBD_STATUS_DEV_NOT_RESPONDING: USBD_STATUS = 0xC0000005u32 as i32;
pub const USBD_STATUS_PID_CHECK_FAILURE: USBD_STATUS = 0xC0000006u32 as i32;
pub const USBD_STATUS_UNEXPECTED_PID: USBD_STATUS = 0xC0000007u32 as i32;
pub const USBD_STATUS_DATA_OVERRUN: USBD_STATUS = 0xC0000008u32 as i32;
pub const USBD_STATUS_DATA_UNDERRUN: USBD_STATUS = 0xC0000009u32 as i32;
pub const USBD_STATUS_RESERVED1: USBD_STATUS = 0xC000000Au32 as i32;
pub const USBD_STATUS_RESERVED2: USBD_STATUS = 0xC000000Bu32 as i32;
pub const USBD_STATUS_BUFFER_OVERRUN: USBD_STATUS = 0xC000000Cu32 as i32;
pub const USBD_STATUS_BUFFER_UNDERRUN: USBD_STATUS = 0xC000000Du32 as i32;
pub const USBD_STATUS_NOT_ACCESSED: USBD_STATUS = 0xC000000Fu32 as i32;
pub const USBD_STATUS_FIFO: USBD_STATUS = 0xC0000010u32 as i32;
pub const USBD_STATUS_XACT_ERROR: USBD_STATUS = 0xC0000011u32 as i32;
pub const USBD_STATUS_BABBLE_DETECTED: USBD_STATUS = 0xC0000012u32 as i32;
pub const USBD_STATUS_DATA_BUFFER_ERROR: USBD_STATUS = 0xC0000013u32 as i32;
pub const USBD_STATUS_NO_PING_RESPONSE: USBD_STATUS = 0xC0000014u32 as i32;
pub const USBD_STATUS_INVALID_STREAM_TYPE: USBD_STATUS = 0xC0000015u32 as i32;
pub const USBD_STATUS_INVALID_STREAM_ID: USBD_STATUS = 0xC0000016u32 as i32;
pub const USBD_STATUS_ENDPOINT_HALTED: USBD_STATUS = 0xC0000030u32 as i32;
pub const USBD_STATUS_INVALID_URB_FUNCTION: USBD_STATUS = 0x80000200u32 as i32;
pub const USBD_STATUS_INVALID_PARAMETER: USBD_STATUS = 0x80000300u32 as i32;
pub const USBD_STATUS_ERROR_BUSY: USBD_STATUS = 0x80000400u32 as i32;
pub const USBD_STATUS_INVALID_PIPE_HANDLE: USBD_STATUS = 0x80000600u32 as i32;
pub const USBD_STATUS_NO_BANDWIDTH: USBD_STATUS = 0x80000700u32 as i32;
pub const USBD_STATUS_INTERNAL_HC_ERROR: USBD_STATUS = 0x80000800u32 as i32;
pub const USBD_STATUS_ERROR_SHORT_TRANSFER: USBD_STATUS = 0x80000900u32 as i32;
pub const USBD_STATUS_BAD_START_FRAME: USBD_STATUS = 0xC0000A00u32 as i32;
pub const USBD_STATUS_ISOCH_REQUEST_FAILED: USBD_STATUS = 0xC0000B00u32 as i32;
pub const USBD_STATUS_FRAME_CONTROL_OWNED: USBD_STATUS = 0xC0000C00u32 as i32;
pub const USBD_STATUS_FRAME_CONTROL_NOT_OWNED: USBD_STATUS = 0xC0000D00u32 as i32;
pub const USBD_STATUS_NOT_SUPPORTED: USBD_STATUS = 0xC0000E00u32 as i32;
pub const USBD_STATUS_INAVLID_CONFIGURATION_DESCRIPTOR: USBD_STATUS = 0xC0000F00u32 as i32;
pub const USBD_STATUS_INVALID_CONFIGURATION_DESCRIPTOR: USBD_STATUS = 0xC0000F00u32 as i32;
pub const USBD_STATUS_INSUFFICIENT_RESOURCES: USBD_STATUS = 0xC0001000u32 as i32;
pub const USBD_STATUS_SET_CONFIG_FAILED: USBD_STATUS = 0xC0002000u32 as i32;
pub const USBD_STATUS_BUFFER_TOO_SMALL: USBD_STATUS = 0xC0003000u32 as i32;
pub const USBD_STATUS_INTERFACE_NOT_FOUND: USBD_STATUS = 0xC0004000u32 as i32;
pub const USBD_STATUS_INAVLID_PIPE_FLAGS: USBD_STATUS = 0xC0005000u32 as i32;
pub const USBD_STATUS_TIMEOUT: USBD_STATUS = 0xC0006000u32 as i32;
pub const USBD_STATUS_DEVICE_GONE: USBD_STATUS = 0xC0007000u32 as i32;
pub const USBD_STATUS_STATUS_NOT_MAPPED: USBD_STATUS = 0xC0008000u32 as i32;
pub const USBD_STATUS_HUB_INTERNAL_ERROR: USBD_STATUS = 0xC0009000u32 as i32;
pub const USBD_STATUS_CANCELED: USBD_STATUS = 0xC0010000u32 as i32;
pub const USBD_STATUS_ISO_NOT_ACCESSED_BY_HW: USBD_STATUS = 0xC0020000u32 as i32;
pub const USBD_STATUS_ISO_TD_ERROR: USBD_STATUS = 0xC0030000u32 as i32;
pub const USBD_STATUS_ISO_NA_LATE_USBPORT: USBD_STATUS = 0xC0040000u32 as i32;
pub const USBD_STATUS_ISO_NOT_ACCESSED_LATE: USBD_STATUS = 0xC0050000u32 as i32;
pub const USBD_STATUS_BAD_DESCRIPTOR: USBD_STATUS = 0xC0100000u32 as i32;
pub const USBD_STATUS_BAD_DESCRIPTOR_BLEN: USBD_STATUS = 0xC0100001u32 as i32;
pub const USBD_STATUS_BAD_DESCRIPTOR_TYPE: USBD_STATUS = 0xC0100002u32 as i32;
pub const USBD_STATUS_BAD_INTERFACE_DESCRIPTOR: USBD_STATUS = 0xC0100003u32 as i32;
pub const USBD_STATUS_BAD_ENDPOINT_DESCRIPTOR: USBD_STATUS = 0xC0100004u32 as i32;
pub const USBD_STATUS_BAD_INTERFACE_ASSOC_DESCRIPTOR: USBD_STATUS = 0xC0100005u32 as i32;
pub const USBD_STATUS_BAD_CONFIG_DESC_LENGTH: USBD_STATUS = 0xC0100006u32 as i32;
pub const USBD_STATUS_BAD_NUMBER_OF_INTERFACES: USBD_STATUS = 0xC0100007u32 as i32;
pub const USBD_STATUS_BAD_NUMBER_OF_ENDPOINTS: USBD_STATUS = 0xC0100008u32 as i32;
pub const USBD_STATUS_BAD_ENDPOINT_ADDRESS: USBD_STATUS = 0xC0100009u32 as i32;
