...
pub const VK_HANGEUL: WORD = 0x15;
...
pub const VK_NAVIGATION_VIEW: WORD = 0x88;
pub const VK_NAVIGATION_MENU: WORD = 0x89;
pub const VK_NAVIGATION_UP: WORD = 0x8A;
pub const VK_NAVIGATION_DOWN: WORD = 0x8B;
pub const VK_NAVIGATION_LEFT: WORD = 0x8C;
pub const VK_NAVIGATION_RIGHT: WORD = 0x8D;
pub const VK_NAVIGATION_ACCEPT: WORD = 0x8E;
pub const VK_NAVIGATION_CANCEL: WORD = 0x8F;
pub const VK_NUMLOCK: WORD = 0x90;
pub const VK_SCROLL: WORD = 0x91;
pub const VK_OEM_NEC_EQUAL: WORD = 0x92;
pub const VK_OEM_FJ_JISHO: WORD = 0x92;
pub const VK_OEM_FJ_MASSHOU: WORD = 0x93;
pub const VK_OEM_FJ_TOUROKU: WORD = 0x94;
pub const VK_OEM_FJ_LOYA: WORD = 0x95;
pub const VK_OEM_FJ_ROYA: WORD = 0x96;
...
pub const VK_GAMEPAD_A: WORD = 0xC3;
pub const VK_GAMEPAD_B: WORD = 0xC4;
pub const VK_GAMEPAD_X: WORD = 0xC5;
pub const VK_GAMEPAD_Y: WORD = 0xC6;
pub const VK_GAMEPAD_RIGHT_SHOULDER: WORD = 0xC7;
pub const VK_GAMEPAD_LEFT_SHOULDER: WORD = 0xC8;
pub const VK_GAMEPAD_LEFT_TRIGGER: WORD = 0xC9;
pub const VK_GAMEPAD_RIGHT_TRIGGER: WORD = 0xCA;
pub const VK_GAMEPAD_DPAD_UP: WORD = 0xCB;
pub const VK_GAMEPAD_DPAD_DOWN: WORD = 0xCC;
pub const VK_GAMEPAD_DPAD_LEFT: WORD = 0xCD;
pub const VK_GAMEPAD_DPAD_RIGHT: WORD = 0xCE;
pub const VK_GAMEPAD_MENU: WORD = 0xCF;
pub const VK_GAMEPAD_VIEW: WORD = 0xD0;
pub const VK_GAMEPAD_LEFT_THUMBSTICK_BUTTON: WORD = 0xD1;
pub const VK_GAMEPAD_RIGHT_THUMBSTICK_BUTTON: WORD = 0xD2;
pub const VK_GAMEPAD_LEFT_THUMBSTICK_UP: WORD = 0xD3;
pub const VK_GAMEPAD_LEFT_THUMBSTICK_DOWN: WORD = 0xD4;
pub const VK_GAMEPAD_LEFT_THUMBSTICK_RIGHT: WORD = 0xD5;
pub const VK_GAMEPAD_LEFT_THUMBSTICK_LEFT: WORD = 0xD6;
pub const VK_GAMEPAD_RIGHT_THUMBSTICK_UP: WORD = 0xD7;
pub const VK_GAMEPAD_RIGHT_THUMBSTICK_DOWN: WORD = 0xD8;
pub const VK_GAMEPAD_RIGHT_THUMBSTICK_RIGHT: WORD = 0xD9;
pub const VK_GAMEPAD_RIGHT_THUMBSTICK_LEFT: WORD = 0xDA;
...
pub const VK_OEM_AX: WORD = 0xE1;
pub const VK_OEM_102: WORD = 0xE2;
pub const VK_ICO_HELP: WORD = 0xE3;
pub const VK_ICO_00: WORD = 0xE4;
pub const VK_PROCESSKEY: WORD = 0xE5;
pub const VK_ICO_CLEAR: WORD = 0xE6;
pub const VK_PACKET: WORD = 0xE7;
pub const VK_OEM_RESET: WORD = 0xE9;
pub const VK_OEM_JUMP: WORD = 0xEA;
pub const VK_OEM_PA1: WORD = 0xEB;
pub const VK_OEM_PA2: WORD = 0xEC;
pub const VK_OEM_PA3: WORD = 0xED;
pub const VK_OEM_WSCTRL: WORD = 0xEE;
pub const VK_OEM_CUSEL: WORD = 0xEF;
pub const VK_OEM_ATTN: WORD = 0xF0;
pub const VK_OEM_FINISH: WORD = 0xF1;
pub const VK_OEM_COPY: WORD = 0xF2;
pub const VK_OEM_AUTO: WORD = 0xF3;
pub const VK_OEM_ENLW: WORD = 0xF4;
pub const VK_OEM_BACKTAB: WORD = 0xF5;
