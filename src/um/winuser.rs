...
pub const SKF_LALTLATCHED: DWORD = 0x10000000;
pub const SKF_LCTLLATCHED: DWORD = 0x04000000;
pub const SKF_LSHIFTLATCHED: DWORD = 0x01000000;
pub const SKF_RALTLATCHED: DWORD = 0x20000000;
pub const SKF_RCTLLATCHED: DWORD = 0x08000000;
pub const SKF_RSHIFTLATCHED: DWORD = 0x02000000;
pub const SKF_LWINLATCHED: DWORD = 0x40000000;
pub const SKF_RWINLATCHED: DWORD = 0x80000000;
pub const SKF_LALTLOCKED: DWORD = 0x00100000;
pub const SKF_LCTLLOCKED: DWORD = 0x00040000;
pub const SKF_LSHIFTLOCKED: DWORD = 0x00010000;
pub const SKF_RALTLOCKED: DWORD = 0x00200000;
pub const SKF_RCTLLOCKED: DWORD = 0x00080000;
pub const SKF_RSHIFTLOCKED: DWORD = 0x00020000;
pub const SKF_LWINLOCKED: DWORD = 0x00400000;
pub const SKF_RWINLOCKED: DWORD = 0x00800000;
//13191
extern "system" {
