...
extern {
    pub static CLSID_PortableDevice: CLSID;
    pub static CLSID_PortableDeviceManager: CLSID;
    pub static CLSID_PortableDeviceService: CLSID;
    pub static CLSID_PortableDeviceDispatchFactory: CLSID;
    pub static CLSID_PortableDeviceFTM: CLSID;
    pub static CLSID_PortableDeviceServiceFTM: CLSID;
    pub static CLSID_PortableDeviceWebControl: CLSID;
}
