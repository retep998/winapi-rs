...
pub const TD_WARNING_ICON: LPWSTR = -1i16 as u16 as usize as LPWSTR;
pub const TD_ERROR_ICON: LPWSTR = -2i16 as u16 as usize as LPWSTR;
pub const TD_INFORMATION_ICON: LPWSTR = -3i16 as u16 as usize as LPWSTR;
pub const TD_SHIELD_ICON: LPWSTR = -4i16 as u16 as usize as LPWSTR;
