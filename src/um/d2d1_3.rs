...
use um::d2d1::{
    ...
    ID2D1SimplifiedGeometrySink, D2D1_BITMAP_INTERPOLATION_MODE, D2D1_COLOR_F,
    D2D1_DRAW_TEXT_OPTIONS, D2D1_GAMMA_1_0, D2D1_GAMMA_2_2, D2D1_MATRIX_3X2_F, D2D1_POINT_2F,
    D2D1_RECT_F, D2D1_RECT_U, D2D1_SIZE_F,
};
use um::d2d1_1::{
    ID2D1ColorContext, ID2D1ColorContextVtbl, ID2D1CommandList, ID2D1GdiMetafile,
    ID2D1GdiMetafileSink, ID2D1GdiMetafileSinkVtbl, ID2D1GdiMetafileVtbl, D2D1_BUFFER_PRECISION,
    D2D1_DEVICE_CONTEXT_OPTIONS, D2D1_INTERPOLATION_MODE, D2D1_PRIMITIVE_BLEND,
};
use um::d2d1_2::{
...
use um::dwrite::{IDWriteFontFace, IDWriteTextFormat, IDWriteTextLayout, DWRITE_GLYPH_RUN};
