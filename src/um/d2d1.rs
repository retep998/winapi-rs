...
interface ID2D1Resource(ID2D1ResourceVtbl): IUnknown(IUnknownVtbl) {
    fn GetFactory(factory: *mut *mut ID2D1Factory) -> ()
}}
...
interface ID2D1Bitmap(ID2D1BitmapVtbl): ID2D1Image(ID2D1ImageVtbl) {
    fn GetSize(ret: *mut D2D1_SIZE_F) -> *mut D2D1_SIZE_F, // FIXME: ABI issue
    fn GetPixelSize(ret: *mut D2D1_SIZE_U) -> *mut D2D1_SIZE_U, // FIXME: ABI issue
    fn GetPixelFormat(
        ret: *mut D2D1_PIXEL_FORMAT
    ) -> *mut D2D1_PIXEL_FORMAT, // FIXME: ABI issue
    fn GetDpi(dpiX: *mut FLOAT, dpiY: *mut FLOAT) -> (),
    fn CopyFromBitmap(
        destPoint: *const D2D1_POINT_2U, bitmap: *mut ID2D1Bitmap,
        srcRect: *const D2D1_RECT_U
    ) -> HRESULT,
    fn CopyFromRenderTarget(
        destPoint: *const D2D1_POINT_2U, renderTarget: *mut ID2D1RenderTarget,
        srcRect: *const D2D1_RECT_U
    ) -> HRESULT,
    fn CopyFromMemory(
        dstRect: *const D2D1_RECT_U, srcData: *const c_void, pitch: UINT32
    ) -> HRESULT
}}
...
interface ID2D1GradientStopCollection(ID2D1GradientStopCollectionVtbl)
    ...
    fn GetGradientStops(
        gradientStops: *mut D2D1_GRADIENT_STOP, gradientStopsCount: UINT32
    ) -> (),
...
interface ID2D1Brush(ID2D1BrushVtbl): ID2D1Resource(ID2D1ResourceVtbl) {
    fn SetOpacity(opacity: FLOAT) -> (),
    fn SetTransform(transform: *const D2D1_MATRIX_3X2_F) -> (),
    fn GetOpacity() -> FLOAT,
    fn GetTransform(transform: *mut D2D1_MATRIX_3X2_F) -> ()
}}
...
interface ID2D1BitmapBrush(ID2D1BitmapBrushVtbl): ID2D1Brush(ID2D1BrushVtbl) {
    fn SetExtendModeX(extendModeX: D2D1_EXTEND_MODE) -> (),
    fn SetExtendModeY(extendModeY: D2D1_EXTEND_MODE) -> (),
    fn SetInterpolationMode(interpolationMode: D2D1_BITMAP_INTERPOLATION_MODE) -> (),
    fn SetBitmap(bitmap: *mut ID2D1Bitmap) -> (),
    ...
    fn GetBitmap(bitmap: *mut *mut ID2D1Bitmap) -> ()
}}
...
interface ID2D1SolidColorBrush(ID2D1SolidColorBrushVtbl): ID2D1Brush(ID2D1BrushVtbl) {
    fn SetColor(color: *const D2D1_COLOR_F) -> (),
    fn GetColor(color: *mut D2D1_COLOR_F) -> *mut D2D1_COLOR_F
}}
...
interface ID2D1LinearGradientBrush(ID2D1LinearGradientBrushVtbl): ID2D1Brush(ID2D1BrushVtbl) {
    fn SetStartPoint(startPoint: D2D1_POINT_2F) -> (),
    fn SetEndPoint(endPoint: D2D1_POINT_2F) -> (),
    fn GetStartPoint(ret: *mut D2D1_POINT_2F) -> *mut D2D1_POINT_2F, // FIXME ABI issue
    fn GetEndPoint(ret: *mut D2D1_POINT_2F) -> *mut D2D1_POINT_2F, // FIXME ABI issue
...
interface ID2D1RadialGradientBrush(ID2D1RadialGradientBrushVtbl): ID2D1Brush(ID2D1BrushVtbl) {
    fn SetCenter(center: D2D1_POINT_2F) -> (),
    fn SetGradientOriginOffset(gradientOriginOffset: D2D1_POINT_2F) -> (),
    fn SetRadiusX(radiusX: FLOAT) -> (),
    fn SetRadiusY(radiusY: FLOAT) -> (),
    fn GetCenter(ret: *mut D2D1_POINT_2F) -> *mut D2D1_POINT_2F, // FIXME ABI issue
...
interface ID2D1StrokeStyle(ID2D1StrokeStyleVtbl): ID2D1Resource(ID2D1ResourceVtbl) {
    ...
    fn GetDashes(dashes: *mut FLOAT, dashesCount: UINT32) -> ()
}}
...
interface ID2D1Geometry(ID2D1GeometryVtbl): ID2D1Resource(ID2D1ResourceVtbl) {
    fn GetBounds(
        worldTransform: *const D2D1_MATRIX_3X2_F, bounds: *mut D2D1_RECT_F
    ) -> HRESULT,
    fn GetWidenedBounds(
    ...
    fn StrokeContainsPoint(
        point: D2D1_POINT_2F, strokeWidth: FLOAT, strokeStyle: *mut ID2D1StrokeStyle,
        worldTransform: *const D2D1_MATRIX_3X2_F, flatteningTolerance: FLOAT,
        contains: *mut BOOL
    ) -> HRESULT,
    fn FillContainsPoint(
        point: D2D1_POINT_2F, worldTransform: *const D2D1_MATRIX_3X2_F,
    ...
    fn CombineWithGeometry(
        inputGeometry: *mut ID2D1Geometry, combineMode: D2D1_COMBINE_MODE,
        inputGeometryTransform: *const D2D1_MATRIX_3X2_F, flatteningTolerance: FLOAT,
        geometrySink: *mut ID2D1SimplifiedGeometrySink
    ) -> HRESULT,
    fn Outline(
    ...
    fn ComputePointAtLength(
        length: FLOAT, worldTransform: *const D2D1_MATRIX_3X2_F,
...
interface ID2D1RectangleGeometry(ID2D1RectangleGeometryVtbl): ID2D1Geometry(ID2D1GeometryVtbl) {
    fn GetRect(rect: *mut D2D1_RECT_F) -> ()
}}
...
interface ID2D1RoundedRectangleGeometry(ID2D1RoundedRectangleGeometryVtbl)
    ...
    fn GetRoundedRect(roundedRect: *mut D2D1_ROUNDED_RECT) -> ()
}}
...
interface ID2D1EllipseGeometry(ID2D1EllipseGeometryVtbl): ID2D1Geometry(ID2D1GeometryVtbl) {
    fn GetEllipse(ellipse: *mut D2D1_ELLIPSE) -> ()
}}
...
interface ID2D1GeometryGroup(ID2D1GeometryGroupVtbl): ID2D1Geometry(ID2D1GeometryVtbl) {
    ...
    fn GetSourceGeometries(
        geometries: *mut *mut ID2D1Geometry, geometriesCount: UINT32
    ) -> ()
}}
...
interface ID2D1TransformedGeometry(ID2D1TransformedGeometryVtbl)
    : ID2D1Geometry(ID2D1GeometryVtbl) {
    fn GetSourceGeometry(sourceGeometry: *mut *mut ID2D1Geometry) -> (),
    fn GetTransform(transform: *mut D2D1_MATRIX_3X2_F) -> ()
}}
...
interface ID2D1SimplifiedGeometrySink(ID2D1SimplifiedGeometrySinkVtbl): IUnknown(IUnknownVtbl) {
    fn SetFillMode(fillMode: D2D1_FILL_MODE) -> (),
    fn SetSegmentFlags(vertexFlags: D2D1_PATH_SEGMENT) -> (),
    fn BeginFigure(startPoint: D2D1_POINT_2F, figureBegin: D2D1_FIGURE_BEGIN) -> (),
    fn AddLines(points: *const D2D1_POINT_2F, pointsCount: UINT32) -> (),
    fn AddBeziers(beziers: *const D2D1_BEZIER_SEGMENT, beziersCount: UINT32) -> (),
    fn EndFigure(figureEnd: D2D1_FIGURE_END) -> (),
    fn Close() -> HRESULT
}}
...
interface ID2D1GeometrySink(ID2D1GeometrySinkVtbl)
    ...
    fn AddLine(point: D2D1_POINT_2F) -> (),
    fn AddBezier(bezier: *const D2D1_BEZIER_SEGMENT) -> (),
    fn AddQuadraticBezier(bezier: *const D2D1_QUADRATIC_BEZIER_SEGMENT) -> (),
    fn AddQuadraticBeziers(
        beziers: *const D2D1_QUADRATIC_BEZIER_SEGMENT, beziersCount: UINT32
    ) -> (),
    fn AddArc(arc: *const D2D1_ARC_SEGMENT) -> ()
}}
...
interface ID2D1TessellationSink(ID2D1TessellationSinkVtbl): IUnknown(IUnknownVtbl) {
    fn AddTriangles(triangles: *const D2D1_TRIANGLE, triangleCount: UINT32) -> (),
    fn Close() -> HRESULT
}}
...
interface ID2D1PathGeometry(ID2D1PathGeometryVtbl): ID2D1Geometry(ID2D1GeometryVtbl) {
    fn Open(geometrySink: *mut *mut ID2D1GeometrySink) -> HRESULT,
    fn Stream(geometrySink: *mut ID2D1GeometrySink) -> HRESULT,
    fn GetSegmentCount(count: *mut UINT32) -> HRESULT,
    fn GetFigureCount(count: *mut UINT32) -> HRESULT
}}
...
interface ID2D1Mesh(ID2D1MeshVtbl): ID2D1Resource(ID2D1ResourceVtbl) {
    fn Open(tessellationSink: *mut *mut ID2D1TessellationSink) -> HRESULT
}}
...
interface ID2D1DrawingStateBlock(ID2D1DrawingStateBlockVtbl): ID2D1Resource(ID2D1ResourceVtbl) {
    fn GetDescription(stateDescription: *mut D2D1_DRAWING_STATE_DESCRIPTION) -> (),
    fn SetDescription(stateDescription: *const D2D1_DRAWING_STATE_DESCRIPTION) -> (),
...
interface ID2D1RenderTarget(ID2D1RenderTargetVtbl): ID2D1Resource(ID2D1ResourceVtbl) {
    fn CreateBitmap(
        size: D2D1_SIZE_U, srcData: *const c_void, pitch: UINT32,
    ...
    fn CreateSolidColorBrush(
        color: *const D2D1_COLOR_F, brushProperties: *const D2D1_BRUSH_PROPERTIES,
        solidColorBrush: *mut *mut ID2D1SolidColorBrush
    ) -> HRESULT,
    fn CreateGradientStopCollection(
        gradientStops: *const D2D1_GRADIENT_STOP, gradientStopsCount: UINT32,
    ...
    fn CreateCompatibleRenderTarget(
        desiredSize: *const D2D1_SIZE_F, desiredPixelSize: *const D2D1_SIZE_U,
    ...
    fn CreateLayer(size: *const D2D1_SIZE_F, layer: *mut *mut ID2D1Layer) -> HRESULT,
    fn CreateMesh(mesh: *mut *mut ID2D1Mesh) -> HRESULT,
    fn DrawLine(
        point0: D2D1_POINT_2F, point1: D2D1_POINT_2F, brush: *mut ID2D1Brush,
        strokeWidth: FLOAT, strokeStype: *mut ID2D1StrokeStyle
    ) -> (),
    fn DrawRectangle(
        rect: *const D2D1_RECT_F, brush: *mut ID2D1Brush,
        strokeWidth: FLOAT, strokeStyle: *mut ID2D1StrokeStyle
    ) -> (),
    fn FillRectangle(
        rect: *const D2D1_RECT_F, brush: *mut ID2D1Brush
    ...
    fn DrawRoundedRectangle(
        roundedRect: *const D2D1_ROUNDED_RECT, brush: *mut ID2D1Brush,
        strokeWidth: FLOAT, strokeStyle: *mut ID2D1StrokeStyle
    ) -> (),
    ...
    fn DrawEllipse(
        ellipse: *const D2D1_ELLIPSE, brush: *mut ID2D1Brush,
        strokeWidth: FLOAT, strokeStyle: *mut ID2D1StrokeStyle
    ) -> (),
    fn FillEllipse(
        ellipse: *const D2D1_ELLIPSE, brush: *mut ID2D1Brush
    ...
    fn DrawGeometry(
        geometry: *mut ID2D1Geometry, brush: *mut ID2D1Brush,
        strokeWidth: FLOAT, strokeStyle: *mut ID2D1StrokeStyle
    ) -> (),
    fn FillGeometry(
        geometry: *mut ID2D1Geometry, brush: *mut ID2D1Brush,
    ...
    fn FillMesh(
        mesh: *mut ID2D1Mesh, brush: *const ID2D1Brush
    ) -> (),
    fn FillOpacityMask(
        opacityMask: *mut ID2D1Bitmap, brush: *mut ID2D1Brush,
        content: D2D1_OPACITY_MASK_CONTENT, destinationRectangle: *const D2D1_RECT_F,
        sourceRectangle: *const D2D1_RECT_F
    ) -> (),
    fn DrawBitmap(
        bitmap: *mut ID2D1Bitmap, destinationRectangle: *const D2D1_RECT_F,
    ...
    fn DrawTextLayout(
        origin: D2D1_POINT_2F, textLayout: *mut IDWriteTextLayout,
        defaultForegroundBrush: *mut ID2D1Brush, options: D2D1_DRAW_TEXT_OPTIONS
    ) -> (),
    fn DrawGlyphRun(
        baselineOrigin: D2D1_POINT_2F, glyphRun: *const DWRITE_GLYPH_RUN,
        foregroundBrush: *mut ID2D1Brush, measuringMode: DWRITE_MEASURING_MODE
    ) -> (),
    fn SetTransform(transform: *const D2D1_MATRIX_3X2_F) -> (),
    fn GetTransform(transform: *mut D2D1_MATRIX_3X2_F) -> (),
    fn SetAntialiasMode(antialiasMode: D2D1_ANTIALIAS_MODE) -> (),
    fn GetAntialiasMode() -> D2D1_ANTIALIAS_MODE,
    fn SetTextAntialiasMode(textAntialiasMode: D2D1_TEXT_ANTIALIAS_MODE) -> (),
    ...
    fn SetTags(tag1: D2D1_TAG, tag2: D2D1_TAG) -> (),
    fn GetTags(tag1: *mut D2D1_TAG, tag2: *mut D2D1_TAG) -> (),
    fn PushLayer(
        layerParameters: *const D2D1_LAYER_PARAMETERS, layer: *mut ID2D1Layer
    ) -> (),
    fn PopLayer() -> (),
    fn Flush(tag1: *mut D2D1_TAG, tag2: *mut D2D1_TAG) -> HRESULT,
    fn SaveDrawingState(drawingStateBlock: *mut ID2D1DrawingStateBlock) -> (),
    fn RestoreDrawingState(drawingStateBlock: *mut ID2D1DrawingStateBlock) -> (),
    fn PushAxisAlignedClip(
        clipRect: *const D2D1_RECT_F, antialiasMode: D2D1_ANTIALIAS_MODE
    ) -> (),
    fn PopAxisAlignedClip() -> (),
    fn Clear(clearColor: *const D2D1_COLOR_F) -> (),
    fn BeginDraw() -> (),
    fn EndDraw(tag1: *mut D2D1_TAG, tag2: *mut D2D1_TAG) -> HRESULT,
    fn GetPixelFormat(
        ret: *mut D2D1_PIXEL_FORMAT
    ) -> *mut D2D1_PIXEL_FORMAT, // FIXME: ABI issue
    fn SetDpi(dpiX: FLOAT, dpiY: FLOAT) -> (),
    fn GetDpi(dpiX: *mut FLOAT, dpiY: *mut FLOAT) -> (),
    fn GetSize(ret: *mut D2D1_SIZE_F) -> *mut D2D1_SIZE_F, // FIXME: ABI issue
    fn GetPixelSize(ret: *mut D2D1_SIZE_U) -> *mut D2D1_SIZE_U, // FIXME: ABI issue
...
interface ID2D1BitmapRenderTarget(ID2D1BitmapRenderTargetVtbl)
    ...
    fn GetBitmap(bitmap: *mut *mut ID2D1Bitmap) -> HRESULT
}}
...
interface ID2D1HwndRenderTarget(ID2D1HwndRenderTargetVtbl)
    ...
    fn Resize(pixelSize: *const D2D1_SIZE_U) -> HRESULT,
    fn GetHwnd() -> HWND
}}
...
interface ID2D1GdiInteropRenderTarget(ID2D1GdiInteropRenderTargetVtbl): IUnknown(IUnknownVtbl) {
    fn GetDC(mode: D2D1_DC_INITIALIZE_MODE, hdc: *mut HDC) -> HRESULT,
    fn ReleaseDC(update: *const RECT) -> HRESULT
}}
...
interface ID2D1DCRenderTarget(ID2D1DCRenderTargetVtbl): ID2D1RenderTarget(ID2D1RenderTargetVtbl) {
    fn BindDC(hDC: HDC, pSubRect: *const RECT) -> HRESULT
}}
...
interface ID2D1Factory(ID2D1FactoryVtbl): IUnknown(IUnknownVtbl) {
    ...
    fn GetDesktopDpi(dpiX: *mut FLOAT, dpiY: *mut FLOAT) -> (),
    ...
    fn CreateGeometryGroup(
        fillMode: D2D1_FILL_MODE, geometries: *mut *mut ID2D1Geometry,
        geometriesCount: UINT32, geometryGroup: *mut *mut ID2D1GeometryGroup
    ) -> HRESULT,
    fn CreateTransformedGeometry(
        sourceGeometry: *mut ID2D1Geometry, transform: *const D2D1_MATRIX_3X2_F,
