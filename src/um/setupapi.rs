...
pub type PSP_FILE_CALLBACK_A = Option<unsafe extern "stdcall" fn(
    Context: PVOID,
    Notification: UINT,
    Param1: UINT_PTR,
    Param2: UINT_PTR
) -> UINT>;
pub type PSP_FILE_CALLBACK_W = Option<unsafe extern "stdcall" fn(
    Context: PVOID,
    Notification: UINT,
    Param1: UINT_PTR,
    Param2: UINT_PTR
...
pub type PDETECT_PROGRESS_NOTIFY = Option<unsafe extern "stdcall" fn(
...
pub type PSP_DETSIG_CMPPROC = Option<unsafe extern "stdcall" fn(
