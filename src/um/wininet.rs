...
UNION2!{union INTERNET_PER_CONN_OPTIONA_Value {
    [u32; 2] [u64; 1],
...
UNION2!{union INTERNET_PER_CONN_OPTIONW_Value {
    [u32; 2] [u64; 1],
    dwValue dwValue_mut: DWORD,
...
UNION2!{union GOPHER_ATTRIBUTE_TYPE_AttributeType {
    [u32; 6] [u64; 3],
...
pub const URLCACHE_FIND_DEFAULT_FILTER: DWORD = NORMAL_CACHE_ENTRY | COOKIE_CACHE_ENTRY
    ...
    | STICKY_CACHE_ENTRY;
UNION2!{union INTERNET_CACHE_ENTRY_INFOA_u {
    [u32; 1],
...
UNION2!{union INTERNET_CACHE_ENTRY_INFOW_u {
    [u32; 1],
    dwReserved dwReserved_mut: DWORD,
    dwExemptDelta dwExemptDelta_mut: DWORD,
}}
