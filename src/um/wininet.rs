...
pub const INTERNET_MAX_HOST_NAME_LENGTH: DWORD = 256;
pub const INTERNET_MAX_USER_NAME_LENGTH: DWORD = 128;
pub const INTERNET_MAX_PASSWORD_LENGTH: DWORD = 128;
pub const INTERNET_MAX_PORT_NUMBER_LENGTH: DWORD = 5;
pub const INTERNET_MAX_PORT_NUMBER_VALUE: DWORD = 65535;
pub const INTERNET_MAX_PATH_LENGTH: DWORD = 2048;
...
pub const MAX_GOPHER_DISPLAY_TEXT: DWORD = 128;
pub const MAX_GOPHER_SELECTOR_TEXT: DWORD = 256;
pub const MAX_GOPHER_HOST_NAME: DWORD = INTERNET_MAX_HOST_NAME_LENGTH;
pub const MAX_GOPHER_LOCATOR_LENGTH: DWORD = 1 + MAX_GOPHER_DISPLAY_TEXT + 1
    + MAX_GOPHER_SELECTOR_TEXT + 1 + MAX_GOPHER_HOST_NAME + 1 + INTERNET_MAX_PORT_NUMBER_LENGTH
    + 1 + 1 + 2;
STRUCT!{struct GOPHER_FIND_DATAA {
    DisplayString: [CHAR; MAX_GOPHER_DISPLAY_TEXT as usize + 1],
    GopherType: DWORD,
    SizeLow: DWORD,
    SizeHigh: DWORD,
    LastModificationTime: FILETIME,
    Locator: [CHAR; MAX_GOPHER_LOCATOR_LENGTH as usize + 1],
}}
pub type LPGOPHER_FIND_DATAA = *mut GOPHER_FIND_DATAA;
STRUCT!{struct GOPHER_FIND_DATAW {
    DisplayString: [WCHAR; MAX_GOPHER_DISPLAY_TEXT as usize + 1],
    GopherType: DWORD,
    SizeLow: DWORD,
    SizeHigh: DWORD,
    LastModificationTime: FILETIME,
    Locator: [WCHAR; MAX_GOPHER_LOCATOR_LENGTH as usize + 1],
}}
...
pub const GROUPNAME_MAX_LENGTH: DWORD = 120;
pub const GROUP_OWNER_STORAGE_SIZE: DWORD = 4;
STRUCT!{struct INTERNET_CACHE_GROUP_INFOA {
    ...
    dwDiskUsage: DWORD,
    dwDiskQuota: DWORD,
    dwOwnerStorage: [DWORD; GROUP_OWNER_STORAGE_SIZE as usize],
    szGroupName: [CHAR; GROUPNAME_MAX_LENGTH as usize],
}}
...
STRUCT!{struct INTERNET_CACHE_GROUP_INFOW {
    ...
    dwDiskQuota: DWORD,
    dwOwnerStorage: [DWORD; GROUP_OWNER_STORAGE_SIZE as usize],
    szGroupName: [WCHAR; GROUPNAME_MAX_LENGTH as usize],
}}
