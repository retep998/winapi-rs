...
//! Structures, type definitions, constants and function prototypes that are
//! visible to user mode applications that interact with filters.
use shared::fltuserstructures::{
    FILTER_INFORMATION_CLASS, FILTER_VOLUME_INFORMATION_CLASS, HFILTER, HFILTER_INSTANCE,
    INSTANCE_INFORMATION_CLASS, PFILTER_MESSAGE_HEADER, PFILTER_REPLY_HEADER
};
