...
use shared::minwindef::{
    BOOL, BYTE, DWORD, LPBOOL, LPDWORD, LPSECURITY_ATTRIBUTES, LPVOID,  PBOOL, PDWORD, PUCHAR,
    PULONG, UCHAR, ULONG
};
use um::winnt::{
    AUDIT_EVENT_TYPE, BOOLEAN, HANDLE, LPCSTR, LPCWSTR, LPWSTR, PACL,
    ...
    PTOKEN_PRIVILEGES, PTOKEN_PRIVILEGES, SECURITY_DESCRIPTOR_CONTROL, SECURITY_IMPERSONATION_LEVEL,
    SECURITY_INFORMATION, TOKEN_INFORMATION_CLASS, TOKEN_TYPE, WELL_KNOWN_SID_TYPE
};
