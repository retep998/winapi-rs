...
use shared::minwindef::{BOOL, DWORD, FLOAT, INT};
...
interface IAudioSessionEvents(IAduioSessionEventsVtbl): IUnknown(IUnknownVtbl) {
    ...
    fn OnChannelVolumeChanged( 
        ChannelCount: DWORD,
        NewChannelVolumeArray: *mut FLOAT,
