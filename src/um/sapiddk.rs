...
use um::sapi::*;
pub use um::sapiddk51::{SPALTERNATESCLSID, SPRECOEXTENSION};
...
pub use um::sapiddk51::{
    ISpCFGInterpreter, ISpCFGInterpreterSite, ISpCFGInterpreterSiteVtbl, ISpCFGInterpreterVtbl,
    ISpErrorLog, ISpErrorLogVtbl, ISpGramCompBackend, ISpGramCompBackendVtbl, ISpGrammarCompiler,
    ISpGrammarCompilerVtbl, ISpITNProcessor, ISpITNProcessorVtbl, ISpObjectTokenEnumBuilder,
    ISpObjectTokenEnumBuilderVtbl, ISpPhraseBuilder, ISpPhraseBuilderVtbl, ISpTTSEngine,
    ISpTTSEngineSite, ISpTTSEngineSiteVtbl, ISpTTSEngineVtbl, ISpTask, ISpTaskManager,
    ISpTaskManagerVtbl, ISpThreadControl, ISpThreadControlVtbl, ISpThreadTask, ISpTokenUI,
    ISpTokenUIVtbl, SPCFGNOTIFY, SPCFGN_ACTIVATE, SPCFGN_ADD, SPCFGN_DEACTIVATE, SPCFGN_INVALIDATE,
    SPCFGN_REMOVE, SPGRAMMARHANDLE, SPPATHENTRY, SPPHRASEPROPERTYHANDLE, SPPHRASERULEHANDLE,
    SPRECOCONTEXTHANDLE, SPRESULTTYPE, SPRT_CFG, SPRT_FALSE_RECOGNITION, SPRT_PROPRIETARY,
    SPRT_SLM, SPRULEENTRY, SPRULEHANDLE, SPSTATEINFO, SPTMTHREADINFO, SPTRANSDICTATION,
    SPTRANSEPSILON, SPTRANSITIONENTRY, SPTRANSITIONID, SPTRANSITIONPROPERTY, SPTRANSITIONTYPE,
    SPTRANSRULE, SPTRANSTEXTBUF, SPTRANSWILDCARD, SPTRANSWORD, SPVESACTIONS, SPVES_ABORT,
    SPVES_CONTINUE, SPVES_RATE, SPVES_SKIP, SPVES_VOLUME, SPVSKIPTYPE, SPVST_SENTENCE, SPVTEXTFRAG,
    SPWORDENTRY, SPWORDHANDLE,
};
...
pub use um::sapiddk51::{SPPHRASEALT, SPRECORESULTINFO};
...
pub use um::sapiddk51::{
    ISpSREngineSite, ISpSREngineSiteVtbl, SPPARSEINFO, SPRIO_NONE, SPRULEINFOOPT, SPWIO_NONE,
    SPWIO_WANT_TEXT, SPWORDINFOOPT,
};
...
pub use um::sapiddk51::{
    ISpSREngine, ISpSREngineVtbl, SPPROPSRC, SPPROPSRC_RECO_CTX, SPPROPSRC_RECO_GRAMMAR,
    SPPROPSRC_RECO_INST,
};
...
pub use um::sapiddk51::{
    CLSID_SpDataKey, CLSID_SpGrammarCompiler, CLSID_SpITNProcessor, CLSID_SpObjectTokenEnum,
    CLSID_SpPhraseBuilder, LIBID_SpeechDDKLib,
};
extern "C" {
