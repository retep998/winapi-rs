...
pub const D3D12_RAYTRACING_MAX_GEOMETRIES_PER_BOTTOM_LEVEL_ACCELERATION_STRUCTURE
    : UINT = 16777216;
pub const D3D12_RAYTRACING_MAX_INSTANCES_PER_TOP_LEVEL_ACCELERATION_STRUCTURE
    : UINT = 16777216;
pub const D3D12_RAYTRACING_MAX_PRIMITIVES_PER_BOTTOM_LEVEL_ACCELERATION_STRUCTURE
    : UINT = 536870912;
...
pub fn D3D12_MAKE_COARSE_SHADING_RATE(
    x: UINT,
    y: UINT,
) -> UINT {
    (x << D3D12_SHADING_RATE_X_AXIS_SHIFT) | y
}
pub fn D3D12_GET_COARSE_SHADING_RATE_X_AXIS(
    x: UINT,
) -> UINT {
    (x >> D3D12_SHADING_RATE_X_AXIS_SHIFT) & D3D12_SHADING_RATE_VALID_MASK
}
pub fn D3D12_GET_COARSE_SHADING_RATE_Y_AXIS(
    y: UINT,
) -> UINT {
