...
//! Mappings for the content of d3d12.h
...
use shared::minwindef::{BOOL, BYTE, DWORD, FLOAT, LPCVOID, UINT};
...
use um::winnt::{HANDLE, HRESULT, INT, LPCSTR, LPCWSTR, LUID};
...
ENUM!{enum D3D12_COMMAND_LIST_TYPE {
    D3D12_COMMAND_LIST_TYPE_DIRECT = 0x0, // 0
    D3D12_COMMAND_LIST_TYPE_BUNDLE = 0x1, // 1
    D3D12_COMMAND_LIST_TYPE_COMPUTE = 0x2, // 2
    D3D12_COMMAND_LIST_TYPE_COPY = 0x3, // 3
}}

ENUM!{enum D3D12_COMMAND_QUEUE_FLAGS {
    D3D12_COMMAND_QUEUE_FLAG_NONE = 0x0, // 0
    D3D12_COMMAND_QUEUE_FLAG_DISABLE_GPU_TIMEOUT = 0x1, // 1
}}

ENUM!{enum D3D12_COMMAND_QUEUE_PRIORITY {
    D3D12_COMMAND_QUEUE_PRIORITY_NORMAL = 0x0, // 0
    D3D12_COMMAND_QUEUE_PRIORITY_HIGH = 0x64, // 100
}}
...
ENUM!{enum D3D12_PRIMITIVE_TOPOLOGY_TYPE {
    D3D12_PRIMITIVE_TOPOLOGY_TYPE_UNDEFINED = 0x0, // 0
    D3D12_PRIMITIVE_TOPOLOGY_TYPE_POINT = 0x1, // 1
    D3D12_PRIMITIVE_TOPOLOGY_TYPE_LINE = 0x2, // 2
    D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE = 0x3, // 3
    D3D12_PRIMITIVE_TOPOLOGY_TYPE_PATCH = 0x4, // 4
}}

ENUM!{enum D3D12_INPUT_CLASSIFICATION {
    D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA = 0x0, // 0
    D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA = 0x1, // 1
}}
...
ENUM!{enum D3D12_FILL_MODE {
    D3D12_FILL_MODE_WIREFRAME = 0x2, // 2
    D3D12_FILL_MODE_SOLID = 0x3, // 3
}}

pub type D3D12_PRIMITIVE_TOPOLOGY = D3D_PRIMITIVE_TOPOLOGY;
pub type D3D12_PRIMITIVE = D3D_PRIMITIVE;
ENUM!{enum D3D12_CULL_MODE {
    D3D12_CULL_MODE_NONE = 0x1, // 1
    D3D12_CULL_MODE_FRONT = 0x2, // 2
    D3D12_CULL_MODE_BACK = 0x3, // 3
}}
...
ENUM!{enum D3D12_COMPARISON_FUNC {
    D3D12_COMPARISON_FUNC_NEVER = 0x1, // 1
    D3D12_COMPARISON_FUNC_LESS = 0x2, // 2
    D3D12_COMPARISON_FUNC_EQUAL = 0x3, // 3
    D3D12_COMPARISON_FUNC_LESS_EQUAL = 0x4, // 4
    D3D12_COMPARISON_FUNC_GREATER = 0x5, // 5
    D3D12_COMPARISON_FUNC_NOT_EQUAL = 0x6, // 6
    D3D12_COMPARISON_FUNC_GREATER_EQUAL = 0x7, // 7
    D3D12_COMPARISON_FUNC_ALWAYS = 0x8, // 8
}}

ENUM!{enum D3D12_DEPTH_WRITE_MASK {
    D3D12_DEPTH_WRITE_MASK_ZERO = 0x0, // 0
    D3D12_DEPTH_WRITE_MASK_ALL = 0x1, // 1
}}

ENUM!{enum D3D12_STENCIL_OP {
    D3D12_STENCIL_OP_KEEP = 0x1, // 1
    D3D12_STENCIL_OP_ZERO = 0x2, // 2
    D3D12_STENCIL_OP_REPLACE = 0x3, // 3
    D3D12_STENCIL_OP_INCR_SAT = 0x4, // 4
    D3D12_STENCIL_OP_DECR_SAT = 0x5, // 5
    D3D12_STENCIL_OP_INVERT = 0x6, // 6
    D3D12_STENCIL_OP_INCR = 0x7, // 7
    D3D12_STENCIL_OP_DECR = 0x8, // 8
}}
...
ENUM!{enum D3D12_BLEND {
    D3D12_BLEND_ZERO = 0x1, // 1
    D3D12_BLEND_ONE = 0x2, // 2
    D3D12_BLEND_SRC_COLOR = 0x3, // 3
    D3D12_BLEND_INV_SRC_COLOR = 0x4, // 4
    D3D12_BLEND_SRC_ALPHA = 0x5, // 5
    D3D12_BLEND_INV_SRC_ALPHA = 0x6, // 6
    D3D12_BLEND_DEST_ALPHA = 0x7, // 7
    D3D12_BLEND_INV_DEST_ALPHA = 0x8, // 8
    D3D12_BLEND_DEST_COLOR = 0x9, // 9
    D3D12_BLEND_INV_DEST_COLOR = 0xA, // 10
    D3D12_BLEND_SRC_ALPHA_SAT = 0xB, // 11
    D3D12_BLEND_BLEND_FACTOR = 0xE, // 14
    D3D12_BLEND_INV_BLEND_FACTOR = 0xF, // 15
    D3D12_BLEND_SRC1_COLOR = 0x10, // 16
    D3D12_BLEND_INV_SRC1_COLOR = 0x11, // 17
    D3D12_BLEND_SRC1_ALPHA = 0x12, // 18
    D3D12_BLEND_INV_SRC1_ALPHA = 0x13, // 19
}}

ENUM!{enum D3D12_BLEND_OP {
    D3D12_BLEND_OP_ADD = 0x1, // 1
    D3D12_BLEND_OP_SUBTRACT = 0x2, // 2
    D3D12_BLEND_OP_REV_SUBTRACT = 0x3, // 3
    D3D12_BLEND_OP_MIN = 0x4, // 4
    D3D12_BLEND_OP_MAX = 0x5, // 5
}}

ENUM!{enum D3D12_COLOR_WRITE_ENABLE {
    D3D12_COLOR_WRITE_ENABLE_RED = 0x1, // 1
    D3D12_COLOR_WRITE_ENABLE_GREEN = 0x2, // 2
    D3D12_COLOR_WRITE_ENABLE_BLUE = 0x4, // 4
    D3D12_COLOR_WRITE_ENABLE_ALPHA = 0x8, // 8
    D3D12_COLOR_WRITE_ENABLE_ALL = 0xF, // 15
}}

ENUM!{enum D3D12_LOGIC_OP {
    D3D12_LOGIC_OP_CLEAR = 0x0, // 0
    D3D12_LOGIC_OP_SET = 0x1, // 1
    D3D12_LOGIC_OP_COPY = 0x2, // 2
    D3D12_LOGIC_OP_COPY_INVERTED = 0x3, // 3
    D3D12_LOGIC_OP_NOOP = 0x4, // 4
    D3D12_LOGIC_OP_INVERT = 0x5, // 5
    D3D12_LOGIC_OP_AND = 0x6, // 6
    D3D12_LOGIC_OP_NAND = 0x7, // 7
    D3D12_LOGIC_OP_OR = 0x8, // 8
    D3D12_LOGIC_OP_NOR = 0x9, // 9
    D3D12_LOGIC_OP_XOR = 0xA, // 10
    D3D12_LOGIC_OP_EQUIV = 0xB, // 11
    D3D12_LOGIC_OP_AND_REVERSE = 0xC, // 12
    D3D12_LOGIC_OP_AND_INVERTED = 0xD, // 13
    D3D12_LOGIC_OP_OR_REVERSE = 0xE, // 14
    D3D12_LOGIC_OP_OR_INVERTED = 0xF, // 15
}}
...
ENUM!{enum D3D12_CONSERVATIVE_RASTERIZATION_MODE {
    D3D12_CONSERVATIVE_RASTERIZATION_MODE_OFF = 0x0, // 0
    D3D12_CONSERVATIVE_RASTERIZATION_MODE_ON = 0x1, // 1
}}
...
ENUM!{enum D3D12_INDEX_BUFFER_STRIP_CUT_VALUE {
    D3D12_INDEX_BUFFER_STRIP_CUT_VALUE_DISABLED = 0x0, // 0
    D3D12_INDEX_BUFFER_STRIP_CUT_VALUE_0xFFFF = 0x1, // 1
    D3D12_INDEX_BUFFER_STRIP_CUT_VALUE_0xFFFFFFFF = 0x2, // 2
}}
...
ENUM!{enum D3D12_PIPELINE_STATE_FLAGS {
    D3D12_PIPELINE_STATE_FLAG_NONE = 0x0, // 0
    D3D12_PIPELINE_STATE_FLAG_TOOL_DEBUG = 0x1, // 1
}}
...
ENUM!{enum D3D12_FEATURE {
    D3D12_FEATURE_D3D12_OPTIONS = 0x0, // 0
    D3D12_FEATURE_ARCHITECTURE = 0x1, // 1
    D3D12_FEATURE_FEATURE_LEVELS = 0x2, // 2
    D3D12_FEATURE_FORMAT_SUPPORT = 0x3, // 3
    D3D12_FEATURE_MULTISAMPLE_QUALITY_LEVELS = 0x4, // 4
    D3D12_FEATURE_FORMAT_INFO = 0x5, // 5
    D3D12_FEATURE_GPU_VIRTUAL_ADDRESS_SUPPORT = 0x6, // 6
    D3D12_FEATURE_SHADER_MODEL = 0x7, // 7
    D3D12_FEATURE_D3D12_OPTIONS1 = 0x8, // 8
    D3D12_FEATURE_ROOT_SIGNATURE = 0xC, // 12
}}

ENUM!{enum D3D12_SHADER_MIN_PRECISION_SUPPORT {
    D3D12_SHADER_MIN_PRECISION_SUPPORT_NONE = 0x0, // 0
    D3D12_SHADER_MIN_PRECISION_SUPPORT_10_BIT = 0x1, // 1
    D3D12_SHADER_MIN_PRECISION_SUPPORT_16_BIT = 0x2, // 2
}}

ENUM!{enum D3D12_TILED_RESOURCES_TIER {
    D3D12_TILED_RESOURCES_TIER_NOT_SUPPORTED = 0x0, // 0
    D3D12_TILED_RESOURCES_TIER_1 = 0x1, // 1
    D3D12_TILED_RESOURCES_TIER_2 = 0x2, // 2
    D3D12_TILED_RESOURCES_TIER_3 = 0x3, // 3
}}

ENUM!{enum D3D12_RESOURCE_BINDING_TIER {
    D3D12_RESOURCE_BINDING_TIER_1 = 0x1, // 1
    D3D12_RESOURCE_BINDING_TIER_2 = 0x2, // 2
    D3D12_RESOURCE_BINDING_TIER_3 = 0x3, // 3
}}

ENUM!{enum D3D12_CONSERVATIVE_RASTERIZATION_TIER {
    D3D12_CONSERVATIVE_RASTERIZATION_TIER_NOT_SUPPORTED = 0x0, // 0
    D3D12_CONSERVATIVE_RASTERIZATION_TIER_1 = 0x1, // 1
    D3D12_CONSERVATIVE_RASTERIZATION_TIER_2 = 0x2, // 2
    D3D12_CONSERVATIVE_RASTERIZATION_TIER_3 = 0x3, // 3
}}

ENUM!{enum D3D12_FORMAT_SUPPORT1 {
    D3D12_FORMAT_SUPPORT1_NONE = 0x0, // 0
    D3D12_FORMAT_SUPPORT1_BUFFER = 0x1, // 1
    D3D12_FORMAT_SUPPORT1_IA_VERTEX_BUFFER = 0x2, // 2
    D3D12_FORMAT_SUPPORT1_IA_INDEX_BUFFER = 0x4, // 4
    D3D12_FORMAT_SUPPORT1_SO_BUFFER = 0x8, // 8
    D3D12_FORMAT_SUPPORT1_TEXTURE1D = 0x10, // 16
    D3D12_FORMAT_SUPPORT1_TEXTURE2D = 0x20, // 32
    D3D12_FORMAT_SUPPORT1_TEXTURE3D = 0x40, // 64
    D3D12_FORMAT_SUPPORT1_TEXTURECUBE = 0x80, // 128
    D3D12_FORMAT_SUPPORT1_SHADER_LOAD = 0x100, // 256
    D3D12_FORMAT_SUPPORT1_SHADER_SAMPLE = 0x200, // 512
    D3D12_FORMAT_SUPPORT1_SHADER_SAMPLE_COMPARISON = 0x400, // 1024
    D3D12_FORMAT_SUPPORT1_SHADER_SAMPLE_MONO_TEXT = 0x800, // 2048
    D3D12_FORMAT_SUPPORT1_MIP = 0x1000, // 4096
    D3D12_FORMAT_SUPPORT1_RENDER_TARGET = 0x4000, // 16384
    D3D12_FORMAT_SUPPORT1_BLENDABLE = 0x8000, // 32768
    D3D12_FORMAT_SUPPORT1_DEPTH_STENCIL = 0x10000, // 65536
    D3D12_FORMAT_SUPPORT1_MULTISAMPLE_RESOLVE = 0x40000, // 262144
    D3D12_FORMAT_SUPPORT1_DISPLAY = 0x80000, // 524288
    D3D12_FORMAT_SUPPORT1_CAST_WITHIN_BIT_LAYOUT = 0x100000, // 1048576
    D3D12_FORMAT_SUPPORT1_MULTISAMPLE_RENDERTARGET = 0x200000, // 2097152
    D3D12_FORMAT_SUPPORT1_MULTISAMPLE_LOAD = 0x400000, // 4194304
    D3D12_FORMAT_SUPPORT1_SHADER_GATHER = 0x800000, // 8388608
    D3D12_FORMAT_SUPPORT1_BACK_BUFFER_CAST = 0x1000000, // 16777216
    D3D12_FORMAT_SUPPORT1_TYPED_UNORDERED_ACCESS_VIEW = 0x2000000, // 33554432
    D3D12_FORMAT_SUPPORT1_SHADER_GATHER_COMPARISON = 0x4000000, // 67108864
    D3D12_FORMAT_SUPPORT1_DECODER_OUTPUT = 0x8000000, // 134217728
    D3D12_FORMAT_SUPPORT1_VIDEO_PROCESSOR_OUTPUT = 0x10000000, // 268435456
    D3D12_FORMAT_SUPPORT1_VIDEO_PROCESSOR_INPUT = 0x20000000, // 536870912
    D3D12_FORMAT_SUPPORT1_VIDEO_ENCODER = 0x40000000, // 1073741824
}}

ENUM!{enum D3D12_FORMAT_SUPPORT2 {
    D3D12_FORMAT_SUPPORT2_NONE = 0x0, // 0
    D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_ADD = 0x1, // 1
    D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_BITWISE_OPS = 0x2, // 2
    D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_COMPARE_STORE_OR_COMPARE_EXCHANGE = 0x4, // 4
    D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_EXCHANGE = 0x8, // 8
    D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_SIGNED_MIN_OR_MAX = 0x10, // 16
    D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_UNSIGNED_MIN_OR_MAX = 0x20, // 32
    D3D12_FORMAT_SUPPORT2_UAV_TYPED_LOAD = 0x40, // 64
    D3D12_FORMAT_SUPPORT2_UAV_TYPED_STORE = 0x80, // 128
    D3D12_FORMAT_SUPPORT2_OUTPUT_MERGER_LOGIC_OP = 0x100, // 256
    D3D12_FORMAT_SUPPORT2_TILED = 0x200, // 512
    D3D12_FORMAT_SUPPORT2_MULTIPLANE_OVERLAY = 0x4000, // 16384
}}

ENUM!{enum D3D12_MULTISAMPLE_QUALITY_LEVEL_FLAGS {
    D3D12_MULTISAMPLE_QUALITY_LEVELS_FLAG_NONE = 0x0, // 0
    D3D12_MULTISAMPLE_QUALITY_LEVELS_FLAG_TILED_RESOURCE = 0x1, // 1
}}

ENUM!{enum D3D12_CROSS_NODE_SHARING_TIER {
    D3D12_CROSS_NODE_SHARING_TIER_NOT_SUPPORTED = 0x0, // 0
    D3D12_CROSS_NODE_SHARING_TIER_1_EMULATED = 0x1, // 1
    D3D12_CROSS_NODE_SHARING_TIER_1 = 0x2, // 2
    D3D12_CROSS_NODE_SHARING_TIER_2 = 0x3, // 3
}}

ENUM!{enum D3D12_RESOURCE_HEAP_TIER {
    D3D12_RESOURCE_HEAP_TIER_1 = 0x1, // 1
    D3D12_RESOURCE_HEAP_TIER_2 = 0x2, // 2
}}
...
ENUM!{enum D3D_ROOT_SIGNATURE_VERSION {
    D3D_ROOT_SIGNATURE_VERSION_1 = 0x1, // 1
    D3D_ROOT_SIGNATURE_VERSION_1_0 = 0x1, // 1
    D3D_ROOT_SIGNATURE_VERSION_1_1 = 0x2, // 2
}}
...
ENUM!{enum D3D_SHADER_MODEL {
    D3D_SHADER_MODEL_5_1 = 0x51, // 81
    D3D_SHADER_MODEL_6_0 = 0x60, // 96
}}
...
ENUM!{enum D3D12_HEAP_TYPE {
    D3D12_HEAP_TYPE_DEFAULT = 0x1, // 1
    D3D12_HEAP_TYPE_UPLOAD = 0x2, // 2
    D3D12_HEAP_TYPE_READBACK = 0x3, // 3
    D3D12_HEAP_TYPE_CUSTOM = 0x4, // 4
}}

ENUM!{enum D3D12_CPU_PAGE_PROPERTY {
    D3D12_CPU_PAGE_PROPERTY_UNKNOWN = 0x0, // 0
    D3D12_CPU_PAGE_PROPERTY_NOT_AVAILABLE = 0x1, // 1
    D3D12_CPU_PAGE_PROPERTY_WRITE_COMBINE = 0x2, // 2
    D3D12_CPU_PAGE_PROPERTY_WRITE_BACK = 0x3, // 3
}}

ENUM!{enum D3D12_MEMORY_POOL {
    D3D12_MEMORY_POOL_UNKNOWN = 0x0, // 0
    D3D12_MEMORY_POOL_L0 = 0x1, // 1
    D3D12_MEMORY_POOL_L1 = 0x2, // 2
}}
...
ENUM!{enum D3D12_HEAP_FLAGS {
    D3D12_HEAP_FLAG_NONE = 0x0, // 0
    D3D12_HEAP_FLAG_SHARED = 0x1, // 1
    D3D12_HEAP_FLAG_DENY_BUFFERS = 0x4, // 4
    D3D12_HEAP_FLAG_ALLOW_DISPLAY = 0x8, // 8
    D3D12_HEAP_FLAG_SHARED_CROSS_ADAPTER = 0x20, // 32
    D3D12_HEAP_FLAG_DENY_RT_DS_TEXTURES = 0x40, // 64
    D3D12_HEAP_FLAG_DENY_NON_RT_DS_TEXTURES = 0x80, // 128
    D3D12_HEAP_FLAG_HARDWARE_PROTECTED = 0x100, // 256
    D3D12_HEAP_FLAG_ALLOW_ALL_BUFFERS_AND_TEXTURES = 0x0, // 0
    D3D12_HEAP_FLAG_ALLOW_ONLY_BUFFERS = 0xC0, // 192
    D3D12_HEAP_FLAG_ALLOW_ONLY_NON_RT_DS_TEXTURES = 0x44, // 68
    D3D12_HEAP_FLAG_ALLOW_ONLY_RT_DS_TEXTURES = 0x84, // 132
}}
...
ENUM!{enum D3D12_RESOURCE_DIMENSION {
    D3D12_RESOURCE_DIMENSION_UNKNOWN = 0x0, // 0
    D3D12_RESOURCE_DIMENSION_BUFFER = 0x1, // 1
    D3D12_RESOURCE_DIMENSION_TEXTURE1D = 0x2, // 2
    D3D12_RESOURCE_DIMENSION_TEXTURE2D = 0x3, // 3
    D3D12_RESOURCE_DIMENSION_TEXTURE3D = 0x4, // 4
}}

ENUM!{enum D3D12_TEXTURE_LAYOUT {
    D3D12_TEXTURE_LAYOUT_UNKNOWN = 0x0, // 0
    D3D12_TEXTURE_LAYOUT_ROW_MAJOR = 0x1, // 1
    D3D12_TEXTURE_LAYOUT_64KB_UNDEFINED_SWIZZLE = 0x2, // 2
    D3D12_TEXTURE_LAYOUT_64KB_STANDARD_SWIZZLE = 0x3, // 3
}}

ENUM!{enum D3D12_RESOURCE_FLAGS {
    D3D12_RESOURCE_FLAG_NONE = 0x0, // 0
    D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET = 0x1, // 1
    D3D12_RESOURCE_FLAG_ALLOW_DEPTH_STENCIL = 0x2, // 2
    D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS = 0x4, // 4
    D3D12_RESOURCE_FLAG_DENY_SHADER_RESOURCE = 0x8, // 8
    D3D12_RESOURCE_FLAG_ALLOW_CROSS_ADAPTER = 0x10, // 16
    D3D12_RESOURCE_FLAG_ALLOW_SIMULTANEOUS_ACCESS = 0x20, // 32
}}
...
UNION!(D3D12_CLEAR_VALUE, u1, Color, Color_mut, [FLOAT; 4]);
UNION!(D3D12_CLEAR_VALUE, u1, DepthStencil, DepthStencil_mut, D3D12_DEPTH_STENCIL_VALUE);
...
ENUM!{enum D3D12_TILE_RANGE_FLAGS {
    D3D12_TILE_RANGE_FLAG_NONE = 0x0, // 0
    D3D12_TILE_RANGE_FLAG_NULL = 0x1, // 1
    D3D12_TILE_RANGE_FLAG_SKIP = 0x2, // 2
    D3D12_TILE_RANGE_FLAG_REUSE_SINGLE_TILE = 0x4, // 4
}}
...
ENUM!{enum D3D12_TILE_MAPPING_FLAGS {
    D3D12_TILE_MAPPING_FLAG_NONE = 0x0, // 0
    D3D12_TILE_MAPPING_FLAG_NO_HAZARD = 0x1, // 1
}}

ENUM!{enum D3D12_TILE_COPY_FLAGS {
    D3D12_TILE_COPY_FLAG_NONE = 0x0, // 0
    D3D12_TILE_COPY_FLAG_NO_HAZARD = 0x1, // 1
    D3D12_TILE_COPY_FLAG_LINEAR_BUFFER_TO_SWIZZLED_TILED_RESOURCE = 0x2, // 2
    D3D12_TILE_COPY_FLAG_SWIZZLED_TILED_RESOURCE_TO_LINEAR_BUFFER = 0x4, // 4
}}

ENUM!{enum D3D12_RESOURCE_STATES {
    D3D12_RESOURCE_STATE_COMMON = 0x0, // 0
    D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER = 0x1, // 1
    D3D12_RESOURCE_STATE_INDEX_BUFFER = 0x2, // 2
    D3D12_RESOURCE_STATE_RENDER_TARGET = 0x4, // 4
    D3D12_RESOURCE_STATE_UNORDERED_ACCESS = 0x8, // 8
    D3D12_RESOURCE_STATE_DEPTH_WRITE = 0x10, // 16
    D3D12_RESOURCE_STATE_DEPTH_READ = 0x20, // 32
    D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE = 0x40, // 64
    D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE = 0x80, // 128
    D3D12_RESOURCE_STATE_STREAM_OUT = 0x100, // 256
    D3D12_RESOURCE_STATE_INDIRECT_ARGUMENT = 0x200, // 512
    D3D12_RESOURCE_STATE_COPY_DEST = 0x400, // 1024
    D3D12_RESOURCE_STATE_COPY_SOURCE = 0x800, // 2048
    D3D12_RESOURCE_STATE_RESOLVE_DEST = 0x1000, // 4096
    D3D12_RESOURCE_STATE_RESOLVE_SOURCE = 0x2000, // 8192
    D3D12_RESOURCE_STATE_GENERIC_READ = 0xAC3, // 2755
    D3D12_RESOURCE_STATE_PRESENT = 0x0, // 0
    D3D12_RESOURCE_STATE_PREDICATION = 0x200, // 512
}}

ENUM!{enum D3D12_RESOURCE_BARRIER_TYPE {
    D3D12_RESOURCE_BARRIER_TYPE_TRANSITION = 0x0, // 0
    D3D12_RESOURCE_BARRIER_TYPE_ALIASING = 0x1, // 1
    D3D12_RESOURCE_BARRIER_TYPE_UAV = 0x2, // 2
}}
...
ENUM!{enum D3D12_RESOURCE_BARRIER_FLAGS {
    D3D12_RESOURCE_BARRIER_FLAG_NONE = 0x0, // 0
    D3D12_RESOURCE_BARRIER_FLAG_BEGIN_ONLY = 0x1, // 1
    D3D12_RESOURCE_BARRIER_FLAG_END_ONLY = 0x2, // 2
}}

STRUCT!{struct D3D12_RESOURCE_BARRIER {
    Type: D3D12_RESOURCE_BARRIER_TYPE,
    Flags: D3D12_RESOURCE_BARRIER_FLAGS,
    u1: D3D12_RESOURCE_TRANSITION_BARRIER,
}}

UNION!(D3D12_RESOURCE_BARRIER, u1, Transition, Transition_mut, D3D12_RESOURCE_TRANSITION_BARRIER);
UNION!(D3D12_RESOURCE_BARRIER, u1, Aliasing, Aliasing_mut, D3D12_RESOURCE_ALIASING_BARRIER);
UNION!(D3D12_RESOURCE_BARRIER, u1, UAV, UAV_mut, D3D12_RESOURCE_UAV_BARRIER);
...
ENUM!{enum D3D12_TEXTURE_COPY_TYPE {
    D3D12_TEXTURE_COPY_TYPE_SUBRESOURCE_INDEX = 0x0, // 0
    D3D12_TEXTURE_COPY_TYPE_PLACED_FOOTPRINT = 0x1, // 1
}}

STRUCT!{struct D3D12_TEXTURE_COPY_LOCATION {
    pResource: *mut ID3D12Resource,
    Type: D3D12_TEXTURE_COPY_TYPE,
    u1: D3D12_PLACED_SUBRESOURCE_FOOTPRINT,
}}

UNION!(D3D12_TEXTURE_COPY_LOCATION, u1, PlacedFootprint, PlacedFootprint_mut,
    D3D12_PLACED_SUBRESOURCE_FOOTPRINT);
UNION!(D3D12_TEXTURE_COPY_LOCATION, u1, SubresourceIndex, SubresourceIndex_mut, UINT);

ENUM!{enum D3D12_SHADER_COMPONENT_MAPPING {
    D3D12_SHADER_COMPONENT_MAPPING_FROM_MEMORY_COMPONENT_0 = 0x0, // 0
    D3D12_SHADER_COMPONENT_MAPPING_FROM_MEMORY_COMPONENT_1 = 0x1, // 1
    D3D12_SHADER_COMPONENT_MAPPING_FROM_MEMORY_COMPONENT_2 = 0x2, // 2
    D3D12_SHADER_COMPONENT_MAPPING_FROM_MEMORY_COMPONENT_3 = 0x3, // 3
    D3D12_SHADER_COMPONENT_MAPPING_FORCE_VALUE_0 = 0x4, // 4
    D3D12_SHADER_COMPONENT_MAPPING_FORCE_VALUE_1 = 0x5, // 5
}}
...
pub const D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING: UINT = 0x00001688;
ENUM!{enum D3D12_BUFFER_SRV_FLAGS {
    D3D12_BUFFER_SRV_FLAG_NONE = 0x0, // 0
    D3D12_BUFFER_SRV_FLAG_RAW = 0x1, // 1
}}
...
ENUM!{enum D3D12_SRV_DIMENSION {
    D3D12_SRV_DIMENSION_UNKNOWN = 0x0, // 0
    D3D12_SRV_DIMENSION_BUFFER = 0x1, // 1
    D3D12_SRV_DIMENSION_TEXTURE1D = 0x2, // 2
    D3D12_SRV_DIMENSION_TEXTURE1DARRAY = 0x3, // 3
    D3D12_SRV_DIMENSION_TEXTURE2D = 0x4, // 4
    D3D12_SRV_DIMENSION_TEXTURE2DARRAY = 0x5, // 5
    D3D12_SRV_DIMENSION_TEXTURE2DMS = 0x6, // 6
    D3D12_SRV_DIMENSION_TEXTURE2DMSARRAY = 0x7, // 7
    D3D12_SRV_DIMENSION_TEXTURE3D = 0x8, // 8
    D3D12_SRV_DIMENSION_TEXTURECUBE = 0x9, // 9
    D3D12_SRV_DIMENSION_TEXTURECUBEARRAY = 0xA, // 10
}}
...
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, Buffer, Buffer_mut, D3D12_BUFFER_SRV);
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, Texture1D, Texture1D_mut, D3D12_TEX1D_SRV);
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, Texture1DArray, Texture1DArray_mut,
    D3D12_TEX1D_ARRAY_SRV);
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, Texture2D, Texture2D_mut, D3D12_TEX2D_SRV);
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, Texture2DArray, Texture2DArray_mut,
    D3D12_TEX2D_ARRAY_SRV);
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, Texture2DMS, Texture2DMS_mut, D3D12_TEX2DMS_SRV);
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, Texture2DMSArray, Texture2DMSArray_mut,
    D3D12_TEX2DMS_ARRAY_SRV);
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, Texture3D, Texture3D_mut, D3D12_TEX3D_SRV);
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, TextureCube, TextureCube_mut, D3D12_TEXCUBE_SRV);
UNION!(D3D12_SHADER_RESOURCE_VIEW_DESC, u1, TextureCubeArray, TextureCubeArray_mut,
...
ENUM!{enum D3D12_FILTER {
    D3D12_FILTER_MIN_MAG_MIP_POINT = 0x0, // 0
    D3D12_FILTER_MIN_MAG_POINT_MIP_LINEAR = 0x1, // 1
    D3D12_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT = 0x4, // 4
    D3D12_FILTER_MIN_POINT_MAG_MIP_LINEAR = 0x5, // 5
    D3D12_FILTER_MIN_LINEAR_MAG_MIP_POINT = 0x10, // 16
    D3D12_FILTER_MIN_LINEAR_MAG_POINT_MIP_LINEAR = 0x11, // 17
    D3D12_FILTER_MIN_MAG_LINEAR_MIP_POINT = 0x14, // 20
    D3D12_FILTER_MIN_MAG_MIP_LINEAR = 0x15, // 21
    D3D12_FILTER_ANISOTROPIC = 0x55, // 85
    ...
    D3D12_FILTER_COMPARISON_ANISOTROPIC = 0xD5, // 213
    D3D12_FILTER_MINIMUM_MIN_MAG_MIP_POINT = 0x100, // 256
    D3D12_FILTER_MINIMUM_MIN_MAG_POINT_MIP_LINEAR = 0x101, // 257
    D3D12_FILTER_MINIMUM_MIN_POINT_MAG_LINEAR_MIP_POINT = 0x104, // 260
    D3D12_FILTER_MINIMUM_MIN_POINT_MAG_MIP_LINEAR = 0x105, // 261
    D3D12_FILTER_MINIMUM_MIN_LINEAR_MAG_MIP_POINT = 0x110, // 272
    D3D12_FILTER_MINIMUM_MIN_LINEAR_MAG_POINT_MIP_LINEAR = 0x111, // 273
    D3D12_FILTER_MINIMUM_MIN_MAG_LINEAR_MIP_POINT = 0x114, // 276
    D3D12_FILTER_MINIMUM_MIN_MAG_MIP_LINEAR = 0x115, // 277
    D3D12_FILTER_MINIMUM_ANISOTROPIC = 0x155, // 341
    D3D12_FILTER_MAXIMUM_MIN_MAG_MIP_POINT = 0x180, // 384
    D3D12_FILTER_MAXIMUM_MIN_MAG_POINT_MIP_LINEAR = 0x181, // 385
    D3D12_FILTER_MAXIMUM_MIN_POINT_MAG_LINEAR_MIP_POINT = 0x184, // 388
    D3D12_FILTER_MAXIMUM_MIN_POINT_MAG_MIP_LINEAR = 0x185, // 389
    D3D12_FILTER_MAXIMUM_MIN_LINEAR_MAG_MIP_POINT = 0x190, // 400
    D3D12_FILTER_MAXIMUM_MIN_LINEAR_MAG_POINT_MIP_LINEAR = 0x191, // 401
    D3D12_FILTER_MAXIMUM_MIN_MAG_LINEAR_MIP_POINT = 0x194, // 404
    D3D12_FILTER_MAXIMUM_MIN_MAG_MIP_LINEAR = 0x195, // 405
    D3D12_FILTER_MAXIMUM_ANISOTROPIC = 0x1D5, // 469
}}

ENUM!{enum D3D12_FILTER_TYPE {
    D3D12_FILTER_TYPE_POINT = 0x0, // 0
    D3D12_FILTER_TYPE_LINEAR = 0x1, // 1
}}

ENUM!{enum D3D12_FILTER_REDUCTION_TYPE {
    D3D12_FILTER_REDUCTION_TYPE_STANDARD = 0x0, // 0
    D3D12_FILTER_REDUCTION_TYPE_COMPARISON = 0x1, // 1
    D3D12_FILTER_REDUCTION_TYPE_MINIMUM = 0x2, // 2
    D3D12_FILTER_REDUCTION_TYPE_MAXIMUM = 0x3, // 3
}}
...
ENUM!{enum D3D12_TEXTURE_ADDRESS_MODE {
    D3D12_TEXTURE_ADDRESS_MODE_WRAP = 0x1, // 1
    D3D12_TEXTURE_ADDRESS_MODE_MIRROR = 0x2, // 2
    D3D12_TEXTURE_ADDRESS_MODE_CLAMP = 0x3, // 3
    D3D12_TEXTURE_ADDRESS_MODE_BORDER = 0x4, // 4
    D3D12_TEXTURE_ADDRESS_MODE_MIRROR_ONCE = 0x5, // 5
}}
...
ENUM!{enum D3D12_BUFFER_UAV_FLAGS {
    D3D12_BUFFER_UAV_FLAG_NONE = 0x0, // 0
    D3D12_BUFFER_UAV_FLAG_RAW = 0x1, // 1
}}
...
ENUM!{enum D3D12_UAV_DIMENSION {
    D3D12_UAV_DIMENSION_UNKNOWN = 0x0, // 0
    D3D12_UAV_DIMENSION_BUFFER = 0x1, // 1
    D3D12_UAV_DIMENSION_TEXTURE1D = 0x2, // 2
    D3D12_UAV_DIMENSION_TEXTURE1DARRAY = 0x3, // 3
    D3D12_UAV_DIMENSION_TEXTURE2D = 0x4, // 4
    D3D12_UAV_DIMENSION_TEXTURE2DARRAY = 0x5, // 5
    D3D12_UAV_DIMENSION_TEXTURE3D = 0x8, // 8
}}
...
UNION!(D3D12_UNORDERED_ACCESS_VIEW_DESC, u1, Buffer, Buffer_mut, D3D12_BUFFER_UAV);
UNION!(D3D12_UNORDERED_ACCESS_VIEW_DESC, u1, Texture1D, Texture1D_mut, D3D12_TEX1D_UAV);
UNION!(D3D12_UNORDERED_ACCESS_VIEW_DESC, u1, Texture1DArray, Texture1DArray_mut,
    D3D12_TEX1D_ARRAY_UAV);
UNION!(D3D12_UNORDERED_ACCESS_VIEW_DESC, u1, Texture2D, Texture2D_mut, D3D12_TEX2D_UAV);
UNION!(D3D12_UNORDERED_ACCESS_VIEW_DESC, u1, Texture2DArray, Texture2DArray_mut,
    D3D12_TEX2D_ARRAY_UAV);
UNION!(D3D12_UNORDERED_ACCESS_VIEW_DESC, u1, Texture3D, Texture3D_mut, D3D12_TEX3D_UAV);
...
ENUM!{enum D3D12_RTV_DIMENSION {
    D3D12_RTV_DIMENSION_UNKNOWN = 0x0, // 0
    D3D12_RTV_DIMENSION_BUFFER = 0x1, // 1
    D3D12_RTV_DIMENSION_TEXTURE1D = 0x2, // 2
    D3D12_RTV_DIMENSION_TEXTURE1DARRAY = 0x3, // 3
    D3D12_RTV_DIMENSION_TEXTURE2D = 0x4, // 4
    D3D12_RTV_DIMENSION_TEXTURE2DARRAY = 0x5, // 5
    D3D12_RTV_DIMENSION_TEXTURE2DMS = 0x6, // 6
    D3D12_RTV_DIMENSION_TEXTURE2DMSARRAY = 0x7, // 7
    D3D12_RTV_DIMENSION_TEXTURE3D = 0x8, // 8
}}
...
UNION!(D3D12_RENDER_TARGET_VIEW_DESC, u1, Buffer, Buffer_mut, D3D12_BUFFER_RTV);
UNION!(D3D12_RENDER_TARGET_VIEW_DESC, u1, Texture1D, Texture1D_mut, D3D12_TEX1D_RTV);
UNION!(D3D12_RENDER_TARGET_VIEW_DESC, u1, Texture1DArray, Texture1DArray_mut,
    D3D12_TEX1D_ARRAY_RTV);
UNION!(D3D12_RENDER_TARGET_VIEW_DESC, u1, Texture2D, Texture2D_mut, D3D12_TEX2D_RTV);
UNION!(D3D12_RENDER_TARGET_VIEW_DESC, u1, Texture2DArray, Texture2DArray_mut,
    D3D12_TEX2D_ARRAY_RTV);
UNION!(D3D12_RENDER_TARGET_VIEW_DESC, u1, Texture2DMS, Texture2DMS_mut, D3D12_TEX2DMS_RTV);
UNION!(D3D12_RENDER_TARGET_VIEW_DESC, u1, Texture2DMSArray, Texture2DMSArray_mut,
    D3D12_TEX2DMS_ARRAY_RTV);
UNION!(D3D12_RENDER_TARGET_VIEW_DESC, u1, Texture3D, Texture3D_mut, D3D12_TEX3D_RTV);
...
ENUM!{enum D3D12_DSV_FLAGS {
    D3D12_DSV_FLAG_NONE = 0x0, // 0
    D3D12_DSV_FLAG_READ_ONLY_DEPTH = 0x1, // 1
    D3D12_DSV_FLAG_READ_ONLY_STENCIL = 0x2, // 2
}}

ENUM!{enum D3D12_DSV_DIMENSION {
    D3D12_DSV_DIMENSION_UNKNOWN = 0x0, // 0
    D3D12_DSV_DIMENSION_TEXTURE1D = 0x1, // 1
    D3D12_DSV_DIMENSION_TEXTURE1DARRAY = 0x2, // 2
    D3D12_DSV_DIMENSION_TEXTURE2D = 0x3, // 3
    D3D12_DSV_DIMENSION_TEXTURE2DARRAY = 0x4, // 4
    D3D12_DSV_DIMENSION_TEXTURE2DMS = 0x5, // 5
    D3D12_DSV_DIMENSION_TEXTURE2DMSARRAY = 0x6, // 6
}}
...
STRUCT!{struct D3D12_DEPTH_STENCIL_VIEW_DESC {
    ...
    u1: D3D12_TEX1D_ARRAY_DSV,
}}

UNION!(D3D12_DEPTH_STENCIL_VIEW_DESC, u1, Texture1D, Texture1D_mut, D3D12_TEX1D_DSV);
UNION!(D3D12_DEPTH_STENCIL_VIEW_DESC, u1, Texture1DArray, Texture1DArray_mut,
    D3D12_TEX1D_ARRAY_DSV);
UNION!(D3D12_DEPTH_STENCIL_VIEW_DESC, u1, Texture2D, Texture2D_mut, D3D12_TEX2D_DSV);
UNION!(D3D12_DEPTH_STENCIL_VIEW_DESC, u1, Texture2DArray, Texture2DArray_mut,
    D3D12_TEX2D_ARRAY_DSV);
UNION!(D3D12_DEPTH_STENCIL_VIEW_DESC, u1, Texture2DMS, Texture2DMS_mut, D3D12_TEX2DMS_DSV);
UNION!(D3D12_DEPTH_STENCIL_VIEW_DESC, u1, Texture2DMSArray, Texture2DMSArray_mut,
    D3D12_TEX2DMS_ARRAY_DSV);

ENUM!{enum D3D12_CLEAR_FLAGS {
    D3D12_CLEAR_FLAG_DEPTH = 0x1, // 1
    D3D12_CLEAR_FLAG_STENCIL = 0x2, // 2
}}

ENUM!{enum D3D12_FENCE_FLAGS {
    D3D12_FENCE_FLAG_NONE = 0x0, // 0
    D3D12_FENCE_FLAG_SHARED = 0x1, // 1
    D3D12_FENCE_FLAG_SHARED_CROSS_ADAPTER = 0x2, // 2
}}

ENUM!{enum D3D12_DESCRIPTOR_HEAP_TYPE {
    D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV = 0x0, // 0
    D3D12_DESCRIPTOR_HEAP_TYPE_SAMPLER = 0x1, // 1
    D3D12_DESCRIPTOR_HEAP_TYPE_RTV = 0x2, // 2
    D3D12_DESCRIPTOR_HEAP_TYPE_DSV = 0x3, // 3
    D3D12_DESCRIPTOR_HEAP_TYPE_NUM_TYPES = 0x4, // 4
}}

ENUM!{enum D3D12_DESCRIPTOR_HEAP_FLAGS {
    D3D12_DESCRIPTOR_HEAP_FLAG_NONE = 0x0, // 0
    D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE = 0x1, // 1
}}
...
ENUM!{enum D3D12_DESCRIPTOR_RANGE_TYPE {
    D3D12_DESCRIPTOR_RANGE_TYPE_SRV = 0x0, // 0
    D3D12_DESCRIPTOR_RANGE_TYPE_UAV = 0x1, // 1
    D3D12_DESCRIPTOR_RANGE_TYPE_CBV = 0x2, // 2
    D3D12_DESCRIPTOR_RANGE_TYPE_SAMPLER = 0x3, // 3
}}
...
ENUM!{enum D3D12_SHADER_VISIBILITY {
    D3D12_SHADER_VISIBILITY_ALL = 0x0, // 0
    D3D12_SHADER_VISIBILITY_VERTEX = 0x1, // 1
    D3D12_SHADER_VISIBILITY_HULL = 0x2, // 2
    D3D12_SHADER_VISIBILITY_DOMAIN = 0x3, // 3
    D3D12_SHADER_VISIBILITY_GEOMETRY = 0x4, // 4
    D3D12_SHADER_VISIBILITY_PIXEL = 0x5, // 5
}}

ENUM!{enum D3D12_ROOT_PARAMETER_TYPE {
    D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE = 0x0, // 0
    D3D12_ROOT_PARAMETER_TYPE_32BIT_CONSTANTS = 0x1, // 1
    D3D12_ROOT_PARAMETER_TYPE_CBV = 0x2, // 2
    D3D12_ROOT_PARAMETER_TYPE_SRV = 0x3, // 3
    D3D12_ROOT_PARAMETER_TYPE_UAV = 0x4, // 4
}}

#[cfg(target_pointer_width = "32")]
STRUCT!{struct D3D12_ROOT_PARAMETER {
    ParameterType: D3D12_ROOT_PARAMETER_TYPE,
    u1: D3D12_ROOT_CONSTANTS,
...
STRUCT!{struct D3D12_ROOT_PARAMETER {
    ParameterType: D3D12_ROOT_PARAMETER_TYPE,
    u1: D3D12_ROOT_DESCRIPTOR_TABLE,
    ShaderVisibility: D3D12_SHADER_VISIBILITY,
}}

UNION!(D3D12_ROOT_PARAMETER, u1, DescriptorTable, DescriptorTable_mut,
    D3D12_ROOT_DESCRIPTOR_TABLE);
UNION!(D3D12_ROOT_PARAMETER, u1, Constants, Constants_mut, D3D12_ROOT_CONSTANTS);
UNION!(D3D12_ROOT_PARAMETER, u1, Descriptor, Descriptor_mut, D3D12_ROOT_DESCRIPTOR);

ENUM!{enum D3D12_ROOT_SIGNATURE_FLAGS {
    D3D12_ROOT_SIGNATURE_FLAG_NONE = 0x0, // 0
    D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT = 0x1, // 1
    D3D12_ROOT_SIGNATURE_FLAG_DENY_VERTEX_SHADER_ROOT_ACCESS = 0x2, // 2
    D3D12_ROOT_SIGNATURE_FLAG_DENY_HULL_SHADER_ROOT_ACCESS = 0x4, // 4
    D3D12_ROOT_SIGNATURE_FLAG_DENY_DOMAIN_SHADER_ROOT_ACCESS = 0x8, // 8
    D3D12_ROOT_SIGNATURE_FLAG_DENY_GEOMETRY_SHADER_ROOT_ACCESS = 0x10, // 16
    D3D12_ROOT_SIGNATURE_FLAG_DENY_PIXEL_SHADER_ROOT_ACCESS = 0x20, // 32
    D3D12_ROOT_SIGNATURE_FLAG_ALLOW_STREAM_OUTPUT = 0x40, // 64
}}

ENUM!{enum D3D12_STATIC_BORDER_COLOR {
    D3D12_STATIC_BORDER_COLOR_TRANSPARENT_BLACK = 0x0, // 0
    D3D12_STATIC_BORDER_COLOR_OPAQUE_BLACK = 0x1, // 1
    D3D12_STATIC_BORDER_COLOR_OPAQUE_WHITE = 0x2, // 2
}}
...
ENUM!{enum D3D12_DESCRIPTOR_RANGE_FLAGS {
    D3D12_DESCRIPTOR_RANGE_FLAG_NONE = 0x0, // 0
    D3D12_DESCRIPTOR_RANGE_FLAG_DESCRIPTORS_VOLATILE = 0x1, // 1
    D3D12_DESCRIPTOR_RANGE_FLAG_DATA_VOLATILE = 0x2, // 2
    D3D12_DESCRIPTOR_RANGE_FLAG_DATA_STATIC_WHILE_SET_AT_EXECUTE = 0x4, // 4
    D3D12_DESCRIPTOR_RANGE_FLAG_DATA_STATIC = 0x8, // 8
}}
...
ENUM!{enum D3D12_ROOT_DESCRIPTOR_FLAGS {
    D3D12_ROOT_DESCRIPTOR_FLAG_NONE = 0x0, // 0
    D3D12_ROOT_DESCRIPTOR_FLAG_DATA_VOLATILE = 0x2, // 2
    D3D12_ROOT_DESCRIPTOR_FLAG_DATA_STATIC_WHILE_SET_AT_EXECUTE = 0x4, // 4
    D3D12_ROOT_DESCRIPTOR_FLAG_DATA_STATIC = 0x8, // 8
}}
...
STRUCT!{struct D3D12_ROOT_PARAMETER1 {
    ParameterType: D3D12_ROOT_PARAMETER_TYPE,
    u1: D3D12_ROOT_DESCRIPTOR_TABLE1,
    ShaderVisibility: D3D12_SHADER_VISIBILITY,
}}

UNION!(D3D12_ROOT_PARAMETER1, u1, DescriptorTable, DescriptorTable_mut,
    D3D12_ROOT_DESCRIPTOR_TABLE1);
UNION!(D3D12_ROOT_PARAMETER1, u1, Constants, Constants_mut, D3D12_ROOT_CONSTANTS);
UNION!(D3D12_ROOT_PARAMETER1, u1, Descriptor, Descriptor_mut, D3D12_ROOT_DESCRIPTOR1);
...
STRUCT!{struct D3D12_VERSIONED_ROOT_SIGNATURE_DESC {
    ...
    u1: D3D12_ROOT_SIGNATURE_DESC,
}}

UNION!(D3D12_VERSIONED_ROOT_SIGNATURE_DESC, u1, Desc_1_0, Desc_1_0_mut, D3D12_ROOT_SIGNATURE_DESC);
UNION!(D3D12_VERSIONED_ROOT_SIGNATURE_DESC, u1, Desc_1_1, Desc_1_1_mut,
...
ENUM!{enum D3D12_QUERY_HEAP_TYPE {
    D3D12_QUERY_HEAP_TYPE_OCCLUSION = 0x0, // 0
    D3D12_QUERY_HEAP_TYPE_TIMESTAMP = 0x1, // 1
    D3D12_QUERY_HEAP_TYPE_PIPELINE_STATISTICS = 0x2, // 2
    D3D12_QUERY_HEAP_TYPE_SO_STATISTICS = 0x3, // 3
}}
...
ENUM!{enum D3D12_QUERY_TYPE {
    D3D12_QUERY_TYPE_OCCLUSION = 0x0, // 0
    D3D12_QUERY_TYPE_BINARY_OCCLUSION = 0x1, // 1
    D3D12_QUERY_TYPE_TIMESTAMP = 0x2, // 2
    D3D12_QUERY_TYPE_PIPELINE_STATISTICS = 0x3, // 3
    D3D12_QUERY_TYPE_SO_STATISTICS_STREAM0 = 0x4, // 4
    D3D12_QUERY_TYPE_SO_STATISTICS_STREAM1 = 0x5, // 5
    D3D12_QUERY_TYPE_SO_STATISTICS_STREAM2 = 0x6, // 6
    D3D12_QUERY_TYPE_SO_STATISTICS_STREAM3 = 0x7, // 7
}}

ENUM!{enum D3D12_PREDICATION_OP {
    D3D12_PREDICATION_OP_EQUAL_ZERO = 0x0, // 0
    D3D12_PREDICATION_OP_NOT_EQUAL_ZERO = 0x1, // 1
}}
...
ENUM!{enum D3D12_INDIRECT_ARGUMENT_TYPE {
    D3D12_INDIRECT_ARGUMENT_TYPE_DRAW = 0x0, // 0
    D3D12_INDIRECT_ARGUMENT_TYPE_DRAW_INDEXED = 0x1, // 1
    D3D12_INDIRECT_ARGUMENT_TYPE_DISPATCH = 0x2, // 2
    D3D12_INDIRECT_ARGUMENT_TYPE_VERTEX_BUFFER_VIEW = 0x3, // 3
    D3D12_INDIRECT_ARGUMENT_TYPE_INDEX_BUFFER_VIEW = 0x4, // 4
    D3D12_INDIRECT_ARGUMENT_TYPE_CONSTANT = 0x5, // 5
    D3D12_INDIRECT_ARGUMENT_TYPE_CONSTANT_BUFFER_VIEW = 0x6, // 6
    D3D12_INDIRECT_ARGUMENT_TYPE_SHADER_RESOURCE_VIEW = 0x7, // 7
    D3D12_INDIRECT_ARGUMENT_TYPE_UNORDERED_ACCESS_VIEW = 0x8, // 8
}}
...
STRUCT!{struct D3D12_INDIRECT_ARGUMENT_DESC {
    ...
    u1: D3D12_INDIRECT_ARGUMENT_DESC_Constant,
}}

UNION!(D3D12_INDIRECT_ARGUMENT_DESC, u1, VertexBuffer, VertexBuffer_mut,
    D3D12_INDIRECT_ARGUMENT_DESC_VertexBuffer);
UNION!(D3D12_INDIRECT_ARGUMENT_DESC, u1, Constant, Constant_mut,
    D3D12_INDIRECT_ARGUMENT_DESC_Constant);
UNION!(D3D12_INDIRECT_ARGUMENT_DESC, u1, ConstantBufferView, ConstantBufferView_mut,
    D3D12_INDIRECT_ARGUMENT_DESC_ConstantBufferView);
UNION!(D3D12_INDIRECT_ARGUMENT_DESC, u1, ShaderResourceView, ShaderResourceView_mut,
    D3D12_INDIRECT_ARGUMENT_DESC_ShaderResourceView);
UNION!(D3D12_INDIRECT_ARGUMENT_DESC, u1, UnorderedAccessView, UnorderedAccessView_mut,
...
interface ID3D12Heap(ID3D12HeapVtbl): ID3D12Pageable(ID3D12PageableVtbl) {
    fn GetDesc(__ret_val: *mut D3D12_HEAP_DESC,) -> *mut D3D12_HEAP_DESC,
}}
...
interface ID3D12Resource(ID3D12ResourceVtbl): ID3D12Pageable(ID3D12PageableVtbl) {
    ...
    fn GetDesc(__ret_val: *mut D3D12_RESOURCE_DESC,) -> *mut D3D12_RESOURCE_DESC,
...
interface ID3D12CommandAllocator(ID3D12CommandAllocatorVtbl): 
...
interface ID3D12PipelineState(ID3D12PipelineStateVtbl): 
    ID3D12Pageable(ID3D12PageableVtbl) {
...
interface ID3D12DescriptorHeap(ID3D12DescriptorHeapVtbl): 
    ID3D12Pageable(ID3D12PageableVtbl) {
    fn GetDesc(__ret_val: *mut D3D12_DESCRIPTOR_HEAP_DESC,) -> *mut D3D12_DESCRIPTOR_HEAP_DESC,
    fn GetCPUDescriptorHandleForHeapStart(__ret_val: *mut D3D12_CPU_DESCRIPTOR_HANDLE,) -> *mut D3D12_CPU_DESCRIPTOR_HANDLE,
    fn GetGPUDescriptorHandleForHeapStart(__ret_val: *mut D3D12_GPU_DESCRIPTOR_HANDLE,) -> *mut D3D12_GPU_DESCRIPTOR_HANDLE,
}}
...
interface ID3D12CommandList(ID3D12CommandListVtbl): 
    ID3D12DeviceChild(ID3D12DeviceChildVtbl) {
...
interface ID3D12GraphicsCommandList(ID3D12GraphicsCommandListVtbl): 
    ...
    fn IASetPrimitiveTopology(PrimitiveTopology: D3D12_PRIMITIVE_TOPOLOGY,) -> (),
    fn RSSetViewports(
        NumViewports: UINT,
    ...
    fn SetPipelineState(pPipelineState: *mut ID3D12PipelineState,) -> (),
    fn ResourceBarrier(
        NumBarriers: UINT,
        pBarriers: *const D3D12_RESOURCE_BARRIER,
    ) -> (),
    fn ExecuteBundle(pCommandList: *mut ID3D12GraphicsCommandList,) -> (),
    fn SetDescriptorHeaps(
        NumDescriptorHeaps: UINT,
        ppDescriptorHeaps: *mut *mut ID3D12DescriptorHeap,
    ) -> (),
    fn SetComputeRootSignature(pRootSignature: *mut ID3D12RootSignature,) -> (),
    fn SetGraphicsRootSignature(pRootSignature: *mut ID3D12RootSignature,) -> (),
...
interface ID3D12CommandQueue(ID3D12CommandQueueVtbl): 
    ID3D12Pageable(ID3D12PageableVtbl) {
    ...
    fn GetDesc(__ret_val: *mut D3D12_COMMAND_QUEUE_DESC,) -> *mut D3D12_COMMAND_QUEUE_DESC,
}}
...
interface ID3D12Device(ID3D12DeviceVtbl): ID3D12Object(ID3D12ObjectVtbl) {
    ...
    fn GetDescriptorHandleIncrementSize(DescriptorHeapType: D3D12_DESCRIPTOR_HEAP_TYPE,) -> UINT,
...
ENUM!{enum D3D12_MULTIPLE_FENCE_WAIT_FLAGS {
    D3D12_MULTIPLE_FENCE_WAIT_FLAG_NONE = 0x0, // 0
    D3D12_MULTIPLE_FENCE_WAIT_FLAG_ANY = 0x1, // 1
    D3D12_MULTIPLE_FENCE_WAIT_FLAG_ALL = 0x0, // 0
}}

ENUM!{enum D3D12_RESIDENCY_PRIORITY {
    D3D12_RESIDENCY_PRIORITY_MINIMUM = 0x28000000, // 671088640
    D3D12_RESIDENCY_PRIORITY_LOW = 0x50000000, // 1342177280
    D3D12_RESIDENCY_PRIORITY_NORMAL = 0x78000000, // 2013265920
    D3D12_RESIDENCY_PRIORITY_HIGH = 0xA0000000, // 2684354560
    D3D12_RESIDENCY_PRIORITY_MAXIMUM = 0xC8000000, // 3355443200
}}
