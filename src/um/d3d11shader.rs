...
interface ID3D11ShaderReflection(ID3D11ShaderReflectionVtbl): IUnknown(IUnknownVtbl) {
    ...
    fn GetResourceBindingDesc(
        ResourceIndex: UINT, pDesc: *mut D3D11_SHADER_INPUT_BIND_DESC
    ) -> HRESULT,
    fn GetInputParameterDesc(
        ParameterIndex: UINT, pDesc: *mut D3D11_SIGNATURE_PARAMETER_DESC
    ) -> HRESULT,
    ...
    fn GetResourceBindingDescByName(
        Name: LPCSTR, pDesc: *mut D3D11_SHADER_INPUT_BIND_DESC
    ) -> HRESULT,
...
interface ID3D11LibraryReflection(ID3D11LibraryReflectionVtbl): IUnknown(IUnknownVtbl) {
    fn GetDesc(pDesc: *mut D3D11_LIBRARY_DESC) -> HRESULT,
    fn GetFunctionByIndex(FunctionIndex: INT) -> *mut ID3D11FunctionReflection
}}
...
interface ID3D11FunctionReflection(ID3D11FunctionReflectionVtbl) {
    fn GetDesc(pDesc: *mut D3D11_FUNCTION_DESC) -> HRESULT,
    fn GetConstantBufferByIndex(
        BufferIndex: UINT
    ) -> *mut ID3D11ShaderReflectionConstantBuffer,
    fn GetConstantBufferByName(
...
interface ID3D11FunctionParameterReflection(ID3D11FunctionParameterReflectionVtbl) {
    fn GetDesc(pDesc: *mut D3D11_PARAMETER_DESC) -> HRESULT
}}
...
interface ID3D11Module(ID3D11ModuleVtbl): IUnknown(IUnknownVtbl) {
    fn CreateInstance(
        pNamespace: LPCSTR, ppModuleInstance: *mut *mut ID3D11ModuleInstance
    ) -> HRESULT
}}
...
interface ID3D11ModuleInstance(ID3D11ModuleInstanceVtbl): IUnknown(IUnknownVtbl) {
    ...
    fn BindConstantBufferByName(
        pName: LPCSTR, uDstSlot: UINT, cbDstOffset: UINT
    ) -> HRESULT,
    ...
    fn BindUnorderedAccessViewByName(
        pName: LPCSTR, uDstSlot: UINT, uCount: UINT
    ) -> HRESULT,
    fn BindResourceAsUnorderedAccessView(
        uSrcSrvSlot: UINT, uDstUavSlot: UINT, uCount: UINT
    ) -> HRESULT,
    fn BindResourceAsUnorderedAccessViewByName(
        pSrvName: LPCSTR, uDstUavSlot: UINT, uCount: UINT
    ) -> HRESULT
}}
...
interface ID3D11Linker(ID3D11LinkerVtbl): IUnknown(IUnknownVtbl) {
    fn Link(
        pEntry: *mut ID3D11ModuleInstance, pEntryName: LPCSTR, pTargetName: LPCSTR,
        uFlags: UINT, ppShaderBlob: *mut *mut ID3DBlob, ppErrorBuffer: *mut *mut ID3DBlob
    ) -> HRESULT,
    fn UseLibrary(pLibraryMI: *mut ID3D11ModuleInstance) -> HRESULT,
...
interface ID3D11FunctionLinkingGraph(ID3D11FunctionLinkingGraphVtbl): IUnknown(IUnknownVtbl) {
    ...
    fn SetInputSignature(
        pInputParameters: *const D3D11_PARAMETER_DESC, cInputParameters: UINT,
        ppInputNode: *mut *mut ID3D11LinkingNode
    ) -> HRESULT,
    fn SetOutputSignature(
        pOutputParameters: *const D3D11_PARAMETER_DESC, cOutputParameters: UINT,
    ...
    fn PassValue(
        pSrcNode: *mut ID3D11LinkingNode, SrcParameterIndex: INT,
        pDstNode: *mut ID3D11LinkingNode, DstParameterIndex: INT
    ) -> HRESULT,
    fn PassValueWithSwizzle(
        pSrcNode: *mut ID3D11LinkingNode, SrcParameterIndex: INT, pSrcSwizzle: LPCSTR,
        pDstNode: *mut ID3D11LinkingNode, DstParameterIndex: INT, pDstSwizzle: LPCSTR
    ) -> HRESULT,
    fn GetLastError(ppErrorBuffer: *mut *mut ID3DBlob) -> HRESULT,
    fn GenerateHlsl(uFlags: UINT, ppBuffer: *mut *mut ID3DBlob) -> HRESULT
}}
