...
STRUCT!{#[debug] struct D3D11_SIGNATURE_PARAMETER_DESC {
    SemanticName: LPCSTR,
    SemanticIndex: UINT,
    Register: UINT,
...
STRUCT!{#[debug] struct D3D11_SHADER_BUFFER_DESC {
    Name: LPCSTR,
...
STRUCT!{#[debug] struct D3D11_SHADER_VARIABLE_DESC {
    Name: LPCSTR,
    StartOffset: UINT,
    Size: UINT,
    uFlags: UINT,
...
STRUCT!{#[debug] struct D3D11_SHADER_TYPE_DESC {
...
STRUCT!{#[debug] struct D3D11_SHADER_DESC {
    Version: UINT,
    Creator: LPCSTR,
    Flags: UINT,
...
STRUCT!{#[debug] struct D3D11_SHADER_INPUT_BIND_DESC {
    Name: LPCSTR,
...
STRUCT!{#[debug] struct D3D11_LIBRARY_DESC {
    Creator: LPCSTR,
    Flags: UINT,
    FunctionCount: UINT,
}}
STRUCT!{#[debug] struct D3D11_FUNCTION_DESC {
    Version: UINT,
    Creator: LPCSTR,
    Flags: UINT,
    ConstantBuffers: UINT,
...
STRUCT!{#[debug] struct D3D11_PARAMETER_DESC {
    Name: LPCSTR,
    SemanticName: LPCSTR,
    Type: D3D_SHADER_VARIABLE_TYPE,
    Class: D3D_SHADER_VARIABLE_CLASS,
