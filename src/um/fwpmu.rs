...
use shared::fwpmtypes::{FWPM_CALLOUT0, FWPM_CALLOUT_CHANGE0, FWPM_CALLOUT_ENUM_TEMPLATE0, FWPM_CALLOUT_SUBSCRIPTION0, FWPM_CONNECTION0, FWPM_CONNECTION_ENUM_TEMPLATE0, FWPM_CONNECTION_EVENT_TYPE, FWPM_CONNECTION_SUBSCRIPTION0, FWPM_ENGINE_OPTION, FWPM_FILTER0, FWPM_FILTER_CHANGE0, FWPM_FILTER_CONDITION0, FWPM_FILTER_ENUM_TEMPLATE0, FWPM_FILTER_SUBSCRIPTION0, FWPM_LAYER0, FWPM_LAYER_ENUM_TEMPLATE0, FWPM_NET_EVENT0, FWPM_NET_EVENT1, FWPM_NET_EVENT2, FWPM_NET_EVENT3, FWPM_NET_EVENT_ENUM_TEMPLATE0, FWPM_NET_EVENT_SUBSCRIPTION0, FWPM_PROVIDER0, FWPM_PROVIDER_CHANGE0, FWPM_PROVIDER_CONTEXT0, FWPM_PROVIDER_CONTEXT1, FWPM_PROVIDER_CONTEXT2, FWPM_PROVIDER_CONTEXT3, FWPM_PROVIDER_CONTEXT_CHANGE0, FWPM_PROVIDER_CONTEXT_ENUM_TEMPLATE0, FWPM_PROVIDER_CONTEXT_SUBSCRIPTION0, FWPM_PROVIDER_ENUM_TEMPLATE0, FWPM_PROVIDER_SUBSCRIPTION0, FWPM_SESSION0, FWPM_SESSION_ENUM_TEMPLATE0, FWPM_SUBLAYER0, FWPM_SUBLAYER_CHANGE0, FWPM_SUBLAYER_ENUM_TEMPLATE0, FWPM_SUBLAYER_SUBSCRIPTION0, FWPM_SYSTEM_PORTS0, FWPM_VSWITCH_EVENT0, FWPM_VSWITCH_EVENT_SUBSCRIPTION0};
use shared::guiddef::GUID;
use shared::iketypes::{IKEEXT_SA_DETAILS0, IKEEXT_SA_DETAILS1, IKEEXT_SA_DETAILS2, IKEEXT_SA_ENUM_TEMPLATE0, IKEEXT_STATISTICS0, IKEEXT_STATISTICS1, IKEEXT_TRAFFIC0};
use shared::ipsectypes::{IPSEC_AUTH_AES_128, IPSEC_AUTH_AES_192, IPSEC_AUTH_CONFIG_GCM_AES_128, IPSEC_AUTH_CONFIG_GCM_AES_192, IPSEC_AUTH_CONFIG_GCM_AES_256, IPSEC_AUTH_CONFIG_HMAC_MD5_96, IPSEC_AUTH_CONFIG_HMAC_SHA_1_96, IPSEC_AUTH_CONFIG_HMAC_SHA_256_128, IPSEC_AUTH_MD5, IPSEC_AUTH_SHA_1, IPSEC_AUTH_AES_256, IPSEC_AUTH_SHA_256, IPSEC_AUTH_TRANSFORM_ID0, IPSEC_CIPHER_CONFIG_CBC_DES, IPSEC_CIPHER_CONFIG_CBC_3DES, IPSEC_CIPHER_CONFIG_CBC_AES_128, IPSEC_CIPHER_CONFIG_CBC_AES_192, IPSEC_CIPHER_CONFIG_CBC_AES_256, IPSEC_CIPHER_CONFIG_GCM_AES_128, IPSEC_CIPHER_CONFIG_GCM_AES_192, IPSEC_CIPHER_CONFIG_GCM_AES_256, IPSEC_CIPHER_TRANSFORM_ID0, IPSEC_CIPHER_TYPE_3DES, IPSEC_CIPHER_TYPE_AES_128, IPSEC_CIPHER_TYPE_AES_192, IPSEC_CIPHER_TYPE_AES_256, IPSEC_CIPHER_TYPE_DES, IPSEC_DOSP_STATISTICS0, IPSEC_DOSP_STATE0, IPSEC_DOSP_STATE_ENUM_TEMPLATE0, IPSEC_GETSPI0, IPSEC_GETSPI1, IPSEC_KEY_MANAGER0, IPSEC_SA_BUNDLE0, IPSEC_SA_BUNDLE1, IPSEC_SA_CONTEXT0, IPSEC_SA_CONTEXT1, IPSEC_SA_CONTEXT_CHANGE0, IPSEC_SA_CONTEXT_ENUM_TEMPLATE0, IPSEC_SA_CONTEXT_SUBSCRIPTION0, IPSEC_SA_DETAILS0, IPSEC_SA_DETAILS1, IPSEC_SA_ENUM_TEMPLATE0, IPSEC_SA_SPI, IPSEC_STATISTICS0, IPSEC_STATISTICS1, IPSEC_TRAFFIC0, IPSEC_TRAFFIC1};
use shared::minwindef::{BOOL, DWORD, UINT};
use shared::rpcdce::SEC_WINNT_AUTH_IDENTITY_W;
use um::winnt::{ACL, DELETE, HANDLE, PACL, PSID, PSECURITY_DESCRIPTOR, PCWSTR, SECURITY_INFORMATION, SID, STANDARD_RIGHTS_EXECUTE, STANDARD_RIGHTS_READ, STANDARD_RIGHTS_REQUIRED, STANDARD_RIGHTS_WRITE};
