...
UNION2!{union CLAIM_SECURITY_ATTRIBUTE_V1_u {
    [usize; 1],
...
pub const SECURITY_DYNAMIC_TRACKING: BOOLEAN = TRUE as BOOLEAN;
pub const SECURITY_STATIC_TRACKING: BOOLEAN = FALSE as BOOLEAN;
...
BITFIELD!(PROCESS_MITIGATION_DEP_POLICY_u_s BitFields: DWORD [
    Enable set_Enable[0..1],
    DisableAtlThunkEmulation set_DisableAtlThunkEmulation[1..2],
    ReservedFlags set_ReservedFlags[2..32],
]);
UNION2!{union PROCESS_MITIGATION_DEP_POLICY_u {
    [u32; 1],
    Flags Flags_mut: DWORD,
    s s_mut: PROCESS_MITIGATION_DEP_POLICY_u_s,
}}
STRUCT!{struct PROCESS_MITIGATION_DEP_POLICY {
    u: PROCESS_MITIGATION_DEP_POLICY_u,
    Permanent: BOOLEAN,
}}
pub type PPROCESS_MITIGATION_DEP_POLICY = *mut PROCESS_MITIGATION_DEP_POLICY;
STRUCT!{struct PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY_u_s BitFields: DWORD [
...
UNION2!{union PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY_u {
    [u32; 1],
    Flags Flags_mut: DWORD,
    s s_mut: PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY_u_s,
}}
STRUCT!{struct PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY {
    u: PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY_u,
}}
pub type PPROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY
    = *mut PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY;
STRUCT!{struct PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY_u_s BitFields: DWORD [
    DisallowWin32kSystemCalls set_DisallowWin32kSystemCalls[0..1],
    ReservedFlags set_ReservedFlags[1..32],
]);
UNION2!{union PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY_u {
    [u32; 1],
    Flags Flags_mut: DWORD,
    s s_mut: PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY_u_s,
}}
STRUCT!{struct PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY {
    u: PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY_u,
}}
pub type PPROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY
    = *mut PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY;
STRUCT!{struct PROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(PROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY_u_s BitFields: DWORD [
    DisableExtensionPoints set_DisableExtensionPoints[0..1],
    ReservedFlags set_ReservedFlags[1..32],
]);
UNION2!{union PROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY_u {
    [u32; 1],
    Flags Flags_mut: DWORD,
    s s_mut: PROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY_u_s,
}}
STRUCT!{struct PROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY {
    u: PROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY_u,
}}
pub type PPROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY
    = *mut PROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY;
STRUCT!{struct PROCESS_MITIGATION_DYNAMIC_CODE_POLICY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(PROCESS_MITIGATION_DYNAMIC_CODE_POLICY_u_s BitFields: DWORD [
...
UNION2!{union PROCESS_MITIGATION_DYNAMIC_CODE_POLICY_u {
    [u32; 1],
    Flags Flags_mut: DWORD,
    s s_mut: PROCESS_MITIGATION_DYNAMIC_CODE_POLICY_u_s,
}}
STRUCT!{struct PROCESS_MITIGATION_DYNAMIC_CODE_POLICY {
    u: PROCESS_MITIGATION_DYNAMIC_CODE_POLICY_u,
}}
pub type PPROCESS_MITIGATION_DYNAMIC_CODE_POLICY = *mut PROCESS_MITIGATION_DYNAMIC_CODE_POLICY;
STRUCT!{struct PROCESS_MITIGATION_CONTROL_FLOW_GUARD_POLICY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(PROCESS_MITIGATION_CONTROL_FLOW_GUARD_POLICY_u_s BitFields: DWORD [
...
UNION2!{union PROCESS_MITIGATION_CONTROL_FLOW_GUARD_POLICY_u {
    [u32; 1],
    Flags Flags_mut: DWORD,
    s s_mut: PROCESS_MITIGATION_CONTROL_FLOW_GUARD_POLICY_u_s,
}}
STRUCT!{struct PROCESS_MITIGATION_CONTROL_FLOW_GUARD_POLICY {
    u: PROCESS_MITIGATION_CONTROL_FLOW_GUARD_POLICY_u,
}}
pub type PPROCESS_MITIGATION_CONTROL_FLOW_GUARD_POLICY
    = *mut PROCESS_MITIGATION_CONTROL_FLOW_GUARD_POLICY;
STRUCT!{struct PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY_u_s BitFields: DWORD [
...
UNION2!{union PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY_u {
    [u32; 1],
    Flags Flags_mut: DWORD,
    s s_mut: PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY_u_s,
}}
STRUCT!{struct PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY {
    u: PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY_u,
}}
pub type PPROCESS_MITIGATION_BINARY_SIGNATURE_POLICY
    = *mut PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY;
STRUCT!{struct PROCESS_MITIGATION_FONT_DISABLE_POLICY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(PROCESS_MITIGATION_FONT_DISABLE_POLICY_u_s BitFields: DWORD [
    DisableNonSystemFonts set_DisableNonSystemFonts[0..1],
    AuditNonSystemFontLoading set_AuditNonSystemFontLoading[1..2],
    ReservedFlags set_ReservedFlags[2..32],
]);
UNION2!{union PROCESS_MITIGATION_FONT_DISABLE_POLICY_u {
    [u32; 1],
    Flags Flags_mut: DWORD,
    s s_mut: PROCESS_MITIGATION_FONT_DISABLE_POLICY_u_s,
}}
STRUCT!{struct PROCESS_MITIGATION_FONT_DISABLE_POLICY {
    u: PROCESS_MITIGATION_FONT_DISABLE_POLICY_u,
}}
pub type PPROCESS_MITIGATION_FONT_DISABLE_POLICY = *mut PROCESS_MITIGATION_FONT_DISABLE_POLICY;
STRUCT!{struct PROCESS_MITIGATION_IMAGE_LOAD_POLICY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(PROCESS_MITIGATION_IMAGE_LOAD_POLICY_u_s BitFields: DWORD [
...
UNION2!{union PROCESS_MITIGATION_IMAGE_LOAD_POLICY_u {
    [u32; 1],
    Flags Flags_mut: DWORD,
    s s_mut: PROCESS_MITIGATION_IMAGE_LOAD_POLICY_u_s,
}}
STRUCT!{struct PROCESS_MITIGATION_IMAGE_LOAD_POLICY {
    u: PROCESS_MITIGATION_IMAGE_LOAD_POLICY_u,
}}
...
STRUCT!{struct PROCESSOR_PERFSTATE_POLICY_u_u_s {
    BitFields: BYTE,
}}
BITFIELD!(PROCESSOR_PERFSTATE_POLICY_u_u_s BitFields: BYTE [
...
UNION2!{union PROCESSOR_PERFSTATE_POLICY_u_u {
    [u8; 1],
    AsBYTE AsBYTE_mut: BYTE,
    s s_mut: PROCESSOR_PERFSTATE_POLICY_u_u_s,
}}
UNION2!{union PROCESSOR_PERFSTATE_POLICY_u {
    [u8; 1],
    Spare Spare_mut: BYTE,
    Flags Flags_mut: PROCESSOR_PERFSTATE_POLICY_u_u,
}}
...
pub const IMAGE_SYM_CLASS_END_OF_FUNCTION: BYTE = -1i32 as BYTE;
...
STRUCT!{struct IMAGE_TLS_DIRECTORY64_u_s {
    BitFields: DWORD,
}}
BITFIELD!(IMAGE_TLS_DIRECTORY64_u_s BitFields: DWORD [
    Reserved0 set_Reserved0[0..20],
    Alignment set_Alignment[20..24],
    Reserved1 set_Reserved1[24..32],
]);
UNION2!{union IMAGE_TLS_DIRECTORY64_u {
    [u32; 1],
    Characteristics Characteristics_mut: DWORD,
    s s_mut: IMAGE_TLS_DIRECTORY64_u_s,
}}
STRUCT!{struct IMAGE_TLS_DIRECTORY64 {
    ...
    u: IMAGE_TLS_DIRECTORY64_u,
}}
pub type PIMAGE_TLS_DIRECTORY64 = *mut IMAGE_TLS_DIRECTORY64;
STRUCT!{struct IMAGE_TLS_DIRECTORY32_u_s {
    BitFields: DWORD,
}}
BITFIELD!(IMAGE_TLS_DIRECTORY32_u_s BitFields: DWORD [
    Reserved0 set_Reserved0[0..20],
    Alignment set_Alignment[20..24],
    Reserved1 set_Reserved1[24..32],
]);
UNION2!{union IMAGE_TLS_DIRECTORY32_u {
    [u32; 1],
    Characteristics Characteristics_mut: DWORD,
    s s_mut: IMAGE_TLS_DIRECTORY32_u_s,
}}
...
STRUCT!{struct IMAGE_DELAYLOAD_DESCRIPTOR_Attributes_s {
    BitFields: DWORD,
}}
BITFIELD!(IMAGE_DELAYLOAD_DESCRIPTOR_Attributes_s BitFields: DWORD [
    RvaBased set_RvaBased[0..1],
    ReservedAttributes set_ReservedAttributes[1..32],
]);
UNION2!{union IMAGE_DELAYLOAD_DESCRIPTOR_Attributes {
    [u32; 1],
    AllAttributes AllAttributes_mut: DWORD,
    s s_mut: IMAGE_DELAYLOAD_DESCRIPTOR_Attributes_s,
}}
...
STRUCT!{struct IMAGE_RESOURCE_DIRECTORY_ENTRY_u1_s {
    BitFields: DWORD,
}}
BITFIELD!(IMAGE_RESOURCE_DIRECTORY_ENTRY_u1_s BitFields: DWORD [
    NameOffset set_NameOffset[0..31],
    NameIsString set_NameIsString[31..32],
]);
UNION2!{union IMAGE_RESOURCE_DIRECTORY_ENTRY_u1 {
    [u32; 1],
    s s_mut: IMAGE_RESOURCE_DIRECTORY_ENTRY_u1_s,
    Name Name_mut: DWORD,
    Id Id_mut: WORD,
}}
STRUCT!{struct IMAGE_RESOURCE_DIRECTORY_ENTRY_u2_s {
    BitFields: DWORD,
}}
BITFIELD!(IMAGE_RESOURCE_DIRECTORY_ENTRY_u2_s BitFields: DWORD [
    OffsetToDirectory set_OffsetToDirectory[0..31],
    DataIsDirectory set_DataIsDirectory[31..32],
]);
UNION2!{union IMAGE_RESOURCE_DIRECTORY_ENTRY_u2 {
    [u32; 1],
    OffsetToData OffsetToData_mut: DWORD,
    s s_mut: IMAGE_RESOURCE_DIRECTORY_ENTRY_u2_s,
}}
STRUCT!{struct IMAGE_RESOURCE_DIRECTORY_ENTRY {
    u1: IMAGE_RESOURCE_DIRECTORY_ENTRY_u1,
    u2: IMAGE_RESOURCE_DIRECTORY_ENTRY_u2,
}}
...
STRUCT!{struct IMAGE_ARM_RUNTIME_FUNCTION_ENTRY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(IMAGE_ARM_RUNTIME_FUNCTION_ENTRY_u_s BitFields: DWORD [
    Flag set_Flag[0..2],
...
UNION2!{union IMAGE_ARM_RUNTIME_FUNCTION_ENTRY_u {
    [u32; 1],
    UnwindData UnwindData_mut: DWORD,
    s s_mut: IMAGE_ARM_RUNTIME_FUNCTION_ENTRY_u_s,
}}
STRUCT!{struct IMAGE_ARM_RUNTIME_FUNCTION_ENTRY {
    BeginAddress: DWORD,
    u: IMAGE_ARM_RUNTIME_FUNCTION_ENTRY_u,
}}
pub type PIMAGE_ARM_RUNTIME_FUNCTION_ENTRY = *mut IMAGE_ARM_RUNTIME_FUNCTION_ENTRY;
STRUCT!{struct IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_u_s {
    BitFields: DWORD,
}}
BITFIELD!(IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_u_s BitFields: DWORD [
    Flag set_Flag[0..2],
    FunctionLength set_FunctionLength[2..13],
    RegF set_RegF[13..16],
    RegI set_RegI[16..20],
...
UNION2!{union IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_u {
    [u32; 1],
    UnwindData UnwindData_mut: DWORD,
    s s_mut: IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_u_s,
}}
STRUCT!{struct IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY {
    BeginAddress: DWORD,
    u: IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_u,
}}
...
pub const FLUSH_NV_MEMORY_DEFAULT_TOKEN: ULONG_PTR = -1i32 as ULONG_PTR;
