...
STRUCT!{struct DISPLAYCONFIG_GET_ADVANCED_COLOR_INFO_u_s {
    bitfield: UINT32,
}}
BITFIELD!{DISPLAYCONFIG_GET_ADVANCED_COLOR_INFO_u_s bitfield: UINT32 [
...
UNION2!{union DISPLAYCONFIG_GET_ADVANCED_COLOR_INFO_u {
    [u32; 1],
    s s_mut: DISPLAYCONFIG_GET_ADVANCED_COLOR_INFO_u_s,
    value value_mut : UINT32,
}}
STRUCT!{struct DISPLAYCONFIG_GET_ADVANCED_COLOR_INFO {
    header: DISPLAYCONFIG_DEVICE_INFO_HEADER,
    u: DISPLAYCONFIG_GET_ADVANCED_COLOR_INFO_u,
    colorEncoding: DISPLAYCONFIG_COLOR_ENCODING,
    bitsPerColorChannel: UINT32,
}}
STRUCT!{struct DISPLAYCONFIG_SET_ADVANCED_COLOR_STATE_u_s {
    bitfield: UINT32,
}}
BITFIELD!{DISPLAYCONFIG_SET_ADVANCED_COLOR_STATE_u_s bitfield: UINT32 [
    enableAdvancedColor set_enableAdvancedColor[0..1],
    reserved set_reserved[1..32],
]}
UNION2!{union DISPLAYCONFIG_SET_ADVANCED_COLOR_STATE_u {
    [u32; 1],
    s s_mut: DISPLAYCONFIG_SET_ADVANCED_COLOR_STATE_u_s,
    value value_mut : UINT32,
}}
STRUCT!{struct DISPLAYCONFIG_SET_ADVANCED_COLOR_STATE {
    header: DISPLAYCONFIG_DEVICE_INFO_HEADER,
    u: DISPLAYCONFIG_SET_ADVANCED_COLOR_STATE_u,
}}
