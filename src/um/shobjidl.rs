...
pub use um::shobjidl_core::{
    SFGAO_CANCOPY, SFGAO_CANMOVE, SFGAO_CANLINK, SFGAO_STORAGE, SFGAO_CANRENAME, SFGAO_CANDELETE,
    SFGAO_HASPROPSHEET, SFGAO_DROPTARGET, SFGAO_CAPABILITYMASK, SFGAO_PLACEHOLDER, SFGAO_SYSTEM,
    SFGAO_ENCRYPTED, SFGAO_ISSLOW, SFGAO_GHOSTED, SFGAO_LINK, SFGAO_SHARE, SFGAO_READONLY,
    SFGAO_HIDDEN, SFGAO_DISPLAYATTRMASK, SFGAO_FILESYSANCESTOR, SFGAO_FOLDER, SFGAO_FILESYSTEM,
    SFGAO_HASSUBFOLDER, SFGAO_CONTENTSMASK, SFGAO_VALIDATE, SFGAO_REMOVABLE, SFGAO_COMPRESSED,
    SFGAO_BROWSABLE, SFGAO_NONENUMERATED, SFGAO_NEWCONTENT, SFGAO_CANMONIKER, SFGAO_HASSTORAGE,
    SFGAO_STREAM, SFGAO_STORAGEANCESTOR, SFGAO_STORAGECAPMASK, SFGAO_PKEYSFGAOMASK,
};
