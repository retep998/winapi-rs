...
pub const D3D10_DEBUG_FEATURE_PRESENT_PER_RENDER_OP: DWORD = 0x4;
RIDL!{#[uuid(0x9b7e4e01, 0x342c, 0x4106, 0xa1, 0x9f, 0x4f, 0x27, 0x04, 0xf6, 0x89, 0xf0)]
interface ID3D10Debug(ID3D10DebugVtbl): IUnknown(IUnknownVtbl) {
    fn SetFeatureMask(
        Mask: UINT,
    ) -> HRESULT,
...
ENUM!{enum D3D10_MESSAGE_CATEGORY {
...
ENUM!{enum D3D10_MESSAGE_SEVERITY {
...
STRUCT!{struct D3D10_INFO_QUEUE_FILTER_DESC {
    NumCategories: UINT,
    pCategoryList: *mut D3D10_MESSAGE_CATEGORY,
    NumSeverities: UINT,
    pSeverityList: *mut D3D10_MESSAGE_SEVERITY,
    NumIDs: UINT,
    pIDList: D3D10_MESSAGE_ID,
}}
STRUCT!{struct D3D10_INFO_QUEUE_FILTER {
