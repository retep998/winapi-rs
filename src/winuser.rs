...
pub const PM_QS_INPUT: ::UINT = (QS_INPUT << 16) as ::UINT;
pub const PM_QS_POSTMESSAGE: ::UINT = ((QS_POSTMESSAGE | QS_HOTKEY | QS_TIMER) << 16) as ::UINT;
pub const PM_QS_PAINT: ::UINT = (QS_PAINT << 16) as ::UINT;
pub const PM_QS_SENDMESSAGE: ::UINT = (QS_SENDMESSAGE << 16) as ::UINT;
//5741
