...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] =
    &[// km
      ...
      ("dxgi1_2",
       ...
       &[]),
      ("dxgi1_3",
       &["dxgi", "dxgi1_2", "dxgiformat", "minwindef", "unknwnbase", "windef", "winnt"],
       &[]),
      ("dxgi1_4",
       &["basetsd",
         "dxgi1_2",
      ...
      ("commctrl",
       ...
       &[]),
      ("commdlg",
       &["basetsd", "minwindef", "prsht", "unknwnbase", "windef", "wingdi", "winnt", "winuser"],
       &[]),
      ...
      ("dsound",
       &["guiddef", "minwindef", "mmsystem", "unknwnbase", "windef", "winerror", "winnt"],
       &[]),
      ...
      ("oaidl",
       &["basetsd", "guiddef", "minwindef", "unknwnbase", "winnt", "wtypes", "wtypesbase"],
       &[]),
      ("objidlbase",
       &["basetsd", "guiddef", "minwindef", "unknwnbase", "winnt", "wtypesbase"],
       &[]),
      ...
      ("wininet",
       &["basetsd", "minwinbase", "minwindef", "ntdef", "windef", "winineti", "winnt"],
       &["wininet"]),
      ("winineti", &["minwindef"], &[]),
