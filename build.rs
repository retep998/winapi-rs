...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("wtypes", &["guiddef", "minwindef", "ntdef", "rpcndr", "wtypesbase"], &[]),
    ...
    ("cguid", &[], &[]),
    ("combaseapi", &["basetsd", "guiddef", "minwindef", "objidlbase", "propidl", "rpcdce", "unknwnbase", "winnt", "wtypesbase"], &["ole32"]),
    ("comcat", &["cguid", "guiddef", "minwindef", "unknwnbase", "winnt", "wtypesbase"], &[]),
    ("coml2api", &["minwindef"], &[]),
    ...
    ("msxml", &["minwindef", "oaidl", "unknwnbase", "winnt", "wtypes"], &[]),
    ...
    ("objectarray", &["guiddef", "minwindef", "unknwnbase", "winnt"], &[]),
    ("objidl", &["basetsd", "guiddef", "minwindef", "objidlbase", "rpcndr", "unknwnbase", "windef", "winnt", "wtypes", "wtypesbase"], &[]),
    ("objidlbase", &["basetsd", "guiddef", "minwindef", "unknwnbase", "winnt", "wtypesbase"], &[]),
    ("objsafe", &["guiddef", "minwindef", "unknwnbase", "winnt"], &[]),
    ("ocidl", &["basetsd", "guiddef", "minwindef", "oaidl", "objidl", "objidlbase", "oleidl", "servprov", "unknwnbase", "urlmon", "windef", "wingdi", "winnt", "winuser", "wtypes", "wtypesbase"], &[]),
    ("ocmm", &["guiddef", "minwindef", "oaidl", "objidlbase", "unknwnbase", "windef", "winnt", "wtypesbase"], &[]),
    ("oleauto", &["basetsd", "minwinbase", "minwindef", "oaidl", "winnt", "wtypes", "wtypesbase"], &["oleaut32"]),
    ("olectl", &["guiddef", "minwindef", "oaidl", "objidlbase", "ocidl", "unknwnbase", "windef", "winerror", "winnt", "winuser", "wtypes", "wtypesbase"], &["oleaut32"]),
    ("oleidl", &["basetsd", "guiddef", "minwindef", "objidl", "objidlbase", "unknwnbase", "windef", "wingdi", "winnt", "winuser", "wtypesbase"], &[]),
    ...
    ("strmif", &["winnt"], &[]),
    ("structuredquerycondition", &["guiddef", "minwindef", "objidl", "propidlbase", "unknwnbase", "winnt", "wtypes"], &[]),
    ...
    ("wincodec", &["basetsd", "d2d1", "d2d1_1", "dcommon", "dxgiformat", "dxgitype", "guiddef", "minwindef", "ntdef", "objidlbase", "ocidl", "propidlbase", "unknwnbase", "windef", "winerror", "winnt"], &["windowscodecs"]),
    ("wincodecsdk", &["guiddef", "minwindef", "oaidl", "objidl", "objidlbase", "ocidl", "propidlbase", "unknwnbase", "wincodec", "winnt", "wtypes"], &["ole32", "oleaut32", "windowscodecs"]),
    ...
    ("robuffer", &["objidlbase", "winnt"], &["runtimeobject"]),
