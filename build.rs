...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("fwpmtypes", &["basetsd", "fwptypes", "guiddef", "iketypes", "ipsectypes", "minwindef", "winnt"], &[]),
    ("fwptypes", &["basetsd", "minwindef", "ntdef", "winnt"], &[]),
    ("guiddef", &[], &[]),
    ...
    ("hidusage", &["minwindef"], &[]),
    ("iketypes", &["basetsd", "fwptypes", "guiddef", "ipsectypes", "minwindef", "winerror", "winnt"], &[]),
    ("in6addr", &["minwindef"], &[]),
    ("inaddr", &["minwindef"], &[]),
    ("intsafe", &[], &[]),
    ("ipsectypes", &["basetsd", "fwpmtypes", "fwptypes", "guiddef", "iketypes", "minwindef"], &[]),
    ("ksmedia", &[], &[]),
    ...
    ("fwpmu", &["basetsd", "fwpmtypes", "fwptypes", "guiddef", "iketypes", "ipsectypes", "minwindef", "rpcdce", "winnt"], &["fwpuclnt"]),
    ("gl-gl", &[], &["opengl32"]),
