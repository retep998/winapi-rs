...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("control", &["guiddef", "oaidl", "unknwnbase", "winnt", "wtypes"], &[]),
    ...
    ("dmksctl", &[], &[]),
    ("dmodshow", &["guiddef", "unknwnbase", "winnt"], &[]),
    ("dmoreg", &["guiddef", "mediaobj", "minwindef", "winnt"], &["msdmo"]),
    ("dmort", &["mediaobj", "minwindef", "winnt"], &["msdmo"]),
    ("dmusicc", &[], &[]),
    ...
    ("strmif", &["basetsd", "ddraw", "guiddef", "minwindef", "oaidl", "objidl", "objidlbase", "unknwnbase", "windef", "wingdi", "winnt", "wtypesbase"], &[]),
