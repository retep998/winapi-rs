...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("mmreg", &["guiddef", "minwindef", "mmeapi", "wingdi"], &[]),
    ...
    // ucrt
    // um
    ("audioclient", &["audiosessiontypes", "basetsd", "guiddef", "minwindef", "mmeapi", "strmif", "unknwnbase", "winerror", "winnt", "wtypesbase"], &[]),
    ...
    ("dsound", &["guiddef", "minwindef", "mmeapi", "unknwnbase", "windef", "winerror", "winnt"], &["dsound"]),
    ...
    ("mciapi", &["basetsd", "minwindef", "mmiscapi", "mmsyscom", "windef", "winnt"], &["winmm"]),
    ...
    ("mmeapi", &["basetsd", "guiddef", "minwindef", "mmsyscom", "windef", "winnt"], &["winmm"]),
    ("mmiscapi", &["basetsd", "minwindef", "mmsyscom", "winnt"], &["winmm"]),
    ("mmiscapi2", &["basetsd", "minwindef", "mmsyscom"], &["winmm"]),
    ("mmsyscom", &["basetsd", "minwindef"], &[]),
    ("mmsystem", &["minwindef", "winnt"], &[]),
    ("msaatext", &[], &[]),
    ...
    ("sapi51", &["guiddef", "minwindef", "mmeapi", "oaidl", "objidlbase", "rpcndr", "servprov", "unknwnbase", "windef", "winnt", "wtypes", "wtypesbase"], &[]),
    ...
    ("sapiddk51", &["guiddef", "minwindef", "mmeapi", "oaidl", "objidlbase", "sapi", "unknwnbase", "windef", "winnt"], &[]),
    ...
    ("timeapi", &["minwindef", "mmsyscom"], &["winmm"]),
