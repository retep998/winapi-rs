...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("winhvemulation", &["minwindef", "winhvplatformdefs"], &["winhvemulation"]),
    ("winhvplatform", &["minwindef", "winhvplatformdefs"], &["winhvplatform"]),
    ("winhvplatformdefs", &["minwindef", "basetsd"], &["winhvplatform"]),
