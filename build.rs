...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("hidusage", &["minwindef"], &[]),
    ("ifdef", &["basetsd", "guiddef", "minwindef", "winnt"], &[]),
    ("in6addr", &["minwindef"], &[]),
    ("inaddr", &["minwindef"], &[]),
    ("intsafe", &[], &[]),
    ("ksmedia", &[], &[]),
    ...
    ("ndkinfo", &["basetsd", "minwindef"], &[]),
    ("ntddndis", &["basetsd", "guiddef", "ifdef", "in6addr", "inaddr", "minwindef", "ndkinfo", "winioctl", "winnt", "ws2ipdef"], &[]),
    ...
    ("traffic", &["basetsd", "guiddef", "minwindef", "ntddndis", "qos", "winnt"], &["traffic"]),
    ...
    ("ws2ipdef", &["in6addr", "inaddr", "minwindef", "winnt", "ws2def"], &[]),
