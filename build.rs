...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("dcomptypes", &["minwindef", "dxgitype", "winnt"], &[]),
    ("devguid", &[], &[]),
    ("devpkey", &["devpropdef"], &[]),
    ...
    ("d3d11on12", &["guiddef", "minwindef", "d3d11", "d3d12", "d3dcommon", "unknwnbase", "winnt"], &["d3d11"]),
    ...
    ("dcomp", &["d2d1", "d2d1_1", "d2d1effects", "d2dbasetypes", "d3d9types", "d3dcommon", "dcompanimation", "dcomptypes", "dxgi", "dxgi1_2", "dxgiformat", "guiddef", "minwinbase", "minwindef", "ntdef", "unknwnbase", "windef", "winnt"], &["dcomp"]),
