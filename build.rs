...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("objbase", &["combaseapi", "guiddef", "minwindef", "objidl", "objidlbase", "unknwnbase", "urlmon", "windef", "winnt", "wtypes", "wtypesbase"], &["ole32"]),
    ("objidl", &["basetsd", "guiddef", "minwindef", "objidlbase", "rpcndr", "unknwnbase", "windef", "winnt", "wtypes", "wtypesbase"], &["ole32"]),
