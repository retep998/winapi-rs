...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("propidl", &["guiddef", "minwindef", "unknwnbase", "winnt", "wtypes", "wtypesbase"], &[]),
    ...
    ("wia", &["basetsd", "guiddef", "minwindef", "objidl", "objidlbase", "propidl", "unknwnbase", "wia", "windef", "winnt", "wtypes", "wtypesbase"], &[]),
