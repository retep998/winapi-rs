...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("ocidl", &["basetsd", "minwindef", "wtypesbase", "wtypes", "ntdef", "guiddef", "unknwnbase", "oaidl"], &[]),
    ...
    ("wincodec", &["basetsd", "minwindef","windef", "winerror", "dxgiformat", "dxgitype", "propidl", "objidlbase", "ocidl", "dcommon", "d2d1", "d2d1_1"], &[]),
