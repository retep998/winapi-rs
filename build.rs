...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("hidusage", &["minwindef"], &[]),
    ("ifdef", &["basetsd", "guiddef", "minwindef", "ntdef"], &[]),
    ("ifmib", &["basetsd", "ifdef", "ipifcons", "minwindef", "ntdef"], &[]),
    ("in6addr", &["minwindef"], &[]),
    ("inaddr", &["minwindef"], &[]),
    ("intsafe", &[], &[]),
    ("ipifcons", &["minwindef"], &[]),
    ...
    ("netioapi", &["basetsd", "guiddef", "ifdef", "minwindef", "ntddndis", "ntdef", "ws2def", "ws2ipdef"], &["iphlpapi"]),
    ("nldef", &["basetsd", "minwindef", "ntdef", "winnt"], &[]),
    ("ntddndis", &["ifdef"], &[]),
