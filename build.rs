...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("dcomptypes", &["dxgicommon", "minwindef", "winnt"], &[]),
    ("devguid", &[], &[]),
    ("devpkey", &["devpropdef"], &[]),
    ("devpropdef", &["guiddef", "minwindef", "winnt"], &[]),
    ("dinputd", &[], &[]),
    ("dxgi", &["basetsd", "dxgicommon", "dxgiformat", "dxgitype", "guiddef", "minwindef", "unknwnbase", "windef", "winnt"], &["dxgi"]),
    ("dxgi1_2", &["basetsd", "dxgi", "dxgicommon", "dxgiformat", "dxgitype", "guiddef", "minwinbase", "minwindef", "unknwnbase", "windef", "winnt"], &[]),
    ("dxgi1_3", &["dxgi", "dxgi1_2", "dxgiformat", "guiddef", "minwindef", "unknwnbase", "windef", "winnt"], &["dxgi"]),
    ("dxgi1_4", &["basetsd", "dxgi1_2", "dxgi1_3", "dxgicommon", "dxgiformat", "guiddef", "minwindef", "unknwnbase", "winnt"], &[]),
    ...
    ("d3d11", &["basetsd", "d3dcommon", "dxgi", "dxgicommon", "dxgiformat", "guiddef", "minwindef", "unknwnbase", "windef", "winnt"], &["d3d11"]),
    ("d3d11_1", &[], &[]),
    ("d3d11_2", &[], &[]),
    ("d3d11_3", &[], &[]),
    ("d3d11_4", &[], &[]),
    ...
    ("d3d12", &["basetsd", "d3dcommon", "dxgicommon", "dxgiformat", "guiddef", "minwinbase", "minwindef", "unknwnbase", "windef", "winnt"], &["d3d12"]),
    ...
    ("wincodec", &["basetsd", "d2d1", "d2d1_1", "dcommon", "dxgiformat", "dxgitype", "guiddef", "intsafe", "minwindef", "ntdef", "oaidl", "objidlbase", "ocidl", "propidl", "unknwnbase", "windef", "winerror", "winnt", "wtypes"], &["oleaut32", "windowscodecs"]),
