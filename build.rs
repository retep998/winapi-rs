...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("sapi", &["guiddef", "minwindef", "unknwnbase", "winnt", "sapi53"], &[]),
    ("sapi51", &["guiddef", "minwindef", "mmreg", "windef", "wtypes", "wtypesbase", "oaidl", "objidlbase", "servprov", "unknwnbase", "winnt"], &[]),
    ("sapi53", &["guiddef", "minwindef", "wtypes", "oaidl", "unknwnbase", "urlmon", "winnt", "sapi51"], &[]),
    ("sapiddk", &["guiddef", "minwindef", "sapi", "unknwnbase", "winnt", "sapiddk51"], &[]),
    ("sapiddk51", &["guiddef", "minwindef", "mmreg", "windef", "oaidl", "objidlbase", "sapi", "unknwnbase", "winnt"], &[]),
