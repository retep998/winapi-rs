...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("fwptypes", &["basetsd", "minwindef", "winnt"], &[]),
    ...
    ("inaddr", &["minwindef"], &[]),
    ("intsafe", &[], &[]),
    ("ipsectypes", &["basetsd", "fwptypes", "fwpmtypes", "guiddef", "minwindef"], &[]),
    ("ksmedia", &[], &[]),
    ...
    ("fwpmu", &["basetsd", "fwptypes", "fwpmtypes", "guiddef", "iketypes", "ipsectypes", "minwindef", "rpcdce", "winnt"], &["fwpuclnt"]),
    ("gl-gl", &[], &["opengl32"]),
